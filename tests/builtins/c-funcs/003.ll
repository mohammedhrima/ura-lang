...
if.then:                                          ; preds = %if.start
  %puts = call i32 @puts(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR0, i32 0, i32 0)), !dbg !10
  br label %if.end, !dbg !10

if.else:                                          ; preds = %if.start
  %puts1 = call i32 @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @STR1, i32 0, i32 0)), !dbg !11
...
!4 = distinct !DISubprogram(name: "isdigit", linkageName: "isdigit", scope: null, file: !3, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
