...
entry:
  ...
  store i32 30, i32* %age, align 4, !dbg !7
  ...
  store i32 10, i32* %x, align 4, !dbg !7
  store i32 0, i32* %y, align 4, !dbg !7
  store i32 20, i32* %y, align 4, !dbg !7
  ...
  store i32 -5, i32* %n, align 4, !dbg !7
  ...
  store i8* null, i8** %first, align 8, !dbg !7
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR9, i32 0, i32 0), i8** %first, align 8, !dbg !7
  store i8* null, i8** %last, align 8, !dbg !7
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR10, i32 0, i32 0), i8** %last, align 8, !dbg !7
