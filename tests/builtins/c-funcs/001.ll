; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/builtins/c-funcs/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/builtins/c-funcs/001.ura"
...
@STR2 = private unnamed_addr constant [11 x i8] c"Hero:  %s\0A\00", align 1
@STR3 = private unnamed_addr constant [11 x i8] c"HP:    %d\0A\00", align 1
@STR4 = private unnamed_addr constant [11 x i8] c"Grade: %c\0A\00", align 1
@STR5 = private unnamed_addr constant [11 x i8] c"Speed: %f\0A\00", align 1
@STR6 = private unnamed_addr constant [24 x i8] c"%s \E2\80\94 HP %d, Grade %c\0A\00", align 1
...
entry:
  %name = alloca i8*, align 8, !dbg !161
  %hp = alloca i32, align 4, !dbg !161
  %grade = alloca i8, align 1, !dbg !161
  %speed = alloca float, align 4, !dbg !161
  store i8* null, i8** %name, align 8, !dbg !161
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR1, i32 0, i32 0), i8** %name, align 8, !dbg !161
  store i32 0, i32* %hp, align 4, !dbg !161
  store i32 100, i32* %hp, align 4, !dbg !161
  store i8 0, i8* %grade, align 1, !dbg !161
  store i8 83, i8* %grade, align 1, !dbg !161
  store float 0.000000e+00, float* %speed, align 4, !dbg !161
  store float 1.750000e+00, float* %speed, align 4, !dbg !161
  %name1 = load i8*, i8** %name, align 8, !dbg !162
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR2, i32 0, i32 0), i8* %name1), !dbg !162
  %hp2 = load i32, i32* %hp, align 4, !dbg !163
  %printf3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR3, i32 0, i32 0), i32 %hp2), !dbg !163
  %grade4 = load i8, i8* %grade, align 1, !dbg !164
  %printf5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR4, i32 0, i32 0), i8 %grade4), !dbg !164
  %speed6 = load float, float* %speed, align 4, !dbg !165
  %printf7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR5, i32 0, i32 0), float %speed6), !dbg !165
  %name8 = load i8*, i8** %name, align 8, !dbg !166
  %hp9 = load i32, i32* %hp, align 4, !dbg !166
  %grade10 = load i8, i8* %grade, align 1, !dbg !166
  %printf11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @STR6, i32 0, i32 0), i8* %name8, i32 %hp9, i8 %grade10), !dbg !166
  ret i32 0, !dbg !166
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/builtins/c-funcs")
...
!160 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
...
!165 = !DILocation(line: 14, scope: !160)
!166 = !DILocation(line: 15, scope: !160)
