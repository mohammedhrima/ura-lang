...
entry:
  ...
  store ptr @STR1, ptr %name, align 8, !dbg !7
  ...
  store i32 30, ptr %age, align 4, !dbg !8
  ...
  store i8 0, ptr %grade, align 1, !dbg !9
  store i8 65, ptr %grade, align 1, !dbg !9
  %grade5 = load i8, ptr %grade, align 1, !dbg !10
  %printf6 = call i32 (ptr, i32, ...) @printf(ptr @STR4, i32 1, i8 %grade5), !dbg !10
  %name7 = load ptr, ptr %name, align 8, !dbg !11
  %age8 = load i32, ptr %age, align 4, !dbg !11
  %printf9 = call i32 (ptr, i32, ...) @printf(ptr @STR5, i32 2, ptr %name7, i32 %age8), !dbg !11
  %x = alloca i32, align 4, !dbg !11
  store i32 0, ptr %x, align 4, !dbg !11
  store i32 10, ptr %x, align 4, !dbg !11
  %y = alloca i32, align 4, !dbg !11
  store i32 0, ptr %y, align 4, !dbg !11
  store i32 20, ptr %y, align 4, !dbg !11
  ...
  store i32 -5, ptr %n, align 4, !dbg !12
  %n13 = load i32, ptr %n, align 4, !dbg !13
  %printf14 = call i32 (ptr, i32, ...) @printf(ptr @STR7, i32 1, i32 %n13), !dbg !13
  %printf15 = call i32 (ptr, i32, ...) @printf(ptr @STR8, i32 1, i32 0), !dbg !14
  %first = alloca ptr, align 8, !dbg !14
  store ptr null, ptr %first, align 8, !dbg !14
  store ptr @STR9, ptr %first, align 8, !dbg !14
  %last = alloca ptr, align 8, !dbg !14
  store ptr null, ptr %last, align 8, !dbg !14
  store ptr @STR10, ptr %last, align 8, !dbg !14
  %first16 = load ptr, ptr %first, align 8, !dbg !15
  %last17 = load ptr, ptr %last, align 8, !dbg !15
  %printf18 = call i32 (ptr, i32, ...) @printf(ptr @STR11, i32 2, ptr %first16, ptr %last17), !dbg !15
  ret i32 0, !dbg !15
}
