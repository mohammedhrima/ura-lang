; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/vars/ref/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/vars/ref/003.ura"
...
entry:
  ...
  %result9 = load i32, i32* %result, align 4, !dbg !7
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %result9), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/vars/ref")
