; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/vars/ref/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/vars/ref/004.ura"
...
entry:
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %num2), !dbg !7
  ret void, !dbg !7
}
...
entry:
  ...
  store i32 0, i32* %val1, align 4, !dbg !9
  store i32 10, i32* %val1, align 4, !dbg !9
  store i32 0, i32* %val2, align 4, !dbg !9
  store i32 20, i32* %val2, align 4, !dbg !9
  store i32 0, i32* %val3, align 4, !dbg !9
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/vars/ref")
!4 = distinct !DISubprogram(name: "print", linkageName: "print", scope: null, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
...
!13 = !DILocation(line: 18, scope: !8)
!14 = !DILocation(line: 20, scope: !8)
!15 = !DILocation(line: 21, scope: !8)
!16 = !DILocation(line: 25, scope: !8)
!17 = !DILocation(line: 26, scope: !8)
!18 = !DILocation(line: 29, scope: !8)
