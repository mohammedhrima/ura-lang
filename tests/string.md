...
@fmt.17 = private unnamed_addr constant [21 x i8] c"%.*s%.*s%d%.*s%s%.*s\00", align 1
...
@fmt.23 = private unnamed_addr constant [13 x i8] c"%d%.*s%s%.*s\00", align 1
@str.24 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.25 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.26 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.27 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
...
@fmt.34 = private unnamed_addr constant [25 x i8] c"%c%.*s%c%.*s%d%.*s%d%.*s\00", align 1
@str.35 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.36 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
...
entry:
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @fmt, i32 0, i32 0), i32 %call1, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.9, i32 0, i32 0), i8* %bool_str, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.10, i32 0, i32 0))
  %s2 = alloca %String, align 8
  %call3 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.11, i32 0, i32 0), i64 5 })
  ...
  %bool_str7 = select i1 %call6, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.14, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.15, i32 0, i32 0)
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @fmt.17, i32 0, i32 0), i32 %len32, i8* %str.data, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.12, i32 0, i32 0), i32 %call5, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.13, i32 0, i32 0), i8* %bool_str7, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.16, i32 0, i32 0))
  %s3 = alloca %String, align 8
  %call8 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.18, i32 0, i32 0), i64 0 })
  store %String %call8, %String* %s3, align 8
  %call9 = call i32 @String.len(%String* %s3)
  %call10 = call i1 @String.empty(%String* %s3)
  %bool_str11 = select i1 %call10, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.20, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.21, i32 0, i32 0)
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @fmt.23, i32 0, i32 0), i32 %call9, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.19, i32 0, i32 0), i8* %bool_str11, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.22, i32 0, i32 0))
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.25, i32 0, i32 0), i32 %len3216, i8* %str.data17, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.24, i32 0, i32 0))
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.27, i32 0, i32 0), i32 %len3222, i8* %str.data23, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.26, i32 0, i32 0))
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.29, i32 0, i32 0), i32 %len3228, i8* %str.data29, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.28, i32 0, i32 0))
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @fmt.34, i32 0, i32 0), i32 %c2i, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.30, i32 0, i32 0), i32 %c2i32, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.31, i32 0, i32 0), i32 %cast, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.32, i32 0, i32 0), i32 %cast35, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.33, i32 0, i32 0))
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.36, i32 0, i32 0), i32 %len3238, i8* %str.data39, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.35, i32 0, i32 0))
...
@str.12 = private unnamed_addr constant [36 x i8] c"hello world this is a longer string\00", align 1
@str.13 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.14 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.15 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@str.16 = private unnamed_addr constant [2 x i8] c" \00", align 1
@true_str = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str = private unnamed_addr constant [6 x i8] c"False\00", align 1
@str.17 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.18 = private unnamed_addr constant [13 x i8] c"%d%.*s%s%.*s\00", align 1
@str.19 = private unnamed_addr constant [2 x i8] c" \00", align 1
@str.20 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.21 = private unnamed_addr constant [15 x i8] c"%.*s%.*s%d%.*s\00", align 1
@str.22 = private unnamed_addr constant [2 x i8] c" \00", align 1
@str.23 = private unnamed_addr constant [2 x i8] c" \00", align 1
@str.24 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.25 = private unnamed_addr constant [21 x i8] c"%c%.*s%.*s%.*s%d%.*s\00", align 1
@str.26 = private unnamed_addr constant [2 x i8] c" \00", align 1
@str.27 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.28 = private unnamed_addr constant [13 x i8] c"%d%.*s%d%.*s\00", align 1
@str.29 = private unnamed_addr constant [6 x i8] c"hello\00", align 1
@str.30 = private unnamed_addr constant [7 x i8] c" world\00", align 1
...
@fmt.37 = private unnamed_addr constant [13 x i8] c"%d%.*s%s%.*s\00", align 1
...
entry:
  ...
  %call = call %String @String.create()
  store %String %call, %String* %s, align 8
  call void @"String.=.array"(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.9, i32 0, i32 0), i64 3 })
  %value = getelementptr %String, %String* %s, i32 0, i32 0
  %value1 = load { i8*, i64 }, { i8*, i64 }* %value, align 8
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @fmt, i32 0, i32 0), i32 %len32, i8* %str.data, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.10, i32 0, i32 0), i32 %call2, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.11, i32 0, i32 0))
  call void @"String.=.array"(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([36 x i8], [36 x i8]* @str.12, i32 0, i32 0), i64 35 })
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.14, i32 0, i32 0), i32 %len326, i8* %str.data7, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.13, i32 0, i32 0))
  call void @"String.=.array"(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.15, i32 0, i32 0), i64 0 })
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @fmt.18, i32 0, i32 0), i32 %call8, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.16, i32 0, i32 0), i8* %bool_str, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.17, i32 0, i32 0))
  %s2 = alloca %String, align 8
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @fmt.21, i32 0, i32 0), i32 %len3214, i8* %str.data15, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.19, i32 0, i32 0), i32 %call16, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.20, i32 0, i32 0))
  %c = alloca i8, align 1
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @fmt.25, i32 0, i32 0), i32 %c2i, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.22, i32 0, i32 0), i32 %len3222, i8* %str.data23, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.23, i32 0, i32 0), i32 %call24, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.24, i32 0, i32 0))
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @fmt.28, i32 0, i32 0), i32 %cast, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.26, i32 0, i32 0), i32 %call29, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.27, i32 0, i32 0))
  %s3 = alloca %String, align 8
  %call30 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.29, i32 0, i32 0), i64 5 })
  store %String %call30, %String* %s3, align 8
  call void @String.join(%String* %s3, { i8*, i64 } { i8* getelementptr inbounds ([7 x i8], [7 x i8]* @str.30, i32 0, i32 0), i64 6 })
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.32, i32 0, i32 0), i32 %len3234, i8* %str.data35, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.31, i32 0, i32 0))
  call void @String.clear(%String* %s3)
  %call36 = call i32 @String.len(%String* %s3)
  %call37 = call i1 @String.empty(%String* %s3)
  %bool_str38 = select i1 %call37, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.34, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.35, i32 0, i32 0)
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @fmt.37, i32 0, i32 0), i32 %call36, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.33, i32 0, i32 0), i8* %bool_str38, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.36, i32 0, i32 0))
  call void @String.drop(%String* %s3)
  call void @String.drop(%String* %s2)
...
@str.16 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.17 = private unnamed_addr constant [7 x i8] c"%d%.*s\00", align 1
@str.18 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
...
@fmt.26 = private unnamed_addr constant [7 x i8] c"%s%.*s\00", align 1
@str.27 = private unnamed_addr constant [4 x i8] c"xyz\00", align 1
@true_str.28 = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str.29 = private unnamed_addr constant [6 x i8] c"False\00", align 1
...
@str.35 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.36 = private unnamed_addr constant [7 x i8] c"%s%.*s\00", align 1
@str.37 = private unnamed_addr constant [6 x i8] c"world\00", align 1
@true_str.38 = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str.39 = private unnamed_addr constant [6 x i8] c"False\00", align 1
@str.40 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.41 = private unnamed_addr constant [7 x i8] c"%s%.*s\00", align 1
@str.42 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@true_str.43 = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str.44 = private unnamed_addr constant [6 x i8] c"False\00", align 1
@str.45 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.46 = private unnamed_addr constant [7 x i8] c"%s%.*s\00", align 1
@str.47 = private unnamed_addr constant [6 x i8] c"world\00", align 1
...
@true_str.53 = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str.54 = private unnamed_addr constant [6 x i8] c"False\00", align 1
@str.55 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.56 = private unnamed_addr constant [7 x i8] c"%s%.*s\00", align 1
@str.57 = private unnamed_addr constant [2 x i8] c"d\00", align 1
@true_str.58 = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str.59 = private unnamed_addr constant [6 x i8] c"False\00", align 1
@str.60 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.61 = private unnamed_addr constant [7 x i8] c"%s%.*s\00", align 1
@str.62 = private unnamed_addr constant [2 x i8] c"x\00", align 1
@str.63 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.64 = private unnamed_addr constant [7 x i8] c"%d%.*s\00", align 1
...
entry:
  ...
  store i32 2, i32* @STDERR_FILENO, align 4
  %s = alloca %String, align 8
  %call = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.9, i32 0, i32 0), i64 11 })
  store %String %call, %String* %s, align 8
  %call1 = call i32 @String.find(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.10, i32 0, i32 0), i64 5 })
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt, i32 0, i32 0), i32 %call1, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.11, i32 0, i32 0))
  %call2 = call i32 @String.find(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.12, i32 0, i32 0), i64 5 })
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.14, i32 0, i32 0), i32 %call2, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.13, i32 0, i32 0))
  %call3 = call i32 @String.find(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.15, i32 0, i32 0), i64 3 })
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.17, i32 0, i32 0), i32 %call3, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.16, i32 0, i32 0))
  %call4 = call i32 @String.find(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.18, i32 0, i32 0), i64 0 })
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.20, i32 0, i32 0), i32 %call4, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.19, i32 0, i32 0))
  %call5 = call i32 @String.find(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.21, i32 0, i32 0), i64 1 })
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.23, i32 0, i32 0), i32 %call5, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.22, i32 0, i32 0))
  %call6 = call i1 @String.contains(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.24, i32 0, i32 0), i64 5 })
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.26, i32 0, i32 0), i8* %bool_str, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.25, i32 0, i32 0))
  %call7 = call i1 @String.contains(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.27, i32 0, i32 0), i64 3 })
  %bool_str8 = select i1 %call7, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.28, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.29, i32 0, i32 0)
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.31, i32 0, i32 0), i8* %bool_str8, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.30, i32 0, i32 0))
  %call9 = call i1 @String.starts_with(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.32, i32 0, i32 0), i64 5 })
  %bool_str10 = select i1 %call9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.33, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.34, i32 0, i32 0)
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.36, i32 0, i32 0), i8* %bool_str10, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.35, i32 0, i32 0))
  %call11 = call i1 @String.starts_with(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.37, i32 0, i32 0), i64 5 })
  %bool_str12 = select i1 %call11, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.38, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.39, i32 0, i32 0)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.41, i32 0, i32 0), i8* %bool_str12, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.40, i32 0, i32 0))
  %call13 = call i1 @String.starts_with(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.42, i32 0, i32 0), i64 0 })
  %bool_str14 = select i1 %call13, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.43, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.44, i32 0, i32 0)
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.46, i32 0, i32 0), i8* %bool_str14, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.45, i32 0, i32 0))
  %call15 = call i1 @String.ends_with(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.47, i32 0, i32 0), i64 5 })
  %bool_str16 = select i1 %call15, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.48, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.49, i32 0, i32 0)
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.51, i32 0, i32 0), i8* %bool_str16, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.50, i32 0, i32 0))
  %call17 = call i1 @String.ends_with(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.52, i32 0, i32 0), i64 5 })
  %bool_str18 = select i1 %call17, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.53, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.54, i32 0, i32 0)
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.56, i32 0, i32 0), i8* %bool_str18, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.55, i32 0, i32 0))
  %call19 = call i1 @String.ends_with(%String* %s, { i8*, i64 } { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.57, i32 0, i32 0), i64 1 })
  %bool_str20 = select i1 %call19, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.58, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.59, i32 0, i32 0)
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.61, i32 0, i32 0), i8* %bool_str20, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.60, i32 0, i32 0))
  %empty = alloca %String, align 8
  %call21 = call %String @String.create()
  store %String %call21, %String* %empty, align 8
  %call22 = call i32 @String.find(%String* %empty, { i8*, i64 } { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.62, i32 0, i32 0), i64 1 })
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.64, i32 0, i32 0), i32 %call22, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.63, i32 0, i32 0))
  %call23 = call i1 @String.contains(%String* %empty, { i8*, i64 } { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.65, i32 0, i32 0), i64 1 })
  %bool_str24 = select i1 %call23, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.66, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.67, i32 0, i32 0)
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.69, i32 0, i32 0), i8* %bool_str24, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.68, i32 0, i32 0))
  %call25 = call i1 @String.starts_with(%String* %empty, { i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.70, i32 0, i32 0), i64 0 })
  %bool_str26 = select i1 %call25, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.71, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.72, i32 0, i32 0)
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.74, i32 0, i32 0), i8* %bool_str26, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.73, i32 0, i32 0))
  %call27 = call i1 @String.ends_with(%String* %empty, { i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.75, i32 0, i32 0), i64 0 })
  %bool_str28 = select i1 %call27, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.76, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.77, i32 0, i32 0)
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.79, i32 0, i32 0), i8* %bool_str28, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.78, i32 0, i32 0))
...
@str.11 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.12 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.13 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.14 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.15 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.16 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.17 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.18 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.19 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.20 = private unnamed_addr constant [7 x i8] c"%d%.*s\00", align 1
@str.21 = private unnamed_addr constant [12 x i8] c"   hello   \00", align 1
@str.22 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.23 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
...
@str.30 = private unnamed_addr constant [16 x i8] c"foo bar foo baz\00", align 1
@str.31 = private unnamed_addr constant [4 x i8] c"foo\00", align 1
@str.32 = private unnamed_addr constant [4 x i8] c"qux\00", align 1
@str.33 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.34 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.35 = private unnamed_addr constant [4 x i8] c"xyz\00", align 1
@str.36 = private unnamed_addr constant [4 x i8] c"qux\00", align 1
@str.37 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.38 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.39 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@str.40 = private unnamed_addr constant [4 x i8] c"qux\00", align 1
...
@fmt.45 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.46 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.47 = private unnamed_addr constant [7 x i8] c"%d%.*s\00", align 1
@str.48 = private unnamed_addr constant [6 x i8] c"abcde\00", align 1
@str.49 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.50 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
@str.51 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@str.52 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.53 = private unnamed_addr constant [9 x i8] c"%.*s%.*s\00", align 1
...
entry:
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt, i32 0, i32 0), i32 %len32, i8* %str.data, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.10, i32 0, i32 0))
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.12, i32 0, i32 0), i32 %len327, i8* %str.data8, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.11, i32 0, i32 0))
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.14, i32 0, i32 0), i32 %len3213, i8* %str.data14, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.13, i32 0, i32 0))
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.16, i32 0, i32 0), i32 %len3219, i8* %str.data20, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.15, i32 0, i32 0))
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.18, i32 0, i32 0), i32 %len3225, i8* %str.data26, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.17, i32 0, i32 0))
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.20, i32 0, i32 0), i32 %call28, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.19, i32 0, i32 0))
  %t1 = alloca %String, align 8
  %call29 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([12 x i8], [12 x i8]* @str.21, i32 0, i32 0), i64 11 })
  ...
  %len3234 = trunc i64 %str.len33 to i32
  %str.data35 = extractvalue { i8*, i64 } %value32, 0
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.23, i32 0, i32 0), i32 %len3234, i8* %str.data35, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.22, i32 0, i32 0))
  %t3 = alloca %String, align 8
  %call36 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.24, i32 0, i32 0), i64 5 })
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.26, i32 0, i32 0), i32 %len3241, i8* %str.data42, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.25, i32 0, i32 0))
  %t5 = alloca %String, align 8
  %call43 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.27, i32 0, i32 0), i64 3 })
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.29, i32 0, i32 0), i32 %call45, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.28, i32 0, i32 0))
  %r1 = alloca %String, align 8
  %call46 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([16 x i8], [16 x i8]* @str.30, i32 0, i32 0), i64 15 })
  store %String %call46, %String* %r1, align 8
  %r2 = alloca %String, align 8
  %call47 = call %String @String.replace(%String* %r1, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.31, i32 0, i32 0), i64 3 }, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.32, i32 0, i32 0), i64 3 })
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.34, i32 0, i32 0), i32 %len3251, i8* %str.data52, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.33, i32 0, i32 0))
  %r3 = alloca %String, align 8
  %call53 = call %String @String.replace(%String* %r1, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.35, i32 0, i32 0), i64 3 }, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.36, i32 0, i32 0), i64 3 })
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.38, i32 0, i32 0), i32 %len3257, i8* %str.data58, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.37, i32 0, i32 0))
  %r4 = alloca %String, align 8
  %call59 = call %String @String.replace(%String* %r1, { i8*, i64 } { i8* getelementptr inbounds ([1 x i8], [1 x i8]* @str.39, i32 0, i32 0), i64 0 }, { i8*, i64 } { i8* getelementptr inbounds ([4 x i8], [4 x i8]* @str.40, i32 0, i32 0), i64 3 })
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.42, i32 0, i32 0), i32 %len3263, i8* %str.data64, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.41, i32 0, i32 0))
  %rep = alloca %String, align 8
  %call65 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str.43, i32 0, i32 0), i64 2 })
  ...
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.45, i32 0, i32 0), i32 %len3270, i8* %str.data71, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.44, i32 0, i32 0))
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fmt.47, i32 0, i32 0), i32 %call73, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.46, i32 0, i32 0))
  %rev = alloca %String, align 8
  %call74 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([6 x i8], [6 x i8]* @str.48, i32 0, i32 0), i64 5 })
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.50, i32 0, i32 0), i32 %len3279, i8* %str.data80, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.49, i32 0, i32 0))
  %rev3 = alloca %String, align 8
  %call81 = call %String @String.from({ i8*, i64 } { i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.51, i32 0, i32 0), i64 1 })
  ...
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @fmt.53, i32 0, i32 0), i32 %len3286, i8* %str.data87, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @str.52, i32 0, i32 0))
