...
free.body:                                        ; preds = %free.cond
  ...
  call void @free(i8* %free.ptr)
  %i40 = load i64, i64* %i36, align 8
  %next41 = add i64 %i40, 1
  store i64 %next41, i64* %i36, align 8
  br label %free.cond
