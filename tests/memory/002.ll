; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/002.ura"
...
@STR2 = private unnamed_addr constant [7 x i8] c"Hero: \00", align 1
...
entry:
  ...
  %stack = alloca [32 x i8], align 1, !dbg !161
  %stack1 = getelementptr [32 x i8], [32 x i8]* %stack, i32 0, i32 0, !dbg !161
  store i8* %stack1, i8** %name, align 8, !dbg !161
  %name2 = load i8*, i8** %name, align 8, !dbg !162
  %strcpy = call i8* @strcpy(i8* %name2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR1, i32 0, i32 0)), !dbg !162
  %name3 = load i8*, i8** %name, align 8, !dbg !162
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i8* %name3), !dbg !162
  ret i32 0, !dbg !162
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory")
