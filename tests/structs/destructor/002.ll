; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/destructor/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/destructor/002.ura"
...
@STR1 = private unnamed_addr constant [7 x i8] c"freed\0A\00", align 1
@output_fmt = private unnamed_addr constant [7 x i8] c"freed\0A\00", align 1
...
define %struct.Buffer @Buffer.new(i32 %n) !dbg !160 {
entry:
  %n1 = alloca i32, align 4, !dbg !161
  %b = alloca %struct.Buffer, align 8, !dbg !161
  store i32 %n, i32* %n1, align 4, !dbg !161
  store %struct.Buffer zeroinitializer, %struct.Buffer* %b, align 8, !dbg !161
  %size = getelementptr %struct.Buffer, %struct.Buffer* %b, i32 0, i32 1, !dbg !161
  %n2 = load i32, i32* %n1, align 4, !dbg !161
  store i32 %n2, i32* %size, align 4, !dbg !161
  %data = getelementptr %struct.Buffer, %struct.Buffer* %b, i32 0, i32 0, !dbg !161
  %n3 = load i32, i32* %n1, align 4, !dbg !162
  %as = sext i32 %n3 to i64, !dbg !162
  %calloc = call i8* @calloc(i64 %as, i64 1), !dbg !162
  store i8* %calloc, i8** %data, align 8, !dbg !162
  %b4 = load %struct.Buffer, %struct.Buffer* %b, align 8, !dbg !162
  ret %struct.Buffer %b4, !dbg !162
}

define void @Buffer.set(i8* %s, %struct.Buffer* %self) !dbg !163 {
entry:
  %s1 = alloca i8*, align 8, !dbg !164
  %self2 = alloca %struct.Buffer*, align 8, !dbg !164
  store i8* %s, i8** %s1, align 8, !dbg !164
  store %struct.Buffer* %self, %struct.Buffer** %self2, align 8, !dbg !164
  %self3 = load %struct.Buffer*, %struct.Buffer** %self2, align 8, !dbg !165
  %data = getelementptr %struct.Buffer, %struct.Buffer* %self3, i32 0, i32 0, !dbg !165
  %DOT = load i8*, i8** %data, align 8, !dbg !165
  %s4 = load i8*, i8** %s1, align 8, !dbg !165
  %strcpy = call i8* @strcpy(i8* %DOT, i8* %s4), !dbg !165
  ret void, !dbg !165
}

define void @Buffer.delete(%struct.Buffer* %self) !dbg !166 {
entry:
  %self1 = alloca %struct.Buffer*, align 8, !dbg !167
  store %struct.Buffer* %self, %struct.Buffer** %self1, align 8, !dbg !167
  %self2 = load %struct.Buffer*, %struct.Buffer** %self1, align 8, !dbg !168
  %data = getelementptr %struct.Buffer, %struct.Buffer* %self2, i32 0, i32 0, !dbg !168
  %DOT = load i8*, i8** %data, align 8, !dbg !168
  call void @free(i8* %DOT), !dbg !168
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt, i32 0, i32 0), i32 0), !dbg !168
  %self3 = load %struct.Buffer*, %struct.Buffer** %self1, align 8, !dbg !168
  ret void, !dbg !168
}

declare i32 @printf(i8*, i32, ...)

define i32 @main() !dbg !169 {
entry:
  %b = alloca %struct.Buffer, align 8, !dbg !170
  store %struct.Buffer zeroinitializer, %struct.Buffer* %b, align 8, !dbg !170
  %0 = call %struct.Buffer @Buffer.new(i32 64), !dbg !171
  %tmp_struct = alloca %struct.Buffer, align 8, !dbg !171
  store %struct.Buffer %0, %struct.Buffer* %tmp_struct, align 8, !dbg !171
  store %struct.Buffer %0, %struct.Buffer* %b, align 8, !dbg !171
  call void @Buffer.set(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR2, i32 0, i32 0), %struct.Buffer* %b), !dbg !172
  %data = getelementptr %struct.Buffer, %struct.Buffer* %b, i32 0, i32 0, !dbg !172
  %DOT = load i8*, i8** %data, align 8, !dbg !172
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %DOT), !dbg !172
  call void @Buffer.delete(%struct.Buffer* %b), !dbg !172
  call void @Buffer.delete(%struct.Buffer* %tmp_struct), !dbg !172
  ret i32 0, !dbg !172
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/destructor")
...
!162 = !DILocation(line: 11, scope: !160)
!163 = distinct !DISubprogram(name: "Buffer.set", linkageName: "Buffer.set", scope: null, file: !3, line: 14, type: !5, scopeLine: 14, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!164 = !DILocation(line: 14, scope: !163)
!165 = !DILocation(line: 15, scope: !163)
!166 = distinct !DISubprogram(name: "Buffer.delete", linkageName: "Buffer.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!167 = !DILocation(line: 0, scope: !166)
!168 = !DILocation(line: 18, scope: !166)
!169 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 21, type: !5, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!170 = !DILocation(line: 21, scope: !169)
!171 = !DILocation(line: 22, scope: !169)
!172 = !DILocation(line: 23, scope: !169)
