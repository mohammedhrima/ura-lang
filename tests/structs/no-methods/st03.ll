; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/no-methods/st03.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/no-methods/st03.ura"
...
entry:
  ...
  %id1 = getelementptr %struct.User, %struct.User* %user, i32 0, i32 0, !dbg !10
  %0 = load i32, i32* %id1, align 4, !dbg !10
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %0), !dbg !10
...
!3 = !DIFile(filename: "st03.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/no-methods")
