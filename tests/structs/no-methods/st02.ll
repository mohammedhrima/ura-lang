...
entry:
  ...
  %car2 = getelementptr %struct.User, %struct.User* %user, i32 0, i32 2, !dbg !8
  %model3 = getelementptr %struct.Car, %struct.Car* %car2, i32 0, i32 0, !dbg !8
  %name4 = getelementptr %struct.Model, %struct.Model* %model3, i32 0, i32 0, !dbg !8
  %DOT = load i8*, i8** %name4, align 8, !dbg !8
  %printf = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR2, i32 0, i32 0), i32 1, i8* %DOT), !dbg !8
  call void @User.clean(%struct.User* %user), !dbg !8
  ret i32 0, !dbg !8
}
