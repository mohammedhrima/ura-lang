; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/static/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/static/002.ura"
...
define %struct.Counter @Counter.new() !dbg !160 {
entry:
  %c = alloca %struct.Counter, align 8, !dbg !161
  store %struct.Counter zeroinitializer, %struct.Counter* %c, align 4, !dbg !161
  %value = getelementptr %struct.Counter, %struct.Counter* %c, i32 0, i32 0, !dbg !161
  store i32 0, i32* %value, align 4, !dbg !161
  %c1 = load %struct.Counter, %struct.Counter* %c, align 4, !dbg !161
  ret %struct.Counter %c1, !dbg !161
}

define %struct.Counter @Counter.from(i32 %v) !dbg !162 {
entry:
  %v1 = alloca i32, align 4, !dbg !163
  %c = alloca %struct.Counter, align 8, !dbg !163
  store i32 %v, i32* %v1, align 4, !dbg !163
  store %struct.Counter zeroinitializer, %struct.Counter* %c, align 4, !dbg !163
  %value = getelementptr %struct.Counter, %struct.Counter* %c, i32 0, i32 0, !dbg !163
  %v2 = load i32, i32* %v1, align 4, !dbg !163
  store i32 %v2, i32* %value, align 4, !dbg !163
  %c3 = load %struct.Counter, %struct.Counter* %c, align 4, !dbg !163
  ret %struct.Counter %c3, !dbg !163
}

define void @Counter.inc(%struct.Counter* %self) !dbg !164 {
entry:
  %self1 = alloca %struct.Counter*, align 8, !dbg !165
  store %struct.Counter* %self, %struct.Counter** %self1, align 8, !dbg !165
  %self2 = load %struct.Counter*, %struct.Counter** %self1, align 8, !dbg !165
  %value = getelementptr %struct.Counter, %struct.Counter* %self2, i32 0, i32 0, !dbg !165
  %DOT = load i32, i32* %value, align 4, !dbg !165
  %ADD = add i32 %DOT, 1, !dbg !165
  store i32 %ADD, i32* %value, align 4, !dbg !165
  ret void, !dbg !165
}

define i32 @Counter.get(%struct.Counter* %self) !dbg !166 {
entry:
  %self1 = alloca %struct.Counter*, align 8, !dbg !167
  store %struct.Counter* %self, %struct.Counter** %self1, align 8, !dbg !167
  %self2 = load %struct.Counter*, %struct.Counter** %self1, align 8, !dbg !167
  %value = getelementptr %struct.Counter, %struct.Counter* %self2, i32 0, i32 0, !dbg !167
  %DOT = load i32, i32* %value, align 4, !dbg !167
  ret i32 %DOT, !dbg !167
}

define i32 @main() !dbg !168 {
entry:
  %a = alloca %struct.Counter, align 8, !dbg !169
  %b = alloca %struct.Counter, align 8, !dbg !169
  store %struct.Counter zeroinitializer, %struct.Counter* %a, align 4, !dbg !169
  %0 = call %struct.Counter @Counter.new(), !dbg !170
  %tmp_struct = alloca %struct.Counter, align 8, !dbg !170
  store %struct.Counter %0, %struct.Counter* %tmp_struct, align 4, !dbg !170
  store %struct.Counter %0, %struct.Counter* %a, align 4, !dbg !170
  %Counter.get = call i32 @Counter.get(%struct.Counter* %a), !dbg !171
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %Counter.get), !dbg !171
  store %struct.Counter zeroinitializer, %struct.Counter* %b, align 4, !dbg !169
  %2 = call %struct.Counter @Counter.from(i32 42), !dbg !172
  %tmp_struct1 = alloca %struct.Counter, align 8, !dbg !172
  store %struct.Counter %2, %struct.Counter* %tmp_struct1, align 4, !dbg !172
  store %struct.Counter %2, %struct.Counter* %b, align 4, !dbg !172
  %Counter.get2 = call i32 @Counter.get(%struct.Counter* %b), !dbg !173
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %Counter.get2), !dbg !173
  call void @Counter.inc(%struct.Counter* %b), !dbg !174
  call void @Counter.inc(%struct.Counter* %b), !dbg !175
  %Counter.get3 = call i32 @Counter.get(%struct.Counter* %b), !dbg !176
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i32 %Counter.get3), !dbg !176
  call void @Counter.delete(%struct.Counter* %a), !dbg !176
  call void @Counter.delete(%struct.Counter* %b), !dbg !176
  call void @Counter.delete(%struct.Counter* %tmp_struct), !dbg !176
  call void @Counter.delete(%struct.Counter* %tmp_struct1), !dbg !176
  ret i32 0, !dbg !176
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/static")
...
!160 = distinct !DISubprogram(name: "Counter.new", linkageName: "Counter.new", scope: null, file: !3, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 7, scope: !160)
!162 = distinct !DISubprogram(name: "Counter.from", linkageName: "Counter.from", scope: null, file: !3, line: 12, type: !5, scopeLine: 12, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 12, scope: !162)
!164 = distinct !DISubprogram(name: "Counter.inc", linkageName: "Counter.inc", scope: null, file: !3, line: 17, type: !5, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!165 = !DILocation(line: 17, scope: !164)
!166 = distinct !DISubprogram(name: "Counter.get", linkageName: "Counter.get", scope: null, file: !3, line: 20, type: !5, scopeLine: 20, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!167 = !DILocation(line: 20, scope: !166)
!168 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 23, type: !5, scopeLine: 23, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!169 = !DILocation(line: 23, scope: !168)
!170 = !DILocation(line: 24, scope: !168)
!171 = !DILocation(line: 25, scope: !168)
!172 = !DILocation(line: 26, scope: !168)
!173 = !DILocation(line: 27, scope: !168)
!174 = !DILocation(line: 28, scope: !168)
!175 = !DILocation(line: 29, scope: !168)
!176 = !DILocation(line: 30, scope: !168)
