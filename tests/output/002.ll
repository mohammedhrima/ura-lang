; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/output/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/output/002.ura"
...
entry:
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt, i32 0, i32 0), i32 17), !dbg !7
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.1, i32 0, i32 0), i32 150), !dbg !7
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.2, i32 0, i32 0), i32 30), !dbg !7
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.3, i32 0, i32 0), i32 37), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/output")
