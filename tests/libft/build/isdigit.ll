; ModuleID = '/Users/hrimamohammed/Desktop/Personal/ura-lang/tests/libft/isdigit.ura'
source_filename = "/Users/hrimamohammed/Desktop/Personal/ura-lang/tests/libft/isdigit.ura"
...
if.then:                                          ; preds = %if.start
  %printf = call i32 (ptr, i32, ...) @printf(ptr @STR0, i32 0), !dbg !12
  br label %if.end, !dbg !12

if.else:                                          ; preds = %if.start
  %printf1 = call i32 (ptr, i32, ...) @printf(ptr @STR1, i32 0), !dbg !11
...
!3 = !DIFile(filename: "isdigit.ura", directory: "/Users/hrimamohammed/Desktop/Personal/ura-lang/tests/libft")
