; ModuleID = '/Users/hrimamohammed/Desktop/Personal/ura-lang/tests/libft/strncmp.ura'
source_filename = "/Users/hrimamohammed/Desktop/Personal/ura-lang/tests/libft/strncmp.ura"
...
define i32 @strncmp(ptr %left, ptr %right, i32 %n) !dbg !4 {
entry:
  ...
  store i32 0, ptr %n3, align 4, !dbg !7
  store i32 %n, ptr %n3, align 4, !dbg !7
...
if.start:                                         ; preds = %entry
  %n4 = load i32, ptr %n3, align 4, !dbg !7
...
while.start:                                      ; preds = %while.then, %if.end
  %i5 = load i32, ptr %i, align 4, !dbg !7
  %n6 = load i32, ptr %n3, align 4, !dbg !7
  %LT = icmp slt i32 %i5, %n6, !dbg !7
  %left7 = load ptr, ptr %left1, align 8, !dbg !8
  %i8 = load i32, ptr %i, align 4, !dbg !8
  %ACCESS = getelementptr i8, ptr %left7, i32 %i8, !dbg !8
  %right9 = load ptr, ptr %right2, align 8, !dbg !8
  %i10 = load i32, ptr %i, align 4, !dbg !8
  %ACCESS11 = getelementptr i8, ptr %right9, i32 %i10, !dbg !8
  ...
  %left14 = load ptr, ptr %left1, align 8, !dbg !8
  %i15 = load i32, ptr %i, align 4, !dbg !8
  %ACCESS16 = getelementptr i8, ptr %left14, i32 %i15, !dbg !8
  %ACC17 = load i8, ptr %ACCESS16, align 1, !dbg !8
...
if.start19:                                       ; preds = %while.end
  %i22 = load i32, ptr %i, align 4, !dbg !8
  %n23 = load i32, ptr %n3, align 4, !dbg !8
  %EQ24 = icmp eq i32 %i22, %n23, !dbg !8
  br i1 %EQ24, label %if.then21, label %if.end20, !dbg !8

if.end20:                                         ; preds = %if.start19
  %left25 = load ptr, ptr %left1, align 8, !dbg !9
  %i26 = load i32, ptr %i, align 4, !dbg !9
  %ACCESS27 = getelementptr i8, ptr %left25, i32 %i26, !dbg !9
  %ACC28 = load i8, ptr %ACCESS27, align 1, !dbg !9
  %as = sext i8 %ACC28 to i32, !dbg !9
  %right29 = load ptr, ptr %right2, align 8, !dbg !9
  %i30 = load i32, ptr %i, align 4, !dbg !9
  %ACCESS31 = getelementptr i8, ptr %right29, i32 %i30, !dbg !9
  %ACC32 = load i8, ptr %ACCESS31, align 1, !dbg !9
...
entry:
  ...
  %strncmp = call i32 @strncmp(ptr @STR0, ptr @STR1, i32 4), !dbg !12
  store i32 %strncmp, ptr %len, align 4, !dbg !12
...
!3 = !DIFile(filename: "strncmp.ura", directory: "/Users/hrimamohammed/Desktop/Personal/ura-lang/tests/libft")
!4 = distinct !DISubprogram(name: "strncmp", linkageName: "strncmp", scope: null, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2)
!5 = !DISubroutineType(types: !6)
!6 = !{}
!7 = !DILocation(line: 3, scope: !4)
!8 = !DILocation(line: 6, scope: !4)
!9 = !DILocation(line: 9, scope: !4)
!10 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !2)
!11 = !DILocation(line: 11, scope: !10)
!12 = !DILocation(line: 12, scope: !10)
!13 = !DILocation(line: 13, scope: !10)
