; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor18.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor18.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT, i32 %String.len), !dbg !163
  %String.find = call i32 @String.find(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR5, i32 0, i32 0), %struct.String* %greeting), !dbg !164
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @output_fmt.1, i32 0, i32 0), i32 %String.find), !dbg !164
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @output_fmt.2, i32 0, i32 0), i8* %bool_str), !dbg !165
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i8* %DOT4), !dbg !166
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i8* %DOT8), !dbg !167
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.5, i32 0, i32 0), i8* %DOT12), !dbg !168
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.6, i32 0, i32 0), i8* %DOT16), !dbg !171
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.7, i32 0, i32 0), i8* %DOT23), !dbg !161
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.8, i32 0, i32 0), i8* %DOT25), !dbg !161
  ...
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.11, i32 0, i32 0), i8* %bool_str30), !dbg !175
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.12, i32 0, i32 0), i8* %DOT34), !dbg !176
  ...
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.13, i32 0, i32 0), i32 %String.to_int), !dbg !178
  ...
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.14, i32 0, i32 0), i8* %DOT42), !dbg !180
  ...
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.15, i32 0, i32 0), i8* %DOT48), !dbg !182
  ...
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.16, i32 0, i32 0), i8* %DOT54), !dbg !184
  ...
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.17, i32 0, i32 0), i8* %DOT60), !dbg !186
...
!3 = !DIFile(filename: "floor18.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
