; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor05.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor05.ura"
...
entry:
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @output_fmt, i32 0, i32 0), i32 2, i8* %item3, i32 %gold4), !dbg !9
  ...
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %bonus8), !dbg !9
  ret i32 0, !dbg !9
}
...
!3 = !DIFile(filename: "floor05.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
