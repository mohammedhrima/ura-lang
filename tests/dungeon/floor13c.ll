; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor13c.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor13c.ura"
...
@STR2 = private unnamed_addr constant [9 x i8] c"inside: \00", align 1
...
@STR5 = private unnamed_addr constant [11 x i8] c" the Brave\00", align 1
@STR6 = private unnamed_addr constant [9 x i8] c"after:  \00", align 1
...
define void @Label.print(%struct.Label* %self) !dbg !175 {
entry:
  %self1 = alloca %struct.Label*, align 8, !dbg !176
  store %struct.Label* %self, %struct.Label** %self1, align 8, !dbg !176
  %self2 = load %struct.Label*, %struct.Label** %self1, align 8, !dbg !176
  %value = getelementptr %struct.Label, %struct.Label* %self2, i32 0, i32 0, !dbg !176
  %DOT = load i8*, i8** %value, align 8, !dbg !176
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %DOT), !dbg !176
  ret void, !dbg !176
}

declare i32 @printf(i8*, i32, ...)

define void @hero_rename(%struct.Label %hero, i8* %suffix) !dbg !177 {
entry:
  %hero1 = alloca %struct.Label, align 8, !dbg !178
  %suffix2 = alloca i8*, align 8, !dbg !178
  store %struct.Label %hero, %struct.Label* %hero1, align 8, !dbg !178
  store i8* %suffix, i8** %suffix2, align 8, !dbg !178
  %value = getelementptr %struct.Label, %struct.Label* %hero1, i32 0, i32 0, !dbg !179
  %DOT = load i8*, i8** %value, align 8, !dbg !179
  %suffix3 = load i8*, i8** %suffix2, align 8, !dbg !179
  %strcat = call i8* @strcat(i8* %DOT, i8* %suffix3), !dbg !179
  %value4 = getelementptr %struct.Label, %struct.Label* %hero1, i32 0, i32 0, !dbg !179
  %DOT5 = load i8*, i8** %value4, align 8, !dbg !179
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %DOT5), !dbg !179
  call void @Label.delete(%struct.Label* %hero1), !dbg !179
  ret void, !dbg !179
}

define i32 @main() !dbg !180 {
entry:
  %hero = alloca %struct.Label, align 8, !dbg !181
  store %struct.Label zeroinitializer, %struct.Label* %hero, align 8, !dbg !181
  %0 = call %struct.Label @Label.new(), !dbg !182
  %tmp_struct = alloca %struct.Label, align 8, !dbg !182
  store %struct.Label %0, %struct.Label* %tmp_struct, align 8, !dbg !182
  %tmp_op = alloca %struct.Label, align 8, !dbg !182
  store %struct.Label %0, %struct.Label* %tmp_op, align 8, !dbg !182
  call void @Label.operator.ASSIGN.Label(%struct.Label* %tmp_op, %struct.Label* %hero), !dbg !182
  call void @Label.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR4, i32 0, i32 0), %struct.Label* %hero), !dbg !182
  %copy = alloca %struct.Label, align 8, !dbg !183
  store %struct.Label zeroinitializer, %struct.Label* %copy, align 8, !dbg !183
  call void @Label.operator.ASSIGN.Label(%struct.Label* %hero, %struct.Label* %copy), !dbg !183
  %copy_val = load %struct.Label, %struct.Label* %copy, align 8, !dbg !183
  call void @hero_rename(%struct.Label %copy_val, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR5, i32 0, i32 0)), !dbg !183
  %value = getelementptr %struct.Label, %struct.Label* %hero, i32 0, i32 0, !dbg !183
  %DOT = load i8*, i8** %value, align 8, !dbg !183
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %DOT), !dbg !183
  call void @Label.delete(%struct.Label* %hero), !dbg !183
  call void @Label.delete(%struct.Label* %tmp_struct), !dbg !183
  ret i32 0, !dbg !183
}
...
!3 = !DIFile(filename: "floor13c.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
...
!175 = distinct !DISubprogram(name: "Label.print", linkageName: "Label.print", scope: null, file: !3, line: 27, type: !5, scopeLine: 27, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!176 = !DILocation(line: 27, scope: !175)
!177 = distinct !DISubprogram(name: "hero_rename", linkageName: "hero_rename", scope: null, file: !3, line: 30, type: !5, scopeLine: 30, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!178 = !DILocation(line: 30, scope: !177)
!179 = !DILocation(line: 31, scope: !177)
!180 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 34, type: !5, scopeLine: 34, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!181 = !DILocation(line: 34, scope: !180)
!182 = !DILocation(line: 35, scope: !180)
!183 = !DILocation(line: 37, scope: !180)
