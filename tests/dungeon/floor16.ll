; ModuleID = 'tests/dungeon/floor16.ura'
source_filename = "tests/dungeon/floor16.ura"
...
if.end:                                           ; preds = %if.then, %if.start
  ...
  call void @DrawRectangle(i32 %hero_x4, i32 300, i32 40, i32 60, i64 %i64_arg8), !dbg !15
  %setColor9 = call %struct.Color @setColor(i32 255, i32 220, i32 0, i32 255), !dbg !16
  ...
  call void @DrawText(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @STR1, i32 0, i32 0), i32 10, i32 10, i32 24, i64 %i64_arg12), !dbg !16
...
!3 = !DIFile(filename: "floor16.ura", directory: "tests/dungeon")
