; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor09b.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor09b.ura"
...
entry:
  ...
  store i32 100, i32* %ref_ptr, align 4, !dbg !7
  %hp1 = load i32, i32* %hp, align 4, !dbg !7
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 %hp1), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "floor09b.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
