...
entry:
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @output_fmt, i32 0, i32 0), i32 3, i32 %floor, i32 %score, i32 %lives), !dbg !9
  call void @earn(i32 100), !dbg !10
  call void @earn(i32 50), !dbg !11
  %score1 = load i32, i32* @score, align 4, !dbg !11
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %score1), !dbg !11
  ret i32 0, !dbg !11
}
