; ModuleID = 'tests/dungeon/floor07b.ura'
source_filename = "tests/dungeon/floor07b.ura"
...
define void @Dungeon.init(%struct.Dungeon* %0) {
entry:
  store %struct.Dungeon zeroinitializer, %struct.Dungeon* %0, align 8
  %entry1 = getelementptr %struct.Dungeon, %struct.Dungeon* %0, i32 0, i32 1
  call void @Room.init(%struct.Room* %entry1)
  ret void
}

define void @Dungeon.clean(%struct.Dungeon* %0) {
entry:
  %entry1 = getelementptr %struct.Dungeon, %struct.Dungeon* %0, i32 0, i32 1
  call void @Room.clean(%struct.Room* %entry1)
  ret void
}
...
entry:
  ...
  call void @Dungeon.init(%struct.Dungeon* %d), !dbg !7
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @output_fmt, i32 0, i32 0), i32 2, i8* %DOT, i8* %DOT7), !dbg !7
  call void @Dungeon.clean(%struct.Dungeon* %d), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "floor07b.ura", directory: "tests/dungeon")
