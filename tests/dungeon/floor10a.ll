; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor10a.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor10a.ura"
...
entry:
  %map = alloca i8*, align 8, !dbg !161
  %i = alloca i32, align 4, !dbg !161
  %buf = alloca i8*, align 8, !dbg !161
  store i8* null, i8** %map, align 8, !dbg !161
  %heap = call i8* @calloc(i64 51, i64 1), !dbg !161
  store i8* %heap, i8** %map, align 8, !dbg !161
...
while.start:                                      ; preds = %while.then, %entry
  ...
  %LT = icmp slt i32 %i1, 50, !dbg !161
  br i1 %LT, label %while.then, label %while.end, !dbg !161

while.then:                                       ; preds = %while.start
  %map2 = load i8*, i8** %map, align 8, !dbg !162
  %i3 = load i32, i32* %i, align 4, !dbg !162
  %ACCESS = getelementptr i8, i8* %map2, i32 %i3, !dbg !162
  store i8 46, i8* %ACCESS, align 1, !dbg !162
  %i4 = load i32, i32* %i, align 4, !dbg !162
  %ADD = add i32 %i4, 1, !dbg !162
  store i32 %ADD, i32* %i, align 4, !dbg !162
  br label %while.start, !dbg !162

while.end:                                        ; preds = %while.start
  %map5 = load i8*, i8** %map, align 8, !dbg !163
  %ACCESS6 = getelementptr i8, i8* %map5, i32 25, !dbg !163
  store i8 64, i8* %ACCESS6, align 1, !dbg !163
  %map7 = load i8*, i8** %map, align 8, !dbg !164
  %ACCESS8 = getelementptr i8, i8* %map7, i32 50, !dbg !164
  store i8 0, i8* %ACCESS8, align 1, !dbg !164
  %map9 = load i8*, i8** %map, align 8, !dbg !164
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %map9), !dbg !164
  %map10 = load i8*, i8** %map, align 8, !dbg !165
  call void @free(i8* %map10), !dbg !165
  store i8* null, i8** %buf, align 8, !dbg !161
  %stack = alloca [16 x i8], align 1, !dbg !161
  %stack11 = getelementptr [16 x i8], [16 x i8]* %stack, i32 0, i32 0, !dbg !161
  store i8* %stack11, i8** %buf, align 8, !dbg !161
  %buf12 = load i8*, i8** %buf, align 8, !dbg !166
  %ACCESS13 = getelementptr i8, i8* %buf12, i32 0, !dbg !166
  store i8 72, i8* %ACCESS13, align 1, !dbg !166
  %buf14 = load i8*, i8** %buf, align 8, !dbg !167
  %ACCESS15 = getelementptr i8, i8* %buf14, i32 1, !dbg !167
  store i8 80, i8* %ACCESS15, align 1, !dbg !167
  %buf16 = load i8*, i8** %buf, align 8, !dbg !168
  %ACCESS17 = getelementptr i8, i8* %buf16, i32 2, !dbg !168
  store i8 0, i8* %ACCESS17, align 1, !dbg !168
  %buf18 = load i8*, i8** %buf, align 8, !dbg !168
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %buf18), !dbg !168
  ret i32 0, !dbg !168
}
...
!3 = !DIFile(filename: "floor10a.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
...
!163 = !DILocation(line: 10, scope: !160)
!164 = !DILocation(line: 11, scope: !160)
