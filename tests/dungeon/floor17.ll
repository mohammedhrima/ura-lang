; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor17.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor17.ura"
...
@STR2 = private unnamed_addr constant [20 x i8] c"listening on :8080\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [20 x i8] c"listening on :8080\0A\00", align 1
@STR3 = private unnamed_addr constant [6 x i8] c"got: \00", align 1
@STR4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [9 x i8] c"got: %s\0A\00", align 1
@STR5 = private unnamed_addr constant [6 x i8] c"pong\0A\00", align 1
...
entry:
  %fd = alloca i32, align 4, !dbg !161
  %port = alloca i32, align 4, !dbg !161
  %addr = alloca i8*, align 8, !dbg !161
  %hi = alloca i32, align 4, !dbg !161
  %lo = alloca i32, align 4, !dbg !161
  %buf = alloca i8*, align 8, !dbg !161
  %client = alloca i32, align 4, !dbg !161
  %n = alloca i32, align 4, !dbg !161
  store i32 0, i32* %fd, align 4, !dbg !161
  %socket = call i32 @socket(i32 2, i32 1, i32 0), !dbg !162
  store i32 %socket, i32* %fd, align 4, !dbg !162
  br label %if.start, !dbg !162

if.start:                                         ; preds = %entry
  %fd1 = load i32, i32* %fd, align 4, !dbg !162
  %LT = icmp slt i32 %fd1, 0, !dbg !162
...
if.end:                                           ; preds = %if.start
  ...
  store i8* %heap, i8** %addr, align 8, !dbg !161
  %addr2 = load i8*, i8** %addr, align 8, !dbg !163
  %ACCESS = getelementptr i8, i8* %addr2, i32 0, !dbg !163
  store i8 16, i8* %ACCESS, align 1, !dbg !163
  %addr3 = load i8*, i8** %addr, align 8, !dbg !164
  %ACCESS4 = getelementptr i8, i8* %addr3, i32 1, !dbg !164
  store i8 2, i8* %ACCESS4, align 1, !dbg !164
  store i32 0, i32* %hi, align 4, !dbg !161
  %port5 = load i32, i32* %port, align 4, !dbg !161
  %RSHIFT = ashr i32 %port5, 8, !dbg !161
  store i32 %RSHIFT, i32* %hi, align 4, !dbg !161
  store i32 0, i32* %lo, align 4, !dbg !161
  %port6 = load i32, i32* %port, align 4, !dbg !161
  %BAND = and i32 %port6, 255, !dbg !161
  store i32 %BAND, i32* %lo, align 4, !dbg !161
  %addr7 = load i8*, i8** %addr, align 8, !dbg !165
  %ACCESS8 = getelementptr i8, i8* %addr7, i32 2, !dbg !165
  %hi9 = load i32, i32* %hi, align 4, !dbg !165
  %as = trunc i32 %hi9 to i8, !dbg !165
  store i8 %as, i8* %ACCESS8, align 1, !dbg !165
  %addr10 = load i8*, i8** %addr, align 8, !dbg !166
  %ACCESS11 = getelementptr i8, i8* %addr10, i32 3, !dbg !166
  %lo12 = load i32, i32* %lo, align 4, !dbg !166
  %as13 = trunc i32 %lo12 to i8, !dbg !166
  store i8 %as13, i8* %ACCESS11, align 1, !dbg !166
  %fd14 = load i32, i32* %fd, align 4, !dbg !167
  %addr15 = load i8*, i8** %addr, align 8, !dbg !167
  %bind = call i32 @bind(i32 %fd14, i8* %addr15, i32 16), !dbg !167
  %fd16 = load i32, i32* %fd, align 4, !dbg !168
  %listen = call i32 @listen(i32 %fd16, i32 5), !dbg !168
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @output_fmt.1, i32 0, i32 0), i32 0), !dbg !168
  store i8* null, i8** %buf, align 8, !dbg !161
  %heap17 = call i8* @calloc(i64 1024, i64 1), !dbg !161
  store i8* %heap17, i8** %buf, align 8, !dbg !161
  store i32 0, i32* %client, align 4, !dbg !161
  %fd18 = load i32, i32* %fd, align 4, !dbg !169
  %accept = call i32 @accept(i32 %fd18, i8* null, i8* null), !dbg !169
  store i32 %accept, i32* %client, align 4, !dbg !169
  br label %if.start19, !dbg !169

if.then:                                          ; preds = %if.start
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0), i32 0), !dbg !162
  ret void, !dbg !162

if.start19:                                       ; preds = %if.end
  %client22 = load i32, i32* %client, align 4, !dbg !169
  %GE = icmp sge i32 %client22, 0, !dbg !169
  br i1 %GE, label %if.then21, label %if.end20, !dbg !169

if.end20:                                         ; preds = %if.end26, %if.start19
  %buf32 = load i8*, i8** %buf, align 8, !dbg !170
  call void @free(i8* %buf32), !dbg !170
  %addr33 = load i8*, i8** %addr, align 8, !dbg !171
  call void @free(i8* %addr33), !dbg !171
  ret void, !dbg !171

if.then21:                                        ; preds = %if.start19
  store i32 0, i32* %n, align 4, !dbg !161
  %client23 = load i32, i32* %client, align 4, !dbg !172
  %buf24 = load i8*, i8** %buf, align 8, !dbg !172
  %read = call i32 @read(i32 %client23, i8* %buf24, i32 1023), !dbg !172
  store i32 %read, i32* %n, align 4, !dbg !172
  br label %if.start25, !dbg !172

if.start25:                                       ; preds = %if.then21
  %n28 = load i32, i32* %n, align 4, !dbg !172
  %GT = icmp sgt i32 %n28, 0, !dbg !172
  br i1 %GT, label %if.then27, label %if.end26, !dbg !172

if.end26:                                         ; preds = %if.then27, %if.start25
  %client31 = load i32, i32* %client, align 4, !dbg !173
  %close = call i32 @close(i32 %client31), !dbg !173
  br label %if.end20, !dbg !173

if.then27:                                        ; preds = %if.start25
  %buf29 = load i8*, i8** %buf, align 8, !dbg !172
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %buf29), !dbg !172
  %client30 = load i32, i32* %client, align 4, !dbg !174
  %write = call i32 @write(i32 %client30, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR5, i32 0, i32 0), i32 5), !dbg !174
  br label %if.end26, !dbg !174
}

declare i32 @printf(i8*, i32, ...)

define i32 @main() !dbg !175 {
entry:
  call void @run(), !dbg !176
  ret i32 0, !dbg !176
}
...
!3 = !DIFile(filename: "floor17.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
...
!160 = distinct !DISubprogram(name: "run", linkageName: "run", scope: null, file: !3, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 4, scope: !160)
!162 = !DILocation(line: 5, scope: !160)
!163 = !DILocation(line: 12, scope: !160)
!164 = !DILocation(line: 13, scope: !160)
!165 = !DILocation(line: 16, scope: !160)
!166 = !DILocation(line: 17, scope: !160)
!167 = !DILocation(line: 19, scope: !160)
!168 = !DILocation(line: 20, scope: !160)
!169 = !DILocation(line: 24, scope: !160)
!170 = !DILocation(line: 31, scope: !160)
!171 = !DILocation(line: 32, scope: !160)
!172 = !DILocation(line: 26, scope: !160)
!173 = !DILocation(line: 30, scope: !160)
!174 = !DILocation(line: 29, scope: !160)
!175 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 34, type: !5, scopeLine: 34, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!176 = !DILocation(line: 35, scope: !175)
