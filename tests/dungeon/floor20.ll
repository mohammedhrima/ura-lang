; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor20.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor20.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }
%struct.Stats = type { i32, i32 }
%struct.Hero = type { i8*, %struct.Stats, i32 }
%struct.Loot = type { i8*, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [4 x i8] c" lv\00", align 1
@STR2 = private unnamed_addr constant [5 x i8] c" HP:\00", align 1
@STR3 = private unnamed_addr constant [7 x i8] c"Aldric\00", align 1
@STR4 = private unnamed_addr constant [7 x i8] c"Hero: \00", align 1
@STR5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [10 x i8] c"Hero: %s\0A\00", align 1
@STR6 = private unnamed_addr constant [11 x i8] c"Iron Sword\00", align 1
@STR7 = private unnamed_addr constant [7 x i8] c"Loot: \00", align 1
@STR8 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [31 x i8] c"Loot: { name: %s, value: %d }\0A\00", align 1
@STR9 = private unnamed_addr constant [9 x i8] c"Fireball\00", align 1
@STR10 = private unnamed_addr constant [8 x i8] c"Spell: \00", align 1
@STR11 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [11 x i8] c"Spell: %s\0A\00", align 1
...
define %struct.Hero @Hero.new(i8* %name) !dbg !160 {
entry:
  %name1 = alloca i8*, align 8, !dbg !161
  %h = alloca %struct.Hero, align 8, !dbg !161
  store i8* %name, i8** %name1, align 8, !dbg !161
  store %struct.Hero zeroinitializer, %struct.Hero* %h, align 8, !dbg !161
  %name2 = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 0, !dbg !161
  %name3 = load i8*, i8** %name1, align 8, !dbg !161
  store i8* %name3, i8** %name2, align 8, !dbg !161
  %stats = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 1, !dbg !161
  %hp = getelementptr %struct.Stats, %struct.Stats* %stats, i32 0, i32 0, !dbg !161
  store i32 100, i32* %hp, align 4, !dbg !161
  %stats4 = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 1, !dbg !161
  %atk = getelementptr %struct.Stats, %struct.Stats* %stats4, i32 0, i32 1, !dbg !161
  store i32 20, i32* %atk, align 4, !dbg !161
  %level = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 2, !dbg !161
  store i32 1, i32* %level, align 4, !dbg !161
  %h5 = load %struct.Hero, %struct.Hero* %h, align 8, !dbg !161
  ret %struct.Hero %h5, !dbg !161
}

define %struct.String @Hero.operator.output(%struct.Hero* %self) !dbg !162 {
entry:
  %self1 = alloca %struct.Hero*, align 8, !dbg !163
  %s = alloca %struct.String, align 8, !dbg !163
  %n = alloca %struct.String, align 8, !dbg !163
  %hp = alloca %struct.String, align 8, !dbg !163
  store %struct.Hero* %self, %struct.Hero** %self1, align 8, !dbg !163
  store %struct.String zeroinitializer, %struct.String* %s, align 8, !dbg !163
  %self2 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !164
  %name = getelementptr %struct.Hero, %struct.Hero* %self2, i32 0, i32 0, !dbg !164
  %DOT = load i8*, i8** %name, align 8, !dbg !164
  %0 = call %struct.String @String.from(i8* %DOT), !dbg !164
  %tmp_struct = alloca %struct.String, align 8, !dbg !164
  store %struct.String %0, %struct.String* %tmp_struct, align 8, !dbg !164
  %tmp_op = alloca %struct.String, align 8, !dbg !164
  store %struct.String %0, %struct.String* %tmp_op, align 8, !dbg !164
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op, %struct.String* %s), !dbg !164
  call void @String.join(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR1, i32 0, i32 0), %struct.String* %s), !dbg !165
  store %struct.String zeroinitializer, %struct.String* %n, align 8, !dbg !163
  %self3 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !166
  %level = getelementptr %struct.Hero, %struct.Hero* %self3, i32 0, i32 2, !dbg !166
  %DOT4 = load i32, i32* %level, align 4, !dbg !166
  %1 = call %struct.String @String.from_int(i32 %DOT4), !dbg !166
  %tmp_struct5 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %1, %struct.String* %tmp_struct5, align 8, !dbg !166
  %tmp_op6 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %1, %struct.String* %tmp_op6, align 8, !dbg !166
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op6, %struct.String* %n), !dbg !166
  %value = getelementptr %struct.String, %struct.String* %n, i32 0, i32 0, !dbg !167
  %DOT7 = load i8*, i8** %value, align 8, !dbg !167
  call void @String.join(i8* %DOT7, %struct.String* %s), !dbg !167
  call void @String.join(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR2, i32 0, i32 0), %struct.String* %s), !dbg !168
  store %struct.String zeroinitializer, %struct.String* %hp, align 8, !dbg !163
  %self8 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !169
  %stats = getelementptr %struct.Hero, %struct.Hero* %self8, i32 0, i32 1, !dbg !169
  %hp9 = getelementptr %struct.Stats, %struct.Stats* %stats, i32 0, i32 0, !dbg !169
  %DOT10 = load i32, i32* %hp9, align 4, !dbg !169
  %2 = call %struct.String @String.from_int(i32 %DOT10), !dbg !169
  %tmp_struct11 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %2, %struct.String* %tmp_struct11, align 8, !dbg !169
  %tmp_op12 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %2, %struct.String* %tmp_op12, align 8, !dbg !169
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op12, %struct.String* %hp), !dbg !169
  %value13 = getelementptr %struct.String, %struct.String* %hp, i32 0, i32 0, !dbg !170
  %DOT14 = load i8*, i8** %value13, align 8, !dbg !170
  call void @String.join(i8* %DOT14, %struct.String* %s), !dbg !170
  call void @String.delete(%struct.String* %n), !dbg !170
  call void @String.delete(%struct.String* %hp), !dbg !170
  call void @String.delete(%struct.String* %tmp_struct), !dbg !170
  call void @String.delete(%struct.String* %tmp_struct5), !dbg !170
  call void @String.delete(%struct.String* %tmp_struct11), !dbg !170
  %s15 = load %struct.String, %struct.String* %s, align 8, !dbg !170
  ret %struct.String %s15, !dbg !170
}

define void @Loot.delete(%struct.Loot* %0) {
entry:
  ret void
}

define i32 @main() !dbg !171 {
entry:
  %hero = alloca %struct.Hero, align 8, !dbg !172
  %loot = alloca %struct.Loot, align 8, !dbg !172
  %s = alloca %struct.String, align 8, !dbg !172
  store %struct.Hero zeroinitializer, %struct.Hero* %hero, align 8, !dbg !172
  %0 = call %struct.Hero @Hero.new(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR3, i32 0, i32 0)), !dbg !173
  %tmp_struct = alloca %struct.Hero, align 8, !dbg !173
  store %struct.Hero %0, %struct.Hero* %tmp_struct, align 8, !dbg !173
  store %struct.Hero %0, %struct.Hero* %hero, align 8, !dbg !173
  %output_op = call %struct.String @Hero.operator.output(%struct.Hero* %hero), !dbg !173
  %out_tmp = alloca %struct.String, align 8, !dbg !173
  store %struct.String %output_op, %struct.String* %out_tmp, align 8, !dbg !173
  %output_op1 = call i8* @String.operator.output(%struct.String* %out_tmp), !dbg !173
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %output_op1), !dbg !173
  store %struct.Loot zeroinitializer, %struct.Loot* %loot, align 8, !dbg !172
  %name = getelementptr %struct.Loot, %struct.Loot* %loot, i32 0, i32 0, !dbg !172
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR6, i32 0, i32 0), i8** %name, align 8, !dbg !172
  %value = getelementptr %struct.Loot, %struct.Loot* %loot, i32 0, i32 1, !dbg !172
  store i32 50, i32* %value, align 4, !dbg !172
  %name2 = getelementptr %struct.Loot, %struct.Loot* %loot, i32 0, i32 0, !dbg !172
  %name3 = load i8*, i8** %name2, align 8, !dbg !172
  %value4 = getelementptr %struct.Loot, %struct.Loot* %loot, i32 0, i32 1, !dbg !172
  %value5 = load i32, i32* %value4, align 4, !dbg !172
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @output_fmt.1, i32 0, i32 0), i32 2, i8* %name3, i32 %value5), !dbg !172
  store %struct.String zeroinitializer, %struct.String* %s, align 8, !dbg !172
  %3 = call %struct.String @String.from(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR9, i32 0, i32 0)), !dbg !174
  %tmp_struct6 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %3, %struct.String* %tmp_struct6, align 8, !dbg !174
  %tmp_op = alloca %struct.String, align 8, !dbg !174
  store %struct.String %3, %struct.String* %tmp_op, align 8, !dbg !174
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op, %struct.String* %s), !dbg !174
  %output_op7 = call i8* @String.operator.output(%struct.String* %s), !dbg !174
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %output_op7), !dbg !174
  call void @Hero.delete(%struct.Hero* %hero), !dbg !174
  call void @Loot.delete(%struct.Loot* %loot), !dbg !174
  call void @String.delete(%struct.String* %s), !dbg !174
  call void @Hero.delete(%struct.Hero* %tmp_struct), !dbg !174
  call void @String.delete(%struct.String* %out_tmp), !dbg !174
  call void @String.delete(%struct.String* %tmp_struct6), !dbg !174
  ret i32 0, !dbg !174
}
...
!3 = !DIFile(filename: "floor20.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
...
!160 = distinct !DISubprogram(name: "Hero.new", linkageName: "Hero.new", scope: null, file: !3, line: 13, type: !5, scopeLine: 13, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 13, scope: !160)
!162 = distinct !DISubprogram(name: "Hero.operator.output", linkageName: "Hero.operator.output", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 0, scope: !162)
!164 = !DILocation(line: 22, scope: !162)
!165 = !DILocation(line: 23, scope: !162)
!166 = !DILocation(line: 24, scope: !162)
!167 = !DILocation(line: 25, scope: !162)
!168 = !DILocation(line: 26, scope: !162)
!169 = !DILocation(line: 27, scope: !162)
!170 = !DILocation(line: 28, scope: !162)
!171 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 35, type: !5, scopeLine: 35, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!172 = !DILocation(line: 35, scope: !171)
!173 = !DILocation(line: 36, scope: !171)
!174 = !DILocation(line: 44, scope: !171)
