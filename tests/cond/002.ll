; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/cond/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/cond/002.ura"
...
@output_fmt.1 = private unnamed_addr constant [12 x i8] c"is not one\0A\00", align 1
...
if.else:                                          ; preds = %if.start
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.1, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end, !dbg !7
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/cond")
