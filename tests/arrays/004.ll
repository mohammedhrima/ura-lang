; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays/004.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [7 x i8] c"Aldric\00", align 1
@STR2 = private unnamed_addr constant [4 x i8] c"Orc\00", align 1
@STR3 = private unnamed_addr constant [7 x i8] c"Dragon\00", align 1
@STR4 = private unnamed_addr constant [5 x i8] c" vs \00", align 1
@STR5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [10 x i8] c"%s vs %s\0A\00", align 1
@STR6 = private unnamed_addr constant [14 x i8] c" approaches!\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [16 x i8] c"%s approaches!\0A\00", align 1
...
@output_fmt.6 = private unnamed_addr constant [10 x i8] c"%s %s %s\0A\00", align 1
...
entry:
  %names = alloca i8**, align 8, !dbg !161
  %bools = alloca i1*, align 8, !dbg !161
  store i8** null, i8*** %names, align 8, !dbg !161
  ...
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR1, i32 0, i32 0), i8** %lit_elem, align 8, !dbg !161
  %lit_elem1 = getelementptr i8*, i8** %lit_data, i32 1, !dbg !161
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR2, i32 0, i32 0), i8** %lit_elem1, align 8, !dbg !161
  ...
  store i8** %lit_data, i8*** %names, align 8, !dbg !161
  %names3 = load i8**, i8*** %names, align 8, !dbg !162
  %ACCESS = getelementptr i8*, i8** %names3, i32 0, !dbg !162
  %ACC = load i8*, i8** %ACCESS, align 8, !dbg !162
  %names4 = load i8**, i8*** %names, align 8, !dbg !162
  %ACCESS5 = getelementptr i8*, i8** %names4, i32 1, !dbg !162
  %ACC6 = load i8*, i8** %ACCESS5, align 8, !dbg !162
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 2, i8* %ACC, i8* %ACC6), !dbg !162
  %names7 = load i8**, i8*** %names, align 8, !dbg !163
  %ACCESS8 = getelementptr i8*, i8** %names7, i32 2, !dbg !163
  %ACC9 = load i8*, i8** %ACCESS8, align 8, !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %ACC9), !dbg !163
  store i1* null, i1** %bools, align 8, !dbg !161
  %array_lit10 = call i8* @calloc(i64 3, i64 1), !dbg !161
  %lit_data11 = bitcast i8* %array_lit10 to i1*, !dbg !161
  %lit_elem12 = getelementptr i1, i1* %lit_data11, i32 0, !dbg !161
  store i1 true, i1* %lit_elem12, align 1, !dbg !161
  %lit_elem13 = getelementptr i1, i1* %lit_data11, i32 1, !dbg !161
  store i1 false, i1* %lit_elem13, align 1, !dbg !161
  %lit_elem14 = getelementptr i1, i1* %lit_data11, i32 2, !dbg !161
  store i1 true, i1* %lit_elem14, align 1, !dbg !161
  store i1* %lit_data11, i1** %bools, align 8, !dbg !161
  %bools15 = load i1*, i1** %bools, align 8, !dbg !164
  %ACCESS16 = getelementptr i1, i1* %bools15, i32 0, !dbg !164
  %ACC17 = load i1, i1* %ACCESS16, align 1, !dbg !164
  %bool_str = select i1 %ACC17, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str, i32 0, i32 0), !dbg !164
  %bools18 = load i1*, i1** %bools, align 8, !dbg !164
  %ACCESS19 = getelementptr i1, i1* %bools18, i32 1, !dbg !164
  %ACC20 = load i1, i1* %ACCESS19, align 1, !dbg !164
  %bool_str21 = select i1 %ACC20, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.2, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.3, i32 0, i32 0), !dbg !164
  %bools22 = load i1*, i1** %bools, align 8, !dbg !164
  %ACCESS23 = getelementptr i1, i1* %bools22, i32 2, !dbg !164
  %ACC24 = load i1, i1* %ACCESS23, align 1, !dbg !164
  %bool_str25 = select i1 %ACC24, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.4, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.5, i32 0, i32 0), !dbg !164
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.6, i32 0, i32 0), i32 3, i8* %bool_str, i8* %bool_str21, i8* %bool_str25), !dbg !164
  ret i32 0, !dbg !164
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays")
