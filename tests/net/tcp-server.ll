...
if.then:                                          ; preds = %if.start
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0), i32 0), !dbg !162
  ret i32 1, !dbg !162
...
if.end12:                                         ; preds = %if.start11
  ...
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @output_fmt.2, i32 0, i32 0), i32 0), !dbg !169
...
if.then13:                                        ; preds = %if.start11
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.1, i32 0, i32 0), i32 0), !dbg !168
  ret i32 1, !dbg !168
...
if.end20:                                         ; preds = %if.start19
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.3, i32 0, i32 0), i32 0), !dbg !171
...
if.then28:                                        ; preds = %if.start26
  ...
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt.4, i32 0, i32 0), i32 1, i8* %buf30), !dbg !174
  ...
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.5, i32 0, i32 0), i32 0), !dbg !176
  br label %if.end27, !dbg !176
}
