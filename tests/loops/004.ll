; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops/004.ura"
...
@output_fmt.2 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@STR4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@STR5 = private unnamed_addr constant [2 x i8] c" \00", align 1
@output_fmt.4 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@STR6 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@STR7 = private unnamed_addr constant [2 x i8] c" \00", align 1
@output_fmt.6 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@STR8 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.7 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@STR9 = private unnamed_addr constant [2 x i8] c" \00", align 1
@output_fmt.8 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@STR10 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.9 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@STR11 = private unnamed_addr constant [2 x i8] c" \00", align 1
@output_fmt.10 = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@STR12 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.11 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
...
entry:
  ...
  %i2 = alloca i32, align 4, !dbg !161
  %i14 = alloca i32, align 4, !dbg !161
  %i26 = alloca i32, align 4, !dbg !161
  %i38 = alloca i32, align 4, !dbg !161
  %i51 = alloca i32, align 4, !dbg !161
  store i32 0, i32* %i, align 4, !dbg !161
  store i32 0, i32* %i, align 4, !dbg !161
  br label %for.cond, !dbg !161

for.cond:                                         ; preds = %for.step, %entry
  %iv = load i32, i32* %i, align 4, !dbg !161
  %lt = icmp slt i32 %iv, 5, !dbg !161
  %gt = icmp sgt i32 %iv, 5, !dbg !161
  %keep = select i1 true, i1 %lt, i1 %gt, !dbg !161
  br i1 %keep, label %for.body, label %for.end, !dbg !161

for.body:                                         ; preds = %for.cond
  %i1 = load i32, i32* %i, align 4, !dbg !161
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 %i1), !dbg !161
  br label %for.step, !dbg !161

for.step:                                         ; preds = %for.body
  %iv2 = load i32, i32* %i, align 4, !dbg !161
  %next = add i32 %iv2, 1, !dbg !161
  store i32 %next, i32* %i, align 4, !dbg !161
  br label %for.cond, !dbg !161

for.end:                                          ; preds = %for.cond
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.1, i32 0, i32 0)), !dbg !161
  store i32 0, i32* %i2, align 4, !dbg !161
  store i32 5, i32* %i2, align 4, !dbg !161
  br label %for.cond3, !dbg !161

for.cond3:                                        ; preds = %for.step5, %for.end
  %iv7 = load i32, i32* %i2, align 4, !dbg !161
  %lt8 = icmp slt i32 %iv7, 0, !dbg !161
  %gt9 = icmp sgt i32 %iv7, 0, !dbg !161
  %keep10 = select i1 false, i1 %lt8, i1 %gt9, !dbg !161
  br i1 %keep10, label %for.body4, label %for.end6, !dbg !161

for.body4:                                        ; preds = %for.cond3
  %i11 = load i32, i32* %i2, align 4, !dbg !161
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 %i11), !dbg !161
  br label %for.step5, !dbg !161

for.step5:                                        ; preds = %for.body4
  %iv212 = load i32, i32* %i2, align 4, !dbg !161
  %next13 = add i32 %iv212, -1, !dbg !161
  store i32 %next13, i32* %i2, align 4, !dbg !161
  br label %for.cond3, !dbg !161

for.end6:                                         ; preds = %for.cond3
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.3, i32 0, i32 0)), !dbg !161
  store i32 0, i32* %i14, align 4, !dbg !161
  store i32 0, i32* %i14, align 4, !dbg !161
  br label %for.cond15, !dbg !161

for.cond15:                                       ; preds = %for.step17, %for.end6
  %iv19 = load i32, i32* %i14, align 4, !dbg !161
  %lt20 = icmp slt i32 %iv19, 20, !dbg !161
  %gt21 = icmp sgt i32 %iv19, 20, !dbg !161
  %keep22 = select i1 true, i1 %lt20, i1 %gt21, !dbg !161
  br i1 %keep22, label %for.body16, label %for.end18, !dbg !161

for.body16:                                       ; preds = %for.cond15
  %i23 = load i32, i32* %i14, align 4, !dbg !161
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 %i23), !dbg !161
  br label %for.step17, !dbg !161

for.step17:                                       ; preds = %for.body16
  %iv224 = load i32, i32* %i14, align 4, !dbg !161
  %next25 = add i32 %iv224, 5, !dbg !161
  store i32 %next25, i32* %i14, align 4, !dbg !161
  br label %for.cond15, !dbg !161

for.end18:                                        ; preds = %for.cond15
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.5, i32 0, i32 0)), !dbg !161
  store i32 0, i32* %i26, align 4, !dbg !161
  store i32 20, i32* %i26, align 4, !dbg !161
  br label %for.cond27, !dbg !161

for.cond27:                                       ; preds = %for.step29, %for.end18
  %iv31 = load i32, i32* %i26, align 4, !dbg !161
  %lt32 = icmp slt i32 %iv31, 0, !dbg !161
  %gt33 = icmp sgt i32 %iv31, 0, !dbg !161
  %keep34 = select i1 false, i1 %lt32, i1 %gt33, !dbg !161
  br i1 %keep34, label %for.body28, label %for.end30, !dbg !161

for.body28:                                       ; preds = %for.cond27
  %i35 = load i32, i32* %i26, align 4, !dbg !161
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i32 %i35), !dbg !161
  br label %for.step29, !dbg !161

for.step29:                                       ; preds = %for.body28
  %iv236 = load i32, i32* %i26, align 4, !dbg !161
  %next37 = add i32 %iv236, -5, !dbg !161
  store i32 %next37, i32* %i26, align 4, !dbg !161
  br label %for.cond27, !dbg !161

for.end30:                                        ; preds = %for.cond27
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.7, i32 0, i32 0)), !dbg !161
  store i32 0, i32* %i38, align 4, !dbg !161
  store i32 0, i32* %i38, align 4, !dbg !161
  br label %for.cond39, !dbg !161

for.cond39:                                       ; preds = %for.step41, %for.end30
  %iv43 = load i32, i32* %i38, align 4, !dbg !161
  %lt44 = icmp slt i32 %iv43, 100, !dbg !161
  %gt45 = icmp sgt i32 %iv43, 100, !dbg !161
  %keep46 = select i1 true, i1 %lt44, i1 %gt45, !dbg !161
  br i1 %keep46, label %for.body40, label %for.end42, !dbg !161

for.body40:                                       ; preds = %for.cond39
  br label %if.start, !dbg !161

for.step41:                                       ; preds = %if.end
  %iv249 = load i32, i32* %i38, align 4, !dbg !161
  %next50 = add i32 %iv249, 1, !dbg !161
  store i32 %next50, i32* %i38, align 4, !dbg !161
  br label %for.cond39, !dbg !161

for.end42:                                        ; preds = %if.then, %for.cond39
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.9, i32 0, i32 0)), !dbg !161
  store i32 0, i32* %i51, align 4, !dbg !161
  store i32 0, i32* %i51, align 4, !dbg !161
  br label %for.cond52, !dbg !161

if.start:                                         ; preds = %for.body40
  %i47 = load i32, i32* %i38, align 4, !dbg !161
  %GT = icmp sgt i32 %i47, 3, !dbg !161
  br i1 %GT, label %if.then, label %if.end, !dbg !161

if.end:                                           ; preds = %if.start
  %i48 = load i32, i32* %i38, align 4, !dbg !161
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i32 %i48), !dbg !161
  br label %for.step41, !dbg !161

if.then:                                          ; preds = %if.start
  br label %for.end42, !dbg !161

for.cond52:                                       ; preds = %for.step54, %for.end42
  %iv56 = load i32, i32* %i51, align 4, !dbg !161
  %lt57 = icmp slt i32 %iv56, 6, !dbg !161
  %gt58 = icmp sgt i32 %iv56, 6, !dbg !161
  %keep59 = select i1 true, i1 %lt57, i1 %gt58, !dbg !161
  br i1 %keep59, label %for.body53, label %for.end55, !dbg !161

for.body53:                                       ; preds = %for.cond52
  br label %if.start60, !dbg !161

for.step54:                                       ; preds = %if.end61, %if.then62
  %iv265 = load i32, i32* %i51, align 4, !dbg !161
  %next66 = add i32 %iv265, 1, !dbg !161
  store i32 %next66, i32* %i51, align 4, !dbg !161
  br label %for.cond52, !dbg !161

for.end55:                                        ; preds = %for.cond52
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.11, i32 0, i32 0)), !dbg !161
  ret i32 0, !dbg !161

if.start60:                                       ; preds = %for.body53
  %i63 = load i32, i32* %i51, align 4, !dbg !161
  %MOD = srem i32 %i63, 2, !dbg !161
  %NEQ = icmp ne i32 %MOD, 0, !dbg !161
  br i1 %NEQ, label %if.then62, label %if.end61, !dbg !161

if.end61:                                         ; preds = %if.start60
  %i64 = load i32, i32* %i51, align 4, !dbg !161
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.10, i32 0, i32 0), i32 %i64), !dbg !161
  br label %for.step54, !dbg !161
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops")
