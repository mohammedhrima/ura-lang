; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/006.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/006.ura"
...
@STR3 = private unnamed_addr constant [4 x i8] c"-99\00", align 1
...
@output_fmt.2 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@STR7 = private unnamed_addr constant [6 x i8] c"apple\00", align 1
@STR8 = private unnamed_addr constant [7 x i8] c"banana\00", align 1
@STR9 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.3 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@STR10 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.4 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
...
@STR12 = private unnamed_addr constant [12 x i8] c"Hello World\00", align 1
...
@STR14 = private unnamed_addr constant [5 x i8] c"aaaa\00", align 1
@STR15 = private unnamed_addr constant [5 x i8] c"bbbb\00", align 1
@STR16 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.7 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@STR17 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.8 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
...
entry:
  %s1 = alloca %struct.String, align 8, !dbg !161
  %s2 = alloca %struct.String, align 8, !dbg !161
  %s3 = alloca %struct.String, align 8, !dbg !161
  ...
  %big = alloca %struct.String, align 8, !dbg !161
  %i = alloca i32, align 4, !dbg !161
  %n1 = alloca %struct.String, align 8, !dbg !161
  %n2 = alloca %struct.String, align 8, !dbg !161
  store %struct.String zeroinitializer, %struct.String* %s1, align 8, !dbg !161
  ...
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op, %struct.String* %s1), !dbg !162
  %String.to_int = call i32 @String.to_int(%struct.String* %s1), !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %String.to_int), !dbg !163
  store %struct.String zeroinitializer, %struct.String* %s2, align 8, !dbg !161
  %2 = call %struct.String @String.from(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR3, i32 0, i32 0)), !dbg !164
  %tmp_struct1 = alloca %struct.String, align 8, !dbg !164
  store %struct.String %2, %struct.String* %tmp_struct1, align 8, !dbg !164
  %tmp_op2 = alloca %struct.String, align 8, !dbg !164
  store %struct.String %2, %struct.String* %tmp_op2, align 8, !dbg !164
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op2, %struct.String* %s2), !dbg !164
  %String.to_int3 = call i32 @String.to_int(%struct.String* %s2), !dbg !165
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %String.to_int3), !dbg !165
  store %struct.String zeroinitializer, %struct.String* %s3, align 8, !dbg !161
  %4 = call %struct.String @String.from(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @STR5, i32 0, i32 0)), !dbg !166
  %tmp_struct4 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %4, %struct.String* %tmp_struct4, align 8, !dbg !166
  %tmp_op5 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %4, %struct.String* %tmp_op5, align 8, !dbg !166
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op5, %struct.String* %s3), !dbg !166
  %String.to_int6 = call i32 @String.to_int(%struct.String* %s3), !dbg !167
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i32 %String.to_int6), !dbg !167
  store %struct.String zeroinitializer, %struct.String* %a, align 8, !dbg !161
  %6 = call %struct.String @String.from(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR7, i32 0, i32 0)), !dbg !168
  %tmp_struct7 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %6, %struct.String* %tmp_struct7, align 8, !dbg !168
  %tmp_op8 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %6, %struct.String* %tmp_op8, align 8, !dbg !168
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op8, %struct.String* %a), !dbg !168
  store %struct.String zeroinitializer, %struct.String* %b, align 8, !dbg !161
  %7 = call %struct.String @String.from(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR8, i32 0, i32 0)), !dbg !169
  %tmp_struct9 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %7, %struct.String* %tmp_struct9, align 8, !dbg !169
  %tmp_op10 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %7, %struct.String* %tmp_op10, align 8, !dbg !169
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op10, %struct.String* %b), !dbg !169
  %String.compare = call i32 @String.compare(%struct.String* %b, %struct.String* %a), !dbg !170
  %8 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i32 1, i32 %String.compare), !dbg !170
  %String.compare11 = call i32 @String.compare(%struct.String* %a, %struct.String* %b), !dbg !171
  %9 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 1, i32 %String.compare11), !dbg !171
  %String.compare12 = call i32 @String.compare(%struct.String* %a, %struct.String* %a), !dbg !172
  %10 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.5, i32 0, i32 0), i32 1, i32 %String.compare12), !dbg !172
  store %struct.String zeroinitializer, %struct.String* %s, align 8, !dbg !161
  %11 = call %struct.String @String.from(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @STR12, i32 0, i32 0)), !dbg !173
  %tmp_struct13 = alloca %struct.String, align 8, !dbg !173
  store %struct.String %11, %struct.String* %tmp_struct13, align 8, !dbg !173
  %tmp_op14 = alloca %struct.String, align 8, !dbg !173
  store %struct.String %11, %struct.String* %tmp_op14, align 8, !dbg !173
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op14, %struct.String* %s), !dbg !173
  store %struct.String zeroinitializer, %struct.String* %r, align 8, !dbg !161
  %String.upper = call %struct.String @String.upper(%struct.String* %s), !dbg !174
  %tmp_struct15 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %String.upper, %struct.String* %tmp_struct15, align 8, !dbg !174
  %tmp_op16 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %String.upper, %struct.String* %tmp_op16, align 8, !dbg !174
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op16, %struct.String* %r), !dbg !174
  store %struct.String zeroinitializer, %struct.String* %r2, align 8, !dbg !161
  %String.reverse = call %struct.String @String.reverse(%struct.String* %r), !dbg !175
  %tmp_struct17 = alloca %struct.String, align 8, !dbg !175
  store %struct.String %String.reverse, %struct.String* %tmp_struct17, align 8, !dbg !175
  %tmp_op18 = alloca %struct.String, align 8, !dbg !175
  store %struct.String %String.reverse, %struct.String* %tmp_op18, align 8, !dbg !175
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op18, %struct.String* %r2), !dbg !175
  %value = getelementptr %struct.String, %struct.String* %r2, i32 0, i32 0, !dbg !175
  %DOT = load i8*, i8** %value, align 8, !dbg !175
  %12 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i32 1, i8* %DOT), !dbg !175
  store %struct.String zeroinitializer, %struct.String* %big, align 8, !dbg !161
  %13 = call %struct.String @String.from(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR14, i32 0, i32 0)), !dbg !176
  %tmp_struct19 = alloca %struct.String, align 8, !dbg !176
  store %struct.String %13, %struct.String* %tmp_struct19, align 8, !dbg !176
  %tmp_op20 = alloca %struct.String, align 8, !dbg !176
  store %struct.String %13, %struct.String* %tmp_op20, align 8, !dbg !176
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op20, %struct.String* %big), !dbg !176
  store i32 0, i32* %i, align 4, !dbg !161
  store i32 0, i32* %i, align 4, !dbg !161
  br label %while.start, !dbg !161

while.start:                                      ; preds = %while.then, %entry
  %i21 = load i32, i32* %i, align 4, !dbg !161
  %LT = icmp slt i32 %i21, 5, !dbg !161
  br i1 %LT, label %while.then, label %while.end, !dbg !161

while.then:                                       ; preds = %while.start
  call void @String.join(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR15, i32 0, i32 0), %struct.String* %big), !dbg !177
  %i22 = load i32, i32* %i, align 4, !dbg !177
  %ADD = add i32 %i22, 1, !dbg !177
  store i32 %ADD, i32* %i, align 4, !dbg !177
  br label %while.start, !dbg !177

while.end:                                        ; preds = %while.start
  %String.len = call i32 @String.len(%struct.String* %big), !dbg !178
  %14 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.7, i32 0, i32 0), i32 1, i32 %String.len), !dbg !178
  store %struct.String zeroinitializer, %struct.String* %n1, align 8, !dbg !161
  %15 = call %struct.String @String.from_int(i32 1000000), !dbg !179
  %tmp_struct23 = alloca %struct.String, align 8, !dbg !179
  store %struct.String %15, %struct.String* %tmp_struct23, align 8, !dbg !179
  %tmp_op24 = alloca %struct.String, align 8, !dbg !179
  store %struct.String %15, %struct.String* %tmp_op24, align 8, !dbg !179
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op24, %struct.String* %n1), !dbg !179
  %value25 = getelementptr %struct.String, %struct.String* %n1, i32 0, i32 0, !dbg !179
  %DOT26 = load i8*, i8** %value25, align 8, !dbg !179
  %16 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i32 1, i8* %DOT26), !dbg !179
  store %struct.String zeroinitializer, %struct.String* %n2, align 8, !dbg !161
  %17 = call %struct.String @String.from_int(i32 -2000000), !dbg !180
  %tmp_struct27 = alloca %struct.String, align 8, !dbg !180
  store %struct.String %17, %struct.String* %tmp_struct27, align 8, !dbg !180
  %tmp_op28 = alloca %struct.String, align 8, !dbg !180
  store %struct.String %17, %struct.String* %tmp_op28, align 8, !dbg !180
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op28, %struct.String* %n2), !dbg !180
  %value29 = getelementptr %struct.String, %struct.String* %n2, i32 0, i32 0, !dbg !180
  %DOT30 = load i8*, i8** %value29, align 8, !dbg !180
  %18 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.9, i32 0, i32 0), i32 1, i8* %DOT30), !dbg !180
  call void @String.delete(%struct.String* %s1), !dbg !180
  call void @String.delete(%struct.String* %s2), !dbg !180
  call void @String.delete(%struct.String* %s3), !dbg !180
  call void @String.delete(%struct.String* %a), !dbg !180
  call void @String.delete(%struct.String* %b), !dbg !180
  call void @String.delete(%struct.String* %s), !dbg !180
  call void @String.delete(%struct.String* %r), !dbg !180
  call void @String.delete(%struct.String* %r2), !dbg !180
  call void @String.delete(%struct.String* %big), !dbg !180
  call void @String.delete(%struct.String* %n1), !dbg !180
  call void @String.delete(%struct.String* %n2), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct1), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct4), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct7), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct9), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct13), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct15), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct17), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct19), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct23), !dbg !180
  call void @String.delete(%struct.String* %tmp_struct27), !dbg !180
  ret i32 0, !dbg !180
}
...
!3 = !DIFile(filename: "006.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string")
...
!167 = !DILocation(line: 12, scope: !160)
!168 = !DILocation(line: 14, scope: !160)
!169 = !DILocation(line: 15, scope: !160)
!170 = !DILocation(line: 16, scope: !160)
!171 = !DILocation(line: 17, scope: !160)
!172 = !DILocation(line: 18, scope: !160)
!173 = !DILocation(line: 20, scope: !160)
!174 = !DILocation(line: 21, scope: !160)
!175 = !DILocation(line: 22, scope: !160)
!176 = !DILocation(line: 25, scope: !160)
!177 = !DILocation(line: 28, scope: !160)
!178 = !DILocation(line: 30, scope: !160)
!179 = !DILocation(line: 32, scope: !160)
!180 = !DILocation(line: 35, scope: !160)
