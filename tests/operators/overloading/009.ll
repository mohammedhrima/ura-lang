; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/operators/overloading/009.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/operators/overloading/009.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }
%struct.String2 = type { i8*, i32, i32 }
...
@STR2 = private unnamed_addr constant [9 x i8] c"v    -> \00", align 1
@STR3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [12 x i8] c"v    -> %s\0A\00", align 1
@STR4 = private unnamed_addr constant [9 x i8] c"self -> \00", align 1
@STR5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [12 x i8] c"self -> %s\0A\00", align 1
@STR6 = private unnamed_addr constant [6 x i8] c"12345\00", align 1
@STR7 = private unnamed_addr constant [5 x i8] c"6789\00", align 1
@STR8 = private unnamed_addr constant [8 x i8] c"value: \00", align 1
@STR9 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [11 x i8] c"value: %s\0A\00", align 1
...
define %struct.String2 @String2.new() !dbg !160 {
entry:
  %s = alloca %struct.String2, align 8, !dbg !161
  store %struct.String2 zeroinitializer, %struct.String2* %s, align 8, !dbg !161
  %size = getelementptr %struct.String2, %struct.String2* %s, i32 0, i32 2, !dbg !161
  store i32 10, i32* %size, align 4, !dbg !161
  %value = getelementptr %struct.String2, %struct.String2* %s, i32 0, i32 0, !dbg !161
  %calloc = call i8* @calloc(i64 10, i64 1), !dbg !162
  store i8* %calloc, i8** %value, align 8, !dbg !162
  %s1 = load %struct.String2, %struct.String2* %s, align 8, !dbg !162
  ret %struct.String2 %s1, !dbg !162
}

define void @String2.delete(%struct.String2* %self) !dbg !163 {
entry:
  %self1 = alloca %struct.String2*, align 8, !dbg !164
  store %struct.String2* %self, %struct.String2** %self1, align 8, !dbg !164
  %self2 = load %struct.String2*, %struct.String2** %self1, align 8, !dbg !165
  %value = getelementptr %struct.String2, %struct.String2* %self2, i32 0, i32 0, !dbg !165
  %DOT = load i8*, i8** %value, align 8, !dbg !165
  call void @free(i8* %DOT), !dbg !165
  %self3 = load %struct.String2*, %struct.String2** %self1, align 8, !dbg !165
  ret void, !dbg !165
}

define void @String2.assign(i8* %str, %struct.String2* %self) !dbg !166 {
entry:
  %str1 = alloca i8*, align 8, !dbg !167
  %self2 = alloca %struct.String2*, align 8, !dbg !167
  %len = alloca i32, align 4, !dbg !167
  store i8* %str, i8** %str1, align 8, !dbg !167
  store %struct.String2* %self, %struct.String2** %self2, align 8, !dbg !167
  br label %if.start, !dbg !167

if.start:                                         ; preds = %entry
  %str3 = load i8*, i8** %str1, align 8, !dbg !167
  %EQ = icmp eq i8* %str3, null, !dbg !167
  br i1 %EQ, label %if.then, label %if.end, !dbg !167

if.end:                                           ; preds = %if.start
  store i32 0, i32* %len, align 4, !dbg !167
  %str4 = load i8*, i8** %str1, align 8, !dbg !168
  %strlen = call i32 @strlen(i8* %str4), !dbg !168
  store i32 %strlen, i32* %len, align 4, !dbg !168
  br label %if.start5, !dbg !168

if.then:                                          ; preds = %if.start
  %ref_arg = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !169
  call void @String2.assign(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @STR1, i32 0, i32 0), %struct.String2* %ref_arg), !dbg !169
  ret void, !dbg !169

if.start5:                                        ; preds = %if.end
  %self8 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !168
  %size = getelementptr %struct.String2, %struct.String2* %self8, i32 0, i32 2, !dbg !168
  %DOT = load i32, i32* %size, align 4, !dbg !168
  %len9 = load i32, i32* %len, align 4, !dbg !168
  %LT = icmp slt i32 %DOT, %len9, !dbg !168
  br i1 %LT, label %if.then7, label %if.end6, !dbg !168

if.end6:                                          ; preds = %while.end, %if.start5
  %self25 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !170
  %value26 = getelementptr %struct.String2, %struct.String2* %self25, i32 0, i32 0, !dbg !170
  %DOT27 = load i8*, i8** %value26, align 8, !dbg !170
  %self28 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !170
  %size29 = getelementptr %struct.String2, %struct.String2* %self28, i32 0, i32 2, !dbg !170
  %DOT30 = load i32, i32* %size29, align 4, !dbg !170
  %as = sext i32 %DOT30 to i64, !dbg !170
  call void @bzero(i8* %DOT27, i64 %as), !dbg !170
  %self31 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !171
  %value32 = getelementptr %struct.String2, %struct.String2* %self31, i32 0, i32 0, !dbg !171
  %DOT33 = load i8*, i8** %value32, align 8, !dbg !171
  %str34 = load i8*, i8** %str1, align 8, !dbg !171
  %strcpy = call i8* @strcpy(i8* %DOT33, i8* %str34), !dbg !171
  %self35 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !171
  %count = getelementptr %struct.String2, %struct.String2* %self35, i32 0, i32 1, !dbg !171
  %len36 = load i32, i32* %len, align 4, !dbg !171
  store i32 %len36, i32* %count, align 4, !dbg !171
  ret void, !dbg !171

if.then7:                                         ; preds = %if.start5
  br label %while.start, !dbg !168

while.start:                                      ; preds = %while.then, %if.then7
  %self10 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !168
  %size11 = getelementptr %struct.String2, %struct.String2* %self10, i32 0, i32 2, !dbg !168
  %DOT12 = load i32, i32* %size11, align 4, !dbg !168
  %len13 = load i32, i32* %len, align 4, !dbg !168
  %LT14 = icmp slt i32 %DOT12, %len13, !dbg !168
  br i1 %LT14, label %while.then, label %while.end, !dbg !168

while.then:                                       ; preds = %while.start
  %self15 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !168
  %size16 = getelementptr %struct.String2, %struct.String2* %self15, i32 0, i32 2, !dbg !168
  %DOT17 = load i32, i32* %size16, align 4, !dbg !168
  %MUL = mul i32 %DOT17, 2, !dbg !168
  store i32 %MUL, i32* %size16, align 4, !dbg !168
  br label %while.start, !dbg !168

while.end:                                        ; preds = %while.start
  %self18 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !168
  %value = getelementptr %struct.String2, %struct.String2* %self18, i32 0, i32 0, !dbg !168
  %self19 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !172
  %value20 = getelementptr %struct.String2, %struct.String2* %self19, i32 0, i32 0, !dbg !172
  %DOT21 = load i8*, i8** %value20, align 8, !dbg !172
  %self22 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !172
  %size23 = getelementptr %struct.String2, %struct.String2* %self22, i32 0, i32 2, !dbg !172
  %DOT24 = load i32, i32* %size23, align 4, !dbg !172
  %realloc = call i8* @realloc(i8* %DOT21, i32 %DOT24), !dbg !172
  store i8* %realloc, i8** %value, align 8, !dbg !172
  br label %if.end6, !dbg !172
}

define void @String2.join(i8* %str, %struct.String2* %self) !dbg !173 {
entry:
  %str1 = alloca i8*, align 8, !dbg !174
  %self2 = alloca %struct.String2*, align 8, !dbg !174
  %res = alloca i8*, align 8, !dbg !174
  store i8* %str, i8** %str1, align 8, !dbg !174
  store %struct.String2* %self, %struct.String2** %self2, align 8, !dbg !174
  br label %if.start, !dbg !174

if.start:                                         ; preds = %entry
  %str3 = load i8*, i8** %str1, align 8, !dbg !174
  %EQ = icmp eq i8* %str3, null, !dbg !174
  br i1 %EQ, label %if.then, label %if.end, !dbg !174

if.end:                                           ; preds = %if.start
  store i8* null, i8** %res, align 8, !dbg !174
  %self4 = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !175
  %value = getelementptr %struct.String2, %struct.String2* %self4, i32 0, i32 0, !dbg !175
  %DOT = load i8*, i8** %value, align 8, !dbg !175
  %str5 = load i8*, i8** %str1, align 8, !dbg !175
  %strjoin = call i8* @strjoin(i8* %DOT, i8* %str5), !dbg !175
  store i8* %strjoin, i8** %res, align 8, !dbg !175
  %res6 = load i8*, i8** %res, align 8, !dbg !176
  %ref_arg = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !176
  call void @String2.assign(i8* %res6, %struct.String2* %ref_arg), !dbg !176
  ret void, !dbg !176
...
define void @String2.operator.ASSIGN.CHARS(i8* %str, %struct.String2* %self) !dbg !177 {
entry:
  %str1 = alloca i8*, align 8, !dbg !178
  %self2 = alloca %struct.String2*, align 8, !dbg !178
  store i8* %str, i8** %str1, align 8, !dbg !178
  store %struct.String2* %self, %struct.String2** %self2, align 8, !dbg !178
  %str3 = load i8*, i8** %str1, align 8, !dbg !179
  %ref_arg = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !179
  call void @String2.assign(i8* %str3, %struct.String2* %ref_arg), !dbg !179
  ret void, !dbg !179
}

define void @String2.operator.ASSIGN.String2(%struct.String2* %v, %struct.String2* %self) !dbg !180 {
entry:
  %v1 = alloca %struct.String2*, align 8, !dbg !181
  %self2 = alloca %struct.String2*, align 8, !dbg !181
  store %struct.String2* %v, %struct.String2** %v1, align 8, !dbg !181
  store %struct.String2* %self, %struct.String2** %self2, align 8, !dbg !181
  %v3 = load %struct.String2*, %struct.String2** %v1, align 8, !dbg !182
  %value = getelementptr %struct.String2, %struct.String2* %v3, i32 0, i32 0, !dbg !182
  %DOT = load i8*, i8** %value, align 8, !dbg !182
  %ref_arg = load %struct.String2*, %struct.String2** %self2, align 8, !dbg !182
  call void @String2.assign(i8* %DOT, %struct.String2* %ref_arg), !dbg !182
  ret void, !dbg !182
}

define %struct.String2 @add(%struct.String2* %v, %struct.String2* %w) !dbg !183 {
entry:
  %v1 = alloca %struct.String2*, align 8, !dbg !184
  %w2 = alloca %struct.String2*, align 8, !dbg !184
  %res = alloca %struct.String2, align 8, !dbg !184
  store %struct.String2* %v, %struct.String2** %v1, align 8, !dbg !184
  store %struct.String2* %w, %struct.String2** %w2, align 8, !dbg !184
  %v3 = load %struct.String2*, %struct.String2** %v1, align 8, !dbg !184
  %value = getelementptr %struct.String2, %struct.String2* %v3, i32 0, i32 0, !dbg !184
  %DOT = load i8*, i8** %value, align 8, !dbg !184
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %DOT), !dbg !184
  %w4 = load %struct.String2*, %struct.String2** %w2, align 8, !dbg !184
  %value5 = getelementptr %struct.String2, %struct.String2* %w4, i32 0, i32 0, !dbg !184
  %DOT6 = load i8*, i8** %value5, align 8, !dbg !184
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %DOT6), !dbg !184
  store %struct.String2 zeroinitializer, %struct.String2* %res, align 8, !dbg !184
  %2 = call %struct.String2 @String2.new(), !dbg !185
  %tmp_struct = alloca %struct.String2, align 8, !dbg !185
  store %struct.String2 %2, %struct.String2* %tmp_struct, align 8, !dbg !185
  %tmp_op = alloca %struct.String2, align 8, !dbg !185
  store %struct.String2 %2, %struct.String2* %tmp_op, align 8, !dbg !185
  call void @String2.operator.ASSIGN.String2(%struct.String2* %tmp_op, %struct.String2* %res), !dbg !185
  %ref_arg = load %struct.String2*, %struct.String2** %w2, align 8, !dbg !185
  call void @String2.operator.ASSIGN.String2(%struct.String2* %ref_arg, %struct.String2* %res), !dbg !185
  call void @String2.delete(%struct.String2* %tmp_struct), !dbg !185
  %res7 = load %struct.String2, %struct.String2* %res, align 8, !dbg !185
  ret %struct.String2 %res7, !dbg !185
}

declare i32 @printf(i8*, i32, ...)

define i32 @main() !dbg !186 {
entry:
  %s0 = alloca %struct.String2, align 8, !dbg !187
  %s1 = alloca %struct.String2, align 8, !dbg !187
  %s2 = alloca %struct.String2, align 8, !dbg !187
  store %struct.String2 zeroinitializer, %struct.String2* %s0, align 8, !dbg !187
  %0 = call %struct.String2 @String2.new(), !dbg !188
  %tmp_struct = alloca %struct.String2, align 8, !dbg !188
  store %struct.String2 %0, %struct.String2* %tmp_struct, align 8, !dbg !188
  %tmp_op = alloca %struct.String2, align 8, !dbg !188
  store %struct.String2 %0, %struct.String2* %tmp_op, align 8, !dbg !188
  call void @String2.operator.ASSIGN.String2(%struct.String2* %tmp_op, %struct.String2* %s0), !dbg !188
  call void @String2.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR6, i32 0, i32 0), %struct.String2* %s0), !dbg !188
  store %struct.String2 zeroinitializer, %struct.String2* %s1, align 8, !dbg !187
  %1 = call %struct.String2 @String2.new(), !dbg !189
  %tmp_struct1 = alloca %struct.String2, align 8, !dbg !189
  store %struct.String2 %1, %struct.String2* %tmp_struct1, align 8, !dbg !189
  %tmp_op2 = alloca %struct.String2, align 8, !dbg !189
  store %struct.String2 %1, %struct.String2* %tmp_op2, align 8, !dbg !189
  call void @String2.operator.ASSIGN.String2(%struct.String2* %tmp_op2, %struct.String2* %s1), !dbg !189
  call void @String2.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @STR7, i32 0, i32 0), %struct.String2* %s1), !dbg !189
  store %struct.String2 zeroinitializer, %struct.String2* %s2, align 8, !dbg !187
  %2 = call %struct.String2 @String2.new(), !dbg !190
  %tmp_struct3 = alloca %struct.String2, align 8, !dbg !190
  store %struct.String2 %2, %struct.String2* %tmp_struct3, align 8, !dbg !190
  %tmp_op4 = alloca %struct.String2, align 8, !dbg !190
  store %struct.String2 %2, %struct.String2* %tmp_op4, align 8, !dbg !190
  call void @String2.operator.ASSIGN.String2(%struct.String2* %tmp_op4, %struct.String2* %s2), !dbg !190
  %add = call %struct.String2 @add(%struct.String2* %s0, %struct.String2* %s1), !dbg !191
  %tmp_struct5 = alloca %struct.String2, align 8, !dbg !191
  store %struct.String2 %add, %struct.String2* %tmp_struct5, align 8, !dbg !191
  %tmp_op6 = alloca %struct.String2, align 8, !dbg !191
  store %struct.String2 %add, %struct.String2* %tmp_op6, align 8, !dbg !191
  call void @String2.operator.ASSIGN.String2(%struct.String2* %tmp_op6, %struct.String2* %s2), !dbg !191
  %value = getelementptr %struct.String2, %struct.String2* %s2, i32 0, i32 0, !dbg !191
  %DOT = load i8*, i8** %value, align 8, !dbg !191
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %DOT), !dbg !191
  call void @String2.delete(%struct.String2* %s0), !dbg !191
  call void @String2.delete(%struct.String2* %s1), !dbg !191
  call void @String2.delete(%struct.String2* %s2), !dbg !191
  call void @String2.delete(%struct.String2* %tmp_struct), !dbg !191
  call void @String2.delete(%struct.String2* %tmp_struct1), !dbg !191
  call void @String2.delete(%struct.String2* %tmp_struct3), !dbg !191
  call void @String2.delete(%struct.String2* %tmp_struct5), !dbg !191
  ret i32 0, !dbg !191
}
...
!3 = !DIFile(filename: "009.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/operators/overloading")
...
!160 = distinct !DISubprogram(name: "String2.new", linkageName: "String2.new", scope: null, file: !3, line: 26, type: !5, scopeLine: 26, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 26, scope: !160)
!162 = !DILocation(line: 29, scope: !160)
!163 = distinct !DISubprogram(name: "String2.delete", linkageName: "String2.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!164 = !DILocation(line: 0, scope: !163)
!165 = !DILocation(line: 33, scope: !163)
!166 = distinct !DISubprogram(name: "String2.assign", linkageName: "String2.assign", scope: null, file: !3, line: 35, type: !5, scopeLine: 35, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!167 = !DILocation(line: 35, scope: !166)
!168 = !DILocation(line: 39, scope: !166)
!169 = !DILocation(line: 37, scope: !166)
!170 = !DILocation(line: 45, scope: !166)
!171 = !DILocation(line: 46, scope: !166)
!172 = !DILocation(line: 43, scope: !166)
!173 = distinct !DISubprogram(name: "String2.join", linkageName: "String2.join", scope: null, file: !3, line: 49, type: !5, scopeLine: 49, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!174 = !DILocation(line: 49, scope: !173)
!175 = !DILocation(line: 51, scope: !173)
!176 = !DILocation(line: 52, scope: !173)
!177 = distinct !DISubprogram(name: "String2.operator.ASSIGN.CHARS", linkageName: "String2.operator.ASSIGN.CHARS", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!178 = !DILocation(line: 0, scope: !177)
!179 = !DILocation(line: 56, scope: !177)
!180 = distinct !DISubprogram(name: "String2.operator.ASSIGN.String2", linkageName: "String2.operator.ASSIGN.String2", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!181 = !DILocation(line: 0, scope: !180)
!182 = !DILocation(line: 59, scope: !180)
!183 = distinct !DISubprogram(name: "add", linkageName: "add", scope: null, file: !3, line: 61, type: !5, scopeLine: 61, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!184 = !DILocation(line: 61, scope: !183)
!185 = !DILocation(line: 64, scope: !183)
!186 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 70, type: !5, scopeLine: 70, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!187 = !DILocation(line: 70, scope: !186)
!188 = !DILocation(line: 71, scope: !186)
!189 = !DILocation(line: 73, scope: !186)
!190 = !DILocation(line: 75, scope: !186)
!191 = !DILocation(line: 76, scope: !186)
