...
entry:
  ...
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %DOT), !dbg !7
  %DOT1 = load i8**, i8*** getelementptr inbounds (%struct.Os, %struct.Os* @os, i32 0, i32 1), align 8, !dbg !8
  %ACCESS = getelementptr i8*, i8** %DOT1, i32 0, !dbg !8
  %ACC = load i8*, i8** %ACCESS, align 8, !dbg !8
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %ACC), !dbg !8
