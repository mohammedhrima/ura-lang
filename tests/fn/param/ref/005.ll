; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/fn/param/ref/005.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/fn/param/ref/005.ura"
...
entry:
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %n2), !dbg !7
  ret void, !dbg !7
}
...
entry:
  ...
  store i32 42, i32* %a, align 4, !dbg !9
  store i32* %a, i32** %r, align 8, !dbg !9
  %ref_ptr = load i32*, i32** %r, align 8, !dbg !10
  %ref_val = load i32, i32* %ref_ptr, align 4, !dbg !10
  call void @print_val(i32 %ref_val), !dbg !10
  ret i32 0, !dbg !10
}
...
!3 = !DIFile(filename: "005.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/fn/param/ref")
!4 = distinct !DISubprogram(name: "print_val", linkageName: "print_val", scope: null, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
