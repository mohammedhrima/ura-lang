; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/refs/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/refs/004.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @output_fmt, i32 0, i32 0), i32 %hp2), !dbg !7
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @output_fmt.1, i32 0, i32 0), i32 %mp7), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/refs")
