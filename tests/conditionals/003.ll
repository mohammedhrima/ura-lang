; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/conditionals/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/conditionals/003.ura"
...
if.then:                                          ; preds = %if.start
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0)), !dbg !7
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.1, i32 0, i32 0)), !dbg !7
  br label %if.end, !dbg !7

if.else:                                          ; preds = %elif.start
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt.2, i32 0, i32 0)), !dbg !7
  br label %if.end, !dbg !7
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/conditionals")
