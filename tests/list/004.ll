; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/list/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/list/004.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.__list_int = type { i32*, i32, i32 }

@STR0 = private unnamed_addr constant [7 x i8] c"total=\00", align 1
@STR1 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [10 x i8] c"total=%d\0A\00", align 1
...
entry:
  ...
  call void @__list_int.push(i32 5, %struct.__list_int* %v), !dbg !25
  call void @__list_int.push(i32 10, %struct.__list_int* %v), !dbg !26
  call void @__list_int.push(i32 15, %struct.__list_int* %v), !dbg !27
  call void @__list_int.push(i32 20, %struct.__list_int* %v), !dbg !28
...
while.start:                                      ; preds = %while.then, %entry
  ...
  %i1 = load i32, i32* %i, align 4, !dbg !29
  %LT = icmp slt i32 %i1, %__list_int.len, !dbg !29
  br i1 %LT, label %while.then, label %while.end, !dbg !29

while.then:                                       ; preds = %while.start
  %data = getelementptr %struct.__list_int, %struct.__list_int* %v, i32 0, i32 0, !dbg !30
  %DOT = load i32*, i32** %data, align 8, !dbg !30
  %i2 = load i32, i32* %i, align 4, !dbg !30
  %ACCESS = getelementptr i32, i32* %DOT, i32 %i2, !dbg !30
  %total3 = load i32, i32* %total, align 4, !dbg !30
  %ACC = load i32, i32* %ACCESS, align 4, !dbg !30
  %ADD = add i32 %total3, %ACC, !dbg !30
  store i32 %ADD, i32* %total, align 4, !dbg !30
  %i4 = load i32, i32* %i, align 4, !dbg !30
  %ADD5 = add i32 %i4, 1, !dbg !30
  store i32 %ADD5, i32* %i, align 4, !dbg !30
  br label %while.start, !dbg !30

while.end:                                        ; preds = %while.start
  %total6 = load i32, i32* %total, align 4, !dbg !30
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 %total6), !dbg !30
  call void @__list_int.delete(%struct.__list_int* %v), !dbg !30
  ret i32 0, !dbg !30
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/list")
...
!29 = !DILocation(line: 13, scope: !23)
!30 = !DILocation(line: 14, scope: !23)
