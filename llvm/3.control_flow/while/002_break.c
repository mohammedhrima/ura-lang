...
int main()
{
   ...
   LLVMValueRef break_cond = LLVMBuildICmp(builder, LLVMIntEQ, i_inc, LLVMConstInt(int32, 3, 0), "break_cmp");
   
   // BUILD CONDITION for break
   // break_cond ? go to end : continue to loop_cond
   LLVMBuildCondBr(builder, break_cond, end, loop_cond);
