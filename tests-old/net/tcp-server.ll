; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net/tcp-server.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net/tcp-server.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [15 x i8] c"socket failed\0A\00", align 1
@output_fmt = private unnamed_addr constant [15 x i8] c"socket failed\0A\00", align 1
@STR2 = private unnamed_addr constant [13 x i8] c"bind failed\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [13 x i8] c"bind failed\0A\00", align 1
@STR3 = private unnamed_addr constant [27 x i8] c"listening on port 8080...\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [27 x i8] c"listening on port 8080...\0A\00", align 1
@STR4 = private unnamed_addr constant [12 x i8] c"new client\0A\00", align 1
@output_fmt.3 = private unnamed_addr constant [12 x i8] c"new client\0A\00", align 1
@STR5 = private unnamed_addr constant [11 x i8] c"received: \00", align 1
...
@STR7 = private unnamed_addr constant [19 x i8] c"hello from server\0A\00", align 1
@STR8 = private unnamed_addr constant [13 x i8] c"read failed\0A\00", align 1
...
entry:
  %server_fd = alloca i32, align 4, !dbg !161
  %port = alloca i32, align 4, !dbg !161
  %addr = alloca i8*, align 8, !dbg !161
  %result = alloca i32, align 4, !dbg !161
  %buf = alloca i8*, align 8, !dbg !161
  %client_fd = alloca i32, align 4, !dbg !161
  %r = alloca i32, align 4, !dbg !161
  store i32 0, i32* %server_fd, align 4, !dbg !161
  %socket = call i32 @socket(i32 2, i32 1, i32 0), !dbg !162
  store i32 %socket, i32* %server_fd, align 4, !dbg !162
  br label %if.start, !dbg !162

if.start:                                         ; preds = %entry
  %server_fd1 = load i32, i32* %server_fd, align 4, !dbg !162
  %LT = icmp slt i32 %server_fd1, 0, !dbg !162
  br i1 %LT, label %if.then, label %if.end, !dbg !162

if.end:                                           ; preds = %if.start
  store i32 0, i32* %port, align 4, !dbg !161
  store i32 8080, i32* %port, align 4, !dbg !161
  store i8* null, i8** %addr, align 8, !dbg !161
  %calloc = call i8* @calloc(i64 16, i64 1), !dbg !163
  store i8* %calloc, i8** %addr, align 8, !dbg !163
  %addr2 = load i8*, i8** %addr, align 8, !dbg !164
  %ACCESS = getelementptr i8, i8* %addr2, i32 0, !dbg !164
  store i8 2, i8* %ACCESS, align 1, !dbg !164
  %addr3 = load i8*, i8** %addr, align 8, !dbg !165
  %ACCESS4 = getelementptr i8, i8* %addr3, i32 1, !dbg !165
  store i8 0, i8* %ACCESS4, align 1, !dbg !165
  %addr5 = load i8*, i8** %addr, align 8, !dbg !166
  %ACCESS6 = getelementptr i8, i8* %addr5, i32 2, !dbg !166
  store i8 31, i8* %ACCESS6, align 1, !dbg !166
  %addr7 = load i8*, i8** %addr, align 8, !dbg !167
  %ACCESS8 = getelementptr i8, i8* %addr7, i32 3, !dbg !167
  store i8 -112, i8* %ACCESS8, align 1, !dbg !167
  store i32 0, i32* %result, align 4, !dbg !161
  %server_fd9 = load i32, i32* %server_fd, align 4, !dbg !168
  %addr10 = load i8*, i8** %addr, align 8, !dbg !168
  %bind = call i32 @bind(i32 %server_fd9, i8* %addr10, i32 16), !dbg !168
  store i32 %bind, i32* %result, align 4, !dbg !168
  br label %if.start11, !dbg !168

if.then:                                          ; preds = %if.start
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0)), !dbg !162
  ret i32 1, !dbg !162

if.start11:                                       ; preds = %if.end
  %result14 = load i32, i32* %result, align 4, !dbg !168
  %LT15 = icmp slt i32 %result14, 0, !dbg !168
  br i1 %LT15, label %if.then13, label %if.end12, !dbg !168

if.end12:                                         ; preds = %if.start11
  %server_fd16 = load i32, i32* %server_fd, align 4, !dbg !169
  %listen = call i32 @listen(i32 %server_fd16, i32 5), !dbg !169
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @output_fmt.2, i32 0, i32 0)), !dbg !169
  store i8* null, i8** %buf, align 8, !dbg !161
  %calloc17 = call i8* @calloc(i64 1024, i64 1), !dbg !170
  store i8* %calloc17, i8** %buf, align 8, !dbg !170
  store i32 0, i32* %client_fd, align 4, !dbg !161
  store i32 0, i32* %client_fd, align 4, !dbg !161
...
if.then13:                                        ; preds = %if.start11
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.1, i32 0, i32 0)), !dbg !168
  ret i32 1, !dbg !168

while.start:                                      ; preds = %if.end27, %if.then21, %if.end12
  br i1 true, label %while.then, label %while.end, !dbg !161

while.then:                                       ; preds = %while.start
  %server_fd18 = load i32, i32* %server_fd, align 4, !dbg !171
  %accept = call i32 @accept(i32 %server_fd18, i8* null, i8* null), !dbg !171
  store i32 %accept, i32* %client_fd, align 4, !dbg !171
  br label %if.start19, !dbg !171

while.end:                                        ; preds = %while.start
  %buf35 = load i8*, i8** %buf, align 8, !dbg !172
  call void @free(i8* %buf35), !dbg !172
  %addr36 = load i8*, i8** %addr, align 8, !dbg !173
  call void @free(i8* %addr36), !dbg !173
  ret i32 0, !dbg !173

if.start19:                                       ; preds = %while.then
  %client_fd22 = load i32, i32* %client_fd, align 4, !dbg !171
  %LT23 = icmp slt i32 %client_fd22, 0, !dbg !171
  br i1 %LT23, label %if.then21, label %if.end20, !dbg !171

if.end20:                                         ; preds = %if.start19
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.3, i32 0, i32 0)), !dbg !171
  %client_fd24 = load i32, i32* %client_fd, align 4, !dbg !174
  %buf25 = load i8*, i8** %buf, align 8, !dbg !174
  %read = call i32 @read(i32 %client_fd24, i8* %buf25, i32 1023), !dbg !174
  store i32 %read, i32* %r, align 4, !dbg !174
  br label %if.start26, !dbg !174

if.then21:                                        ; preds = %if.start19
  br label %while.start, !dbg !171

if.start26:                                       ; preds = %if.end20
  %r29 = load i32, i32* %r, align 4, !dbg !174
  %GT = icmp sgt i32 %r29, 0, !dbg !174
  br i1 %GT, label %if.then28, label %elif.start, !dbg !174

if.end27:                                         ; preds = %elif.then, %elif.start, %if.then28
  %client_fd34 = load i32, i32* %client_fd, align 4, !dbg !175
  %close = call i32 @close(i32 %client_fd34), !dbg !175
  br label %while.start, !dbg !175

if.then28:                                        ; preds = %if.start26
  %buf30 = load i8*, i8** %buf, align 8, !dbg !174
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt.4, i32 0, i32 0), i8* %buf30), !dbg !174
  %client_fd31 = load i32, i32* %client_fd, align 4, !dbg !176
  %write = call i32 @write(i32 %client_fd31, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @STR7, i32 0, i32 0), i32 18), !dbg !176
  br label %if.end27, !dbg !176

elif.start:                                       ; preds = %if.start26
  %r32 = load i32, i32* %r, align 4, !dbg !176
  %LT33 = icmp slt i32 %r32, 0, !dbg !176
  br i1 %LT33, label %elif.then, label %if.end27, !dbg !176

elif.then:                                        ; preds = %elif.start
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.5, i32 0, i32 0)), !dbg !176
  br label %if.end27, !dbg !176
}
...
!3 = !DIFile(filename: "tcp-server.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net")
...
!163 = !DILocation(line: 11, scope: !160)
!164 = !DILocation(line: 12, scope: !160)
!165 = !DILocation(line: 13, scope: !160)
!166 = !DILocation(line: 14, scope: !160)
!167 = !DILocation(line: 15, scope: !160)
!168 = !DILocation(line: 18, scope: !160)
!169 = !DILocation(line: 23, scope: !160)
!170 = !DILocation(line: 26, scope: !160)
!171 = !DILocation(line: 30, scope: !160)
!172 = !DILocation(line: 42, scope: !160)
!173 = !DILocation(line: 43, scope: !160)
!174 = !DILocation(line: 34, scope: !160)
!175 = !DILocation(line: 40, scope: !160)
