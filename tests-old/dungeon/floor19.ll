; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor19.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor19.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @output_fmt, i32 0, i32 0), i8* %ACC, i8* %ACC11, i8* %ACC14), !dbg !162
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @output_fmt.1, i32 0, i32 0), i32 %ACC17, i32 %ACC20, i32 %ACC23), !dbg !163
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.2, i32 0, i32 0), i32 %roll24, i8* %ACC28), !dbg !164
...
while.end:                                        ; preds = %while.start
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.3, i32 0, i32 0), i32 %total43), !dbg !165
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @output_fmt.4, i32 0, i32 0), i32 %ACC52, i32 %ACC55, i32 %ACC58, i32 %ACC61), !dbg !166
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @output_fmt.5, i32 0, i32 0), i8* %ACC69, i8* %ACC72, i8* %ACC75), !dbg !167
  ret i32 0, !dbg !167
}
...
!3 = !DIFile(filename: "floor19.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
