...
@trap_msg = private unnamed_addr constant [85 x i8] c"\1B[1m\1B[0;31mruntime error: \1B[0mtests/operators/compound/001.ura:11: division by zero\0A\00", align 1
@str.5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@fmt.6 = private unnamed_addr constant [5 x i8] c"%d%s\00", align 1
@trap_msg.7 = private unnamed_addr constant [85 x i8] c"\1B[1m\1B[0;31mruntime error: \1B[0mtests/operators/compound/001.ura:13: division by zero\0A\00", align 1
...
trap:                                             ; preds = %entry
  %3 = call i64 @write(i32 2, i8* getelementptr inbounds ([85 x i8], [85 x i8]* @trap_msg, i32 0, i32 0), i64 84)
...
trap9:                                            ; preds = %cont
  %5 = call i64 @write(i32 2, i8* getelementptr inbounds ([85 x i8], [85 x i8]* @trap_msg.7, i32 0, i32 0), i64 84)
  call void @exit(i32 1)
  unreachable
