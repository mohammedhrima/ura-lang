; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops/003.ura"
...
while.end:                                        ; preds = %while.start
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt, i32 0, i32 0), i32 %open9), !dbg !8
  ret i32 0, !dbg !8
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops")
