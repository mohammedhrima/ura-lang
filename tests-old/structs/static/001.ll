; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/static/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/static/001.ura"
...
define %struct.Point @Point.new(i32 %x, i32 %y) !dbg !160 {
entry:
  %x1 = alloca i32, align 4, !dbg !161
  %y2 = alloca i32, align 4, !dbg !161
  %p = alloca %struct.Point, align 8, !dbg !161
  store i32 %x, i32* %x1, align 4, !dbg !161
  store i32 %y, i32* %y2, align 4, !dbg !161
  store %struct.Point zeroinitializer, %struct.Point* %p, align 4, !dbg !161
  %x3 = getelementptr %struct.Point, %struct.Point* %p, i32 0, i32 0, !dbg !161
  %x4 = load i32, i32* %x1, align 4, !dbg !161
  store i32 %x4, i32* %x3, align 4, !dbg !161
  %y5 = getelementptr %struct.Point, %struct.Point* %p, i32 0, i32 1, !dbg !161
  %y6 = load i32, i32* %y2, align 4, !dbg !161
  store i32 %y6, i32* %y5, align 4, !dbg !161
  %p7 = load %struct.Point, %struct.Point* %p, align 4, !dbg !161
  ret %struct.Point %p7, !dbg !161
}

define %struct.Point @Point.origin() !dbg !162 {
entry:
  %0 = call %struct.Point @Point.new(i32 0, i32 0), !dbg !163
  %tmp_struct = alloca %struct.Point, align 8, !dbg !163
  store %struct.Point %0, %struct.Point* %tmp_struct, align 4, !dbg !163
  ret %struct.Point %0, !dbg !163
}

define void @Point.print(%struct.Point* %self) !dbg !164 {
entry:
  %self1 = alloca %struct.Point*, align 8, !dbg !165
  store %struct.Point* %self, %struct.Point** %self1, align 8, !dbg !165
  %self2 = load %struct.Point*, %struct.Point** %self1, align 8, !dbg !165
  %x = getelementptr %struct.Point, %struct.Point* %self2, i32 0, i32 0, !dbg !165
  %DOT = load i32, i32* %x, align 4, !dbg !165
  %self3 = load %struct.Point*, %struct.Point** %self1, align 8, !dbg !165
  %y = getelementptr %struct.Point, %struct.Point* %self3, i32 0, i32 1, !dbg !165
  %DOT4 = load i32, i32* %y, align 4, !dbg !165
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 %DOT, i32 %DOT4), !dbg !165
  ret void, !dbg !165
}

declare i32 @printf(i8*, ...)

define i32 @main() !dbg !166 {
entry:
  %p = alloca %struct.Point, align 8, !dbg !167
  %o = alloca %struct.Point, align 8, !dbg !167
  store %struct.Point zeroinitializer, %struct.Point* %p, align 4, !dbg !167
  %0 = call %struct.Point @Point.new(i32 3, i32 4), !dbg !168
  %tmp_struct = alloca %struct.Point, align 8, !dbg !168
  store %struct.Point %0, %struct.Point* %tmp_struct, align 4, !dbg !168
  store %struct.Point %0, %struct.Point* %p, align 4, !dbg !168
  call void @Point.print(%struct.Point* %p), !dbg !169
  store %struct.Point zeroinitializer, %struct.Point* %o, align 4, !dbg !167
  %1 = call %struct.Point @Point.origin(), !dbg !170
  %tmp_struct1 = alloca %struct.Point, align 8, !dbg !170
  store %struct.Point %1, %struct.Point* %tmp_struct1, align 4, !dbg !170
  store %struct.Point %1, %struct.Point* %o, align 4, !dbg !170
  call void @Point.print(%struct.Point* %o), !dbg !171
  call void @Point.delete(%struct.Point* %p), !dbg !171
  call void @Point.delete(%struct.Point* %o), !dbg !171
  call void @Point.delete(%struct.Point* %tmp_struct), !dbg !171
  call void @Point.delete(%struct.Point* %tmp_struct1), !dbg !171
  ret i32 0, !dbg !171
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/static")
...
!160 = distinct !DISubprogram(name: "Point.new", linkageName: "Point.new", scope: null, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 8, scope: !160)
!162 = distinct !DISubprogram(name: "Point.origin", linkageName: "Point.origin", scope: null, file: !3, line: 14, type: !5, scopeLine: 14, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 15, scope: !162)
!164 = distinct !DISubprogram(name: "Point.print", linkageName: "Point.print", scope: null, file: !3, line: 17, type: !5, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!165 = !DILocation(line: 17, scope: !164)
!166 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 20, type: !5, scopeLine: 20, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!167 = !DILocation(line: 20, scope: !166)
!168 = !DILocation(line: 21, scope: !166)
!169 = !DILocation(line: 22, scope: !166)
!170 = !DILocation(line: 23, scope: !166)
!171 = !DILocation(line: 24, scope: !166)
