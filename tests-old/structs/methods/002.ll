; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/methods/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/methods/002.ura"
...
@STR1 = private unnamed_addr constant [8 x i8] c"Items: \00", align 1
@STR2 = private unnamed_addr constant [10 x i8] c" | Last: \00", align 1
@STR3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [22 x i8] c"Items: %d | Last: %s\0A\00", align 1
@STR4 = private unnamed_addr constant [14 x i8] c"Health Potion\00", align 1
@STR5 = private unnamed_addr constant [11 x i8] c"Iron Sword\00", align 1
@STR6 = private unnamed_addr constant [9 x i8] c"Gold Key\00", align 1
...
define %struct.Inventory @Inventory.new() !dbg !160 {
entry:
  %inv = alloca %struct.Inventory, align 8, !dbg !161
  store %struct.Inventory zeroinitializer, %struct.Inventory* %inv, align 8, !dbg !161
  %last = getelementptr %struct.Inventory, %struct.Inventory* %inv, i32 0, i32 0, !dbg !161
  %heap = call i8* @calloc(i64 32, i64 1), !dbg !161
  store i8* %heap, i8** %last, align 8, !dbg !161
  %count = getelementptr %struct.Inventory, %struct.Inventory* %inv, i32 0, i32 1, !dbg !161
  store i32 0, i32* %count, align 4, !dbg !161
  %inv1 = load %struct.Inventory, %struct.Inventory* %inv, align 8, !dbg !161
  ret %struct.Inventory %inv1, !dbg !161
}

define void @Inventory.add(i8* %item, %struct.Inventory* %self) !dbg !162 {
entry:
  %item1 = alloca i8*, align 8, !dbg !163
  %self2 = alloca %struct.Inventory*, align 8, !dbg !163
  store i8* %item, i8** %item1, align 8, !dbg !163
  store %struct.Inventory* %self, %struct.Inventory** %self2, align 8, !dbg !163
  %self3 = load %struct.Inventory*, %struct.Inventory** %self2, align 8, !dbg !164
  %last = getelementptr %struct.Inventory, %struct.Inventory* %self3, i32 0, i32 0, !dbg !164
  %DOT = load i8*, i8** %last, align 8, !dbg !164
  %item4 = load i8*, i8** %item1, align 8, !dbg !164
  %strcpy = call i8* @strcpy(i8* %DOT, i8* %item4), !dbg !164
  %self5 = load %struct.Inventory*, %struct.Inventory** %self2, align 8, !dbg !164
  %count = getelementptr %struct.Inventory, %struct.Inventory* %self5, i32 0, i32 1, !dbg !164
  %self6 = load %struct.Inventory*, %struct.Inventory** %self2, align 8, !dbg !164
  %count7 = getelementptr %struct.Inventory, %struct.Inventory* %self6, i32 0, i32 1, !dbg !164
  %DOT8 = load i32, i32* %count7, align 4, !dbg !164
  %ADD = add i32 %DOT8, 1, !dbg !164
  store i32 %ADD, i32* %count, align 4, !dbg !164
  ret void, !dbg !164
}

define void @Inventory.print(%struct.Inventory* %self) !dbg !165 {
entry:
  %self1 = alloca %struct.Inventory*, align 8, !dbg !166
  store %struct.Inventory* %self, %struct.Inventory** %self1, align 8, !dbg !166
  %self2 = load %struct.Inventory*, %struct.Inventory** %self1, align 8, !dbg !166
  %count = getelementptr %struct.Inventory, %struct.Inventory* %self2, i32 0, i32 1, !dbg !166
  %DOT = load i32, i32* %count, align 4, !dbg !166
  %self3 = load %struct.Inventory*, %struct.Inventory** %self1, align 8, !dbg !166
  %last = getelementptr %struct.Inventory, %struct.Inventory* %self3, i32 0, i32 0, !dbg !166
  %DOT4 = load i8*, i8** %last, align 8, !dbg !166
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @output_fmt, i32 0, i32 0), i32 %DOT, i8* %DOT4), !dbg !166
  ret void, !dbg !166
}

define void @Inventory.delete(%struct.Inventory* %self) !dbg !167 {
entry:
  %self1 = alloca %struct.Inventory*, align 8, !dbg !168
  store %struct.Inventory* %self, %struct.Inventory** %self1, align 8, !dbg !168
  %self2 = load %struct.Inventory*, %struct.Inventory** %self1, align 8, !dbg !169
  %last = getelementptr %struct.Inventory, %struct.Inventory* %self2, i32 0, i32 0, !dbg !169
  %DOT = load i8*, i8** %last, align 8, !dbg !169
  call void @free(i8* %DOT), !dbg !169
  %self3 = load %struct.Inventory*, %struct.Inventory** %self1, align 8, !dbg !169
  ret void, !dbg !169
}

declare i32 @printf(i8*, ...)

define i32 @main() !dbg !170 {
entry:
  %inv = alloca %struct.Inventory, align 8, !dbg !171
  store %struct.Inventory zeroinitializer, %struct.Inventory* %inv, align 8, !dbg !171
  %0 = call %struct.Inventory @Inventory.new(), !dbg !172
  %tmp_struct = alloca %struct.Inventory, align 8, !dbg !172
  store %struct.Inventory %0, %struct.Inventory* %tmp_struct, align 8, !dbg !172
  store %struct.Inventory %0, %struct.Inventory* %inv, align 8, !dbg !172
  call void @Inventory.add(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @STR4, i32 0, i32 0), %struct.Inventory* %inv), !dbg !173
  call void @Inventory.add(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR5, i32 0, i32 0), %struct.Inventory* %inv), !dbg !174
  call void @Inventory.add(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR6, i32 0, i32 0), %struct.Inventory* %inv), !dbg !175
  call void @Inventory.print(%struct.Inventory* %inv), !dbg !176
  call void @Inventory.delete(%struct.Inventory* %inv), !dbg !176
  call void @Inventory.delete(%struct.Inventory* %tmp_struct), !dbg !176
  ret i32 0, !dbg !176
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/methods")
...
!160 = distinct !DISubprogram(name: "Inventory.new", linkageName: "Inventory.new", scope: null, file: !3, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 9, scope: !160)
!162 = distinct !DISubprogram(name: "Inventory.add", linkageName: "Inventory.add", scope: null, file: !3, line: 15, type: !5, scopeLine: 15, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 15, scope: !162)
!164 = !DILocation(line: 16, scope: !162)
!165 = distinct !DISubprogram(name: "Inventory.print", linkageName: "Inventory.print", scope: null, file: !3, line: 19, type: !5, scopeLine: 19, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!166 = !DILocation(line: 19, scope: !165)
!167 = distinct !DISubprogram(name: "Inventory.delete", linkageName: "Inventory.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!168 = !DILocation(line: 0, scope: !167)
!169 = !DILocation(line: 23, scope: !167)
!170 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 25, type: !5, scopeLine: 25, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!171 = !DILocation(line: 25, scope: !170)
!172 = !DILocation(line: 26, scope: !170)
!173 = !DILocation(line: 27, scope: !170)
!174 = !DILocation(line: 28, scope: !170)
!175 = !DILocation(line: 29, scope: !170)
!176 = !DILocation(line: 30, scope: !170)
