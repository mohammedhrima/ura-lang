; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/006.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/006.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 %String.to_int), !dbg !163
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 %String.to_int3), !dbg !165
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 %String.to_int6), !dbg !167
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i32 %String.compare), !dbg !170
  %String.compare11 = call i32 @String.compare(%struct.String* %a, %struct.String* %b), !dbg !171
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 %String.compare11), !dbg !171
  %String.compare12 = call i32 @String.compare(%struct.String* %a, %struct.String* %a), !dbg !172
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.5, i32 0, i32 0), i32 %String.compare12), !dbg !172
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i8* %DOT), !dbg !175
...
while.end:                                        ; preds = %while.start
  ...
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.7, i32 0, i32 0), i32 %String.len), !dbg !178
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i8* %DOT26), !dbg !179
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.9, i32 0, i32 0), i8* %DOT30), !dbg !180
...
!3 = !DIFile(filename: "006.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string")
