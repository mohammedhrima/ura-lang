; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/001.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt, i32 0, i32 0), i32 %String.len, i8* %bool_str), !dbg !163
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.3, i32 0, i32 0), i8* %DOT, i32 %String.len3, i8* %bool_str5), !dbg !165
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.6, i32 0, i32 0), i32 %String.len8, i8* %bool_str10), !dbg !167
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.7, i32 0, i32 0), i8* %DOT14), !dbg !168
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i8* %DOT18), !dbg !169
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.9, i32 0, i32 0), i8* %DOT22), !dbg !170
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.10, i32 0, i32 0), i8 %String.at, i8 %String.at23, i8 %String.at24, i8 %String.at25), !dbg !171
  %String.c_str = call i8* @String.c_str(%struct.String* %s2), !dbg !172
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.11, i32 0, i32 0), i8* %String.c_str), !dbg !172
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string")
