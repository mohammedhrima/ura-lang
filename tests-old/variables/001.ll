; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/variables/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/variables/001.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @output_fmt, i32 0, i32 0), i8* %name1), !dbg !7
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @output_fmt.1, i32 0, i32 0), i32 %hp2, i32 %mp3, double %f2d), !dbg !7
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.2, i32 0, i32 0), i8* %bool_str), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/variables")
