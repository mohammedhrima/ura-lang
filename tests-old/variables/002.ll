; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/variables/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/variables/002.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.1, i32 0, i32 0), i32 %hp5), !dbg !7
  %mp6 = load i32, i32* %mp, align 4, !dbg !7
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.2, i32 0, i32 0), i32 %mp6), !dbg !7
  %xp7 = load i32, i32* %xp, align 4, !dbg !7
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.3, i32 0, i32 0), i32 %xp7), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/variables")
