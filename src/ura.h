...
static inline Value _build_load2(TypeRef ty, Value ptr, char *name) { return LLVMBuildLoad2(builder, ty, ptr, name); }
...
// ----------------------------------------------------------------------------
// Higher-level helpers (thin wrappers, moved from codegen.c)
// ----------------------------------------------------------------------------
...
static inline Value _load2(Token *token)
{
