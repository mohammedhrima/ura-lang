...
entry:
  ...
  %stack3 = load ptr, ptr %stack2, align 8
  store ptr %stack3, ptr %str, align 8
  %str4 = load ptr, ptr %str, align 8
  %ACCESS = getelementptr i8, ptr %str4, i32 0
  %c5 = load i8, ptr %c1, align 1
  store i8 %c5, ptr %ACCESS, align 1
  %str6 = load ptr, ptr %str, align 8
  %write = call i32 @write(i32 1, ptr %str6, i32 1)
  ret i32 0
}
