; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/output/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/output/003.ura"
...
entry:
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.2, i32 0, i32 0), i8 %grade3), !dbg !7
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.3, i32 0, i32 0), i8* %bool_str), !dbg !7
  %speed5 = load float, float* %speed, align 4, !dbg !7
  %f2d = fpext float %speed5 to double, !dbg !7
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.4, i32 0, i32 0), double %f2d), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/output")
