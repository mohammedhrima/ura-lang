...
@STR0 = private unnamed_addr constant [8 x i8] c"popped=\00", align 1
@STR1 = private unnamed_addr constant [6 x i8] c" len=\00", align 1
@STR2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [18 x i8] c"popped=%d len=%d\0A\00", align 1
@STR3 = private unnamed_addr constant [8 x i8] c"popped=\00", align 1
