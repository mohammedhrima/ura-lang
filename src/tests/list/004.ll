; ModuleID = 'tests/list/004.ura'
source_filename = "tests/list/004.ura"
...
entry:
  ...
  %total = alloca i32, align 4, !dbg !21
  %i = alloca i32, align 4, !dbg !21
  store %struct.__list_int zeroinitializer, %struct.__list_int* %v, align 8, !dbg !21
  call void @__list_int.push(i32 5, %struct.__list_int* %v), !dbg !22
  call void @__list_int.push(i32 10, %struct.__list_int* %v), !dbg !23
  call void @__list_int.push(i32 15, %struct.__list_int* %v), !dbg !24
  call void @__list_int.push(i32 20, %struct.__list_int* %v), !dbg !25
  store i32 0, i32* %total, align 4, !dbg !21
  store i32 0, i32* %total, align 4, !dbg !21
...
while.start:                                      ; preds = %while.then, %entry
  ...
  %i1 = load i32, i32* %i, align 4, !dbg !26
  %LT = icmp slt i32 %i1, %__list_int.len, !dbg !26
  br i1 %LT, label %while.then, label %while.end, !dbg !26

while.then:                                       ; preds = %while.start
  %data = getelementptr %struct.__list_int, %struct.__list_int* %v, i32 0, i32 0, !dbg !27
  %DOT = load i32*, i32** %data, align 8, !dbg !27
  %i2 = load i32, i32* %i, align 4, !dbg !27
  %ACCESS = getelementptr i32, i32* %DOT, i32 %i2, !dbg !27
  %total3 = load i32, i32* %total, align 4, !dbg !27
  %ACC = load i32, i32* %ACCESS, align 4, !dbg !27
  %ADD = add i32 %total3, %ACC, !dbg !27
  store i32 %ADD, i32* %total, align 4, !dbg !27
  %i4 = load i32, i32* %i, align 4, !dbg !27
  %ADD5 = add i32 %i4, 1, !dbg !27
  store i32 %ADD5, i32* %i, align 4, !dbg !27
  br label %while.start, !dbg !27

while.end:                                        ; preds = %while.start
  %total6 = load i32, i32* %total, align 4, !dbg !27
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %total6), !dbg !27
  call void @__list_int.delete(%struct.__list_int* %v), !dbg !27
  ret i32 0, !dbg !27
}
...
!3 = !DIFile(filename: "004.ura", directory: "tests/list")
...
!26 = !DILocation(line: 13, scope: !20)
