; ModuleID = '/ura-lang/src/tests/errors/modules/002.ura'
source_filename = "/ura-lang/src/tests/errors/modules/002.ura"
...
@output_fmt = private unnamed_addr constant [4 x i8] c"hi\0A\00", align 1
...
entry:
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 0), !dbg !161
  ret i32 0, !dbg !161
}
...
!3 = !DIFile(filename: "002.ura", directory: "/ura-lang/src/tests/errors/modules")
...
!160 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
