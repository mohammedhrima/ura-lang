; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/operators/overloading/006.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/operators/overloading/006.ura"
...
@STR3 = private unnamed_addr constant [5 x i8] c"b1: \00", align 1
@STR4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [8 x i8] c"b1: %s\0A\00", align 1
@STR5 = private unnamed_addr constant [5 x i8] c"b2: \00", align 1
...
define %struct.Buffer @Buffer.new() !dbg !160 {
entry:
  %b = alloca %struct.Buffer, align 8, !dbg !161
  store %struct.Buffer zeroinitializer, %struct.Buffer* %b, align 8, !dbg !161
  %value = getelementptr %struct.Buffer, %struct.Buffer* %b, i32 0, i32 0, !dbg !161
  %heap = call i8* @calloc(i64 64, i64 1), !dbg !161
  store i8* %heap, i8** %value, align 8, !dbg !161
  %b1 = load %struct.Buffer, %struct.Buffer* %b, align 8, !dbg !161
  ret %struct.Buffer %b1, !dbg !161
}

define void @Buffer.delete(%struct.Buffer* %self) !dbg !162 {
entry:
  %self1 = alloca %struct.Buffer*, align 8, !dbg !163
  store %struct.Buffer* %self, %struct.Buffer** %self1, align 8, !dbg !163
  %self2 = load %struct.Buffer*, %struct.Buffer** %self1, align 8, !dbg !164
  %value = getelementptr %struct.Buffer, %struct.Buffer* %self2, i32 0, i32 0, !dbg !164
  %DOT = load i8*, i8** %value, align 8, !dbg !164
  call void @free(i8* %DOT), !dbg !164
  %self3 = load %struct.Buffer*, %struct.Buffer** %self1, align 8, !dbg !164
  ret void, !dbg !164
}

define void @Buffer.operator.ASSIGN.CHARS(i8* %s, %struct.Buffer* %self) !dbg !165 {
entry:
  %s1 = alloca i8*, align 8, !dbg !166
  %self2 = alloca %struct.Buffer*, align 8, !dbg !166
  store i8* %s, i8** %s1, align 8, !dbg !166
  store %struct.Buffer* %self, %struct.Buffer** %self2, align 8, !dbg !166
  %self3 = load %struct.Buffer*, %struct.Buffer** %self2, align 8, !dbg !167
  %value = getelementptr %struct.Buffer, %struct.Buffer* %self3, i32 0, i32 0, !dbg !167
...
define void @Buffer.operator.ASSIGN.Buffer(%struct.Buffer* %b, %struct.Buffer* %self) !dbg !168 {
entry:
  %b1 = alloca %struct.Buffer*, align 8, !dbg !169
  %self2 = alloca %struct.Buffer*, align 8, !dbg !169
  store %struct.Buffer* %b, %struct.Buffer** %b1, align 8, !dbg !169
  store %struct.Buffer* %self, %struct.Buffer** %self2, align 8, !dbg !169
  %self3 = load %struct.Buffer*, %struct.Buffer** %self2, align 8, !dbg !170
  %value = getelementptr %struct.Buffer, %struct.Buffer* %self3, i32 0, i32 0, !dbg !170
  %DOT = load i8*, i8** %value, align 8, !dbg !170
  %b4 = load %struct.Buffer*, %struct.Buffer** %b1, align 8, !dbg !170
  %value5 = getelementptr %struct.Buffer, %struct.Buffer* %b4, i32 0, i32 0, !dbg !170
  %DOT6 = load i8*, i8** %value5, align 8, !dbg !170
  %strcpy = call i8* @strcpy(i8* %DOT, i8* %DOT6), !dbg !170
  ret void, !dbg !170
}

define i32 @main() !dbg !171 {
entry:
  %b1 = alloca %struct.Buffer, align 8, !dbg !172
  %b2 = alloca %struct.Buffer, align 8, !dbg !172
  store %struct.Buffer zeroinitializer, %struct.Buffer* %b1, align 8, !dbg !172
  %0 = call %struct.Buffer @Buffer.new(), !dbg !173
  %tmp_struct = alloca %struct.Buffer, align 8, !dbg !173
  store %struct.Buffer %0, %struct.Buffer* %tmp_struct, align 8, !dbg !173
  %tmp_op = alloca %struct.Buffer, align 8, !dbg !173
  store %struct.Buffer %0, %struct.Buffer* %tmp_op, align 8, !dbg !173
  call void @Buffer.operator.ASSIGN.Buffer(%struct.Buffer* %tmp_op, %struct.Buffer* %b1), !dbg !173
  call void @Buffer.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR1, i32 0, i32 0), %struct.Buffer* %b1), !dbg !173
  store %struct.Buffer zeroinitializer, %struct.Buffer* %b2, align 8, !dbg !172
  %1 = call %struct.Buffer @Buffer.new(), !dbg !174
  %tmp_struct1 = alloca %struct.Buffer, align 8, !dbg !174
  store %struct.Buffer %1, %struct.Buffer* %tmp_struct1, align 8, !dbg !174
  %tmp_op2 = alloca %struct.Buffer, align 8, !dbg !174
  store %struct.Buffer %1, %struct.Buffer* %tmp_op2, align 8, !dbg !174
  call void @Buffer.operator.ASSIGN.Buffer(%struct.Buffer* %tmp_op2, %struct.Buffer* %b2), !dbg !174
  call void @Buffer.operator.ASSIGN.Buffer(%struct.Buffer* %b1, %struct.Buffer* %b2), !dbg !174
  %value = getelementptr %struct.Buffer, %struct.Buffer* %b2, i32 0, i32 0, !dbg !175
  %DOT = load i8*, i8** %value, align 8, !dbg !175
  %strcpy = call i8* @strcpy(i8* %DOT, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR2, i32 0, i32 0)), !dbg !175
  %value3 = getelementptr %struct.Buffer, %struct.Buffer* %b1, i32 0, i32 0, !dbg !175
  %DOT4 = load i8*, i8** %value3, align 8, !dbg !175
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %DOT4), !dbg !175
  %value5 = getelementptr %struct.Buffer, %struct.Buffer* %b2, i32 0, i32 0, !dbg !175
  %DOT6 = load i8*, i8** %value5, align 8, !dbg !175
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %DOT6), !dbg !175
  call void @Buffer.delete(%struct.Buffer* %b1), !dbg !175
  call void @Buffer.delete(%struct.Buffer* %b2), !dbg !175
  call void @Buffer.delete(%struct.Buffer* %tmp_struct), !dbg !175
  call void @Buffer.delete(%struct.Buffer* %tmp_struct1), !dbg !175
  ret i32 0, !dbg !175
}
...
!3 = !DIFile(filename: "006.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/operators/overloading")
...
!160 = distinct !DISubprogram(name: "Buffer.new", linkageName: "Buffer.new", scope: null, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 8, scope: !160)
!162 = distinct !DISubprogram(name: "Buffer.delete", linkageName: "Buffer.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 0, scope: !162)
!164 = !DILocation(line: 14, scope: !162)
!165 = distinct !DISubprogram(name: "Buffer.operator.ASSIGN.CHARS", linkageName: "Buffer.operator.ASSIGN.CHARS", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!166 = !DILocation(line: 0, scope: !165)
!167 = !DILocation(line: 17, scope: !165)
!168 = distinct !DISubprogram(name: "Buffer.operator.ASSIGN.Buffer", linkageName: "Buffer.operator.ASSIGN.Buffer", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!169 = !DILocation(line: 0, scope: !168)
!170 = !DILocation(line: 20, scope: !168)
!171 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 22, type: !5, scopeLine: 22, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!172 = !DILocation(line: 22, scope: !171)
!173 = !DILocation(line: 23, scope: !171)
!174 = !DILocation(line: 26, scope: !171)
!175 = !DILocation(line: 29, scope: !171)
