; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/operators/bitwise/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/operators/bitwise/001.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt, i32 0, i32 0), i32 %status4), !dbg !7
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.1, i32 0, i32 0), i32 %BAND), !dbg !7
  %status7 = load i32, i32* %status, align 4, !dbg !7
  %FROZEN = load i32, i32* @FROZEN, align 4, !dbg !7
  %BAND8 = and i32 %status7, %FROZEN, !dbg !7
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.2, i32 0, i32 0), i32 %BAND8), !dbg !7
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.3, i32 0, i32 0), i32 %status11), !dbg !7
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.4, i32 0, i32 0), i32 %status15), !dbg !7
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.5, i32 0, i32 0), i32 %tier216), !dbg !7
  %tier217 = load i32, i32* %tier2, align 4, !dbg !7
  %RSHIFT = ashr i32 %tier217, 2, !dbg !7
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.6, i32 0, i32 0), i32 %RSHIFT), !dbg !7
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.7, i32 0, i32 0), i32 %combo22), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/operators/bitwise")
