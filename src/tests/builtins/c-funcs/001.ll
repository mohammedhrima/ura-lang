...
entry:
  ...
  %printf = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR2, i32 0, i32 0), i32 1, i8* %name1), !dbg !162
  %hp2 = load i32, i32* %hp, align 4, !dbg !163
  %printf3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR3, i32 0, i32 0), i32 1, i32 %hp2), !dbg !163
  %grade4 = load i8, i8* %grade, align 1, !dbg !164
  %printf5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR4, i32 0, i32 0), i32 1, i8 %grade4), !dbg !164
  %speed6 = load float, float* %speed, align 4, !dbg !165
  %printf7 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR5, i32 0, i32 0), i32 1, float %speed6), !dbg !165
  %name8 = load i8*, i8** %name, align 8, !dbg !166
  %hp9 = load i32, i32* %hp, align 4, !dbg !166
  %grade10 = load i8, i8* %grade, align 1, !dbg !166
  %printf11 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @STR6, i32 0, i32 0), i32 3, i8* %name8, i32 %hp9, i8 %grade10), !dbg !166
  ret i32 0, !dbg !166
}
