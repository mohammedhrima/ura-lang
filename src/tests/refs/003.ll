; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/refs/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/refs/003.ura"
...
while.end:                                        ; preds = %while.start
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 %xp6), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/refs")
