; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/functions/basic/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/functions/basic/001.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @output_fmt, i32 0, i32 0), i32 %floor2), !dbg !7
  ret void, !dbg !7
}
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @output_fmt.1, i32 0, i32 0), i8* %name2), !dbg !9
  ret void, !dbg !9
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/functions/basic")
