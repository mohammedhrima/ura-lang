; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/functions/params/ref/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/functions/params/ref/004.ura"
...
while.end:                                        ; preds = %while.start
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %kills3), !dbg !10
  ret i32 0, !dbg !10
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/functions/params/ref")
