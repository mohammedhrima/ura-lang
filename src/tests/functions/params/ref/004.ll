; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/functions/params/ref/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/functions/params/ref/004.ura"
...
define void @tick(i32* %kills) !dbg !4 {
entry:
  %kills1 = alloca i32*, align 8, !dbg !7
  store i32* %kills, i32** %kills1, align 8, !dbg !7
  %ref_ptr = load i32*, i32** %kills1, align 8, !dbg !7
  %ref_val = load i32, i32* %ref_ptr, align 4, !dbg !7
  %ADD = add i32 %ref_val, 1, !dbg !7
  %ref_ptr2 = load i32*, i32** %kills1, align 8, !dbg !7
...
while.then:                                       ; preds = %while.start
  call void @tick(i32* %kills), !dbg !10
  %i2 = load i32, i32* %i, align 4, !dbg !10
  %ADD = add i32 %i2, 1, !dbg !10
  store i32 %ADD, i32* %i, align 4, !dbg !10
  br label %while.start, !dbg !10

while.end:                                        ; preds = %while.start
  %kills3 = load i32, i32* %kills, align 4, !dbg !10
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 %kills3), !dbg !10
  ret i32 0, !dbg !10
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/functions/params/ref")
!4 = distinct !DISubprogram(name: "tick", linkageName: "tick", scope: null, file: !3, line: 3, type: !5, scopeLine: 3, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
