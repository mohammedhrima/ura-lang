; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/003.ura"
...
entry:
  %str = alloca i8*, align 8, !dbg !161
  store i8* null, i8** %str, align 8, !dbg !161
  %heap = call i8* @calloc(i64 8, i64 1), !dbg !161
  store i8* %heap, i8** %str, align 8, !dbg !161
  %str1 = load i8*, i8** %str, align 8, !dbg !162
  %ACCESS = getelementptr i8, i8* %str1, i32 0, !dbg !162
  store i8 68, i8* %ACCESS, align 1, !dbg !162
  %str2 = load i8*, i8** %str, align 8, !dbg !163
  %ACCESS3 = getelementptr i8, i8* %str2, i32 1, !dbg !163
  store i8 85, i8* %ACCESS3, align 1, !dbg !163
  %str4 = load i8*, i8** %str, align 8, !dbg !164
  %ACCESS5 = getelementptr i8, i8* %str4, i32 2, !dbg !164
  store i8 78, i8* %ACCESS5, align 1, !dbg !164
  %str6 = load i8*, i8** %str, align 8, !dbg !165
  %ACCESS7 = getelementptr i8, i8* %str6, i32 3, !dbg !165
  store i8 71, i8* %ACCESS7, align 1, !dbg !165
  %str8 = load i8*, i8** %str, align 8, !dbg !166
  %ACCESS9 = getelementptr i8, i8* %str8, i32 4, !dbg !166
  store i8 69, i8* %ACCESS9, align 1, !dbg !166
  %str10 = load i8*, i8** %str, align 8, !dbg !167
  %ACCESS11 = getelementptr i8, i8* %str10, i32 5, !dbg !167
  store i8 79, i8* %ACCESS11, align 1, !dbg !167
  %str12 = load i8*, i8** %str, align 8, !dbg !168
  %ACCESS13 = getelementptr i8, i8* %str12, i32 6, !dbg !168
  store i8 78, i8* %ACCESS13, align 1, !dbg !168
  %str14 = load i8*, i8** %str, align 8, !dbg !169
  %ACCESS15 = getelementptr i8, i8* %str14, i32 7, !dbg !169
  store i8 0, i8* %ACCESS15, align 1, !dbg !169
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @output_fmt, i32 0, i32 0)), !dbg !169
  %str16 = load i8*, i8** %str, align 8, !dbg !170
  call void @free(i8* %str16), !dbg !170
  ret i32 0, !dbg !170
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory")
...
!162 = !DILocation(line: 7, scope: !160)
!163 = !DILocation(line: 8, scope: !160)
!164 = !DILocation(line: 9, scope: !160)
!165 = !DILocation(line: 10, scope: !160)
