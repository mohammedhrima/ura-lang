; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/001.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [6 x i8] c"Map: \00", align 1
...
entry:
  ...
  %heap = call i8* @calloc(i64 50, i64 1), !dbg !161
...
while.end:                                        ; preds = %while.start
  ...
  %ACCESS6 = getelementptr i8, i8* %map5, i32 24, !dbg !163
  store i8 64, i8* %ACCESS6, align 1, !dbg !163
  %map7 = load i8*, i8** %map, align 8, !dbg !164
  %ACCESS8 = getelementptr i8, i8* %map7, i32 49, !dbg !164
  store i8 0, i8* %ACCESS8, align 1, !dbg !164
  %map9 = load i8*, i8** %map, align 8, !dbg !164
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @output_fmt, i32 0, i32 0), i8* %map9), !dbg !164
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory")
...
!162 = !DILocation(line: 9, scope: !160)
