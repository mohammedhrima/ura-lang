; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory/004.ura"
...
if.then:                                          ; preds = %if.start
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt, i32 0, i32 0), i8* %loot2), !dbg !164
  br label %if.end, !dbg !164

if.else:                                          ; preds = %if.start
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.1, i32 0, i32 0)), !dbg !164
  br label %if.end, !dbg !164
...
if.then6:                                         ; preds = %if.start4
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.2, i32 0, i32 0), i8* %loot10), !dbg !165
  br label %if.end5, !dbg !165

if.else7:                                         ; preds = %if.start4
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.3, i32 0, i32 0)), !dbg !165
  br label %if.end5, !dbg !165
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/memory")
