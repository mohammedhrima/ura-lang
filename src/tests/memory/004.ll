; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/memory/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/memory/004.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [11 x i8] c"Iron Sword\00", align 1
@STR2 = private unnamed_addr constant [12 x i8] c"Magic Staff\00", align 1
@STR3 = private unnamed_addr constant [8 x i8] c"Found: \00", align 1
@STR4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [11 x i8] c"Found: %s\0A\00", align 1
@STR5 = private unnamed_addr constant [16 x i8] c"Chest is empty\0A\00", align 1
...
@STR8 = private unnamed_addr constant [16 x i8] c"Chest is empty\0A\00", align 1
...
define i8* @find_weapon(i32 %chest) !dbg !160 {
entry:
  %chest1 = alloca i32, align 4, !dbg !161
  store i32 %chest, i32* %chest1, align 4, !dbg !161
  br label %if.start, !dbg !161

if.start:                                         ; preds = %entry
  %chest2 = load i32, i32* %chest1, align 4, !dbg !161
  %EQ = icmp eq i32 %chest2, 1, !dbg !161
  br i1 %EQ, label %if.then, label %if.end, !dbg !161

if.end:                                           ; preds = %if.start
  br label %if.start3, !dbg !161

if.then:                                          ; preds = %if.start
  ret i8* getelementptr inbounds ([11 x i8], [11 x i8]* @STR1, i32 0, i32 0), !dbg !161

if.start3:                                        ; preds = %if.end
  %chest6 = load i32, i32* %chest1, align 4, !dbg !161
  %EQ7 = icmp eq i32 %chest6, 2, !dbg !161
  br i1 %EQ7, label %if.then5, label %if.end4, !dbg !161

if.end4:                                          ; preds = %if.start3
  ret i8* null, !dbg !161

if.then5:                                         ; preds = %if.start3
  ret i8* getelementptr inbounds ([12 x i8], [12 x i8]* @STR2, i32 0, i32 0), !dbg !161
}

define i32 @main() !dbg !162 {
entry:
  %loot = alloca i8*, align 8, !dbg !163
  store i8* null, i8** %loot, align 8, !dbg !163
  %find_weapon = call i8* @find_weapon(i32 1), !dbg !164
  store i8* %find_weapon, i8** %loot, align 8, !dbg !164
  br label %if.start, !dbg !164

if.start:                                         ; preds = %entry
  %loot1 = load i8*, i8** %loot, align 8, !dbg !164
  %NEQ = icmp ne i8* %loot1, null, !dbg !164
  br i1 %NEQ, label %if.then, label %if.else, !dbg !164

if.end:                                           ; preds = %if.else, %if.then
  %find_weapon3 = call i8* @find_weapon(i32 99), !dbg !165
  store i8* %find_weapon3, i8** %loot, align 8, !dbg !165
  br label %if.start4, !dbg !165

if.then:                                          ; preds = %if.start
  %loot2 = load i8*, i8** %loot, align 8, !dbg !164
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %loot2), !dbg !164
  br label %if.end, !dbg !164

if.else:                                          ; preds = %if.start
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.1, i32 0, i32 0), i32 0), !dbg !164
  br label %if.end, !dbg !164

if.start4:                                        ; preds = %if.end
  %loot8 = load i8*, i8** %loot, align 8, !dbg !165
  %NEQ9 = icmp ne i8* %loot8, null, !dbg !165
  br i1 %NEQ9, label %if.then6, label %if.else7, !dbg !165

if.end5:                                          ; preds = %if.else7, %if.then6
  ret i32 0, !dbg !165

if.then6:                                         ; preds = %if.start4
  %loot10 = load i8*, i8** %loot, align 8, !dbg !165
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %loot10), !dbg !165
  br label %if.end5, !dbg !165

if.else7:                                         ; preds = %if.start4
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.3, i32 0, i32 0), i32 0), !dbg !165
  br label %if.end5, !dbg !165
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/memory")
...
!160 = distinct !DISubprogram(name: "find_weapon", linkageName: "find_weapon", scope: null, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 5, scope: !160)
!162 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 10, type: !5, scopeLine: 10, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 10, scope: !162)
!164 = !DILocation(line: 11, scope: !162)
