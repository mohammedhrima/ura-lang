...
define i32 @math.add(i32 %a, i32 %b) !dbg !160 {
entry:
  %a1 = alloca i32, align 4, !dbg !161
  %b2 = alloca i32, align 4, !dbg !161
  store i32 %a, i32* %a1, align 4, !dbg !161
  store i32 %b, i32* %b2, align 4, !dbg !161
  %a3 = load i32, i32* %a1, align 4, !dbg !161
  %b4 = load i32, i32* %b2, align 4, !dbg !161
  %ADD = add i32 %a3, %b4, !dbg !161
  ret i32 %ADD, !dbg !161
}

define i32 @math.mul(i32 %a, i32 %b) !dbg !162 {
entry:
  %a1 = alloca i32, align 4, !dbg !163
  %b2 = alloca i32, align 4, !dbg !163
  store i32 %a, i32* %a1, align 4, !dbg !163
  store i32 %b, i32* %b2, align 4, !dbg !163
  %a3 = load i32, i32* %a1, align 4, !dbg !163
  %b4 = load i32, i32* %b2, align 4, !dbg !163
  %MUL = mul i32 %a3, %b4, !dbg !163
  ret i32 %MUL, !dbg !163
}
...
!160 = distinct !DISubprogram(name: "math.add", linkageName: "math.add", scope: null, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 5, scope: !160)
!162 = distinct !DISubprogram(name: "math.mul", linkageName: "math.mul", scope: null, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 8, scope: !162)
!164 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!165 = !DILocation(line: 11, scope: !164)
!166 = !DILocation(line: 12, scope: !164)
!167 = !DILocation(line: 13, scope: !164)
!168 = !DILocation(line: 14, scope: !164)
