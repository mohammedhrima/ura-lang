...
entry:
  ...
  %0 = call i32 @math.add(i32 3, i32 4), !dbg !162
  store i32 %0, i32* %result, align 4, !dbg !162
  %result1 = load i32, i32* %result, align 4, !dbg !163
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR1, i32 0, i32 0), i32 %result1), !dbg !163
  %1 = call i32 @math.mul(i32 3, i32 4), !dbg !164
  %printf2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR2, i32 0, i32 0), i32 %1), !dbg !164
  ret i32 0, !dbg !164
}

define i32 @math.add(i32 %a, i32 %b) !dbg !165 {
entry:
  %a1 = alloca i32, align 4, !dbg !166
  %b2 = alloca i32, align 4, !dbg !166
  store i32 %a, i32* %a1, align 4, !dbg !166
  store i32 %b, i32* %b2, align 4, !dbg !166
  %a3 = load i32, i32* %a1, align 4, !dbg !166
  %b4 = load i32, i32* %b2, align 4, !dbg !166
  %ADD = add i32 %a3, %b4, !dbg !166
  ret i32 %ADD, !dbg !166
}

define i32 @math.mul(i32 %a, i32 %b) !dbg !167 {
entry:
  %a1 = alloca i32, align 4, !dbg !168
  %b2 = alloca i32, align 4, !dbg !168
  store i32 %a, i32* %a1, align 4, !dbg !168
  store i32 %b, i32* %b2, align 4, !dbg !168
  %a3 = load i32, i32* %a1, align 4, !dbg !168
  %b4 = load i32, i32* %b2, align 4, !dbg !168
  %MUL = mul i32 %a3, %b4, !dbg !168
  ret i32 %MUL, !dbg !168
}
...
!160 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 11, scope: !160)
!162 = !DILocation(line: 12, scope: !160)
!163 = !DILocation(line: 13, scope: !160)
!164 = !DILocation(line: 14, scope: !160)
!165 = distinct !DISubprogram(name: "math.add", linkageName: "math.add", scope: null, file: !3, line: 5, type: !5, scopeLine: 5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!166 = !DILocation(line: 5, scope: !165)
!167 = distinct !DISubprogram(name: "math.mul", linkageName: "math.mul", scope: null, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!168 = !DILocation(line: 8, scope: !167)
