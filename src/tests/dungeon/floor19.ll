; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor19.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor19.ura"
...
@STR3 = private unnamed_addr constant [7 x i8] c"Dragon\00", align 1
@STR4 = private unnamed_addr constant [10 x i8] c"Enemies: \00", align 1
...
@output_fmt = private unnamed_addr constant [21 x i8] c"Enemies: %s, %s, %s\0A\00", align 1
@STR8 = private unnamed_addr constant [10 x i8] c"Loot:    \00", align 1
@STR9 = private unnamed_addr constant [3 x i8] c", \00", align 1
@STR10 = private unnamed_addr constant [3 x i8] c", \00", align 1
@STR11 = private unnamed_addr constant [7 x i8] c" gold\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [26 x i8] c"Loot:    %d, %d, %d gold\0A\00", align 1
@STR12 = private unnamed_addr constant [6 x i8] c"Roll \00", align 1
@STR13 = private unnamed_addr constant [3 x i8] c": \00", align 1
@STR14 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [13 x i8] c"Roll %d: %s\0A\00", align 1
@STR15 = private unnamed_addr constant [15 x i8] c"Total damage: \00", align 1
@STR16 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.3 = private unnamed_addr constant [18 x i8] c"Total damage: %d\0A\00", align 1
@STR17 = private unnamed_addr constant [5 x i8] c"HP: \00", align 1
@STR18 = private unnamed_addr constant [5 x i8] c" -> \00", align 1
@STR19 = private unnamed_addr constant [5 x i8] c" -> \00", align 1
@STR20 = private unnamed_addr constant [5 x i8] c" -> \00", align 1
@STR21 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.4 = private unnamed_addr constant [26 x i8] c"HP: %d -> %d -> %d -> %d\0A\00", align 1
@STR22 = private unnamed_addr constant [9 x i8] c"Fireball\00", align 1
@STR23 = private unnamed_addr constant [10 x i8] c"Ice Shard\00", align 1
@STR24 = private unnamed_addr constant [10 x i8] c"Lightning\00", align 1
@STR25 = private unnamed_addr constant [13 x i8] c"Spell book: \00", align 1
...
@output_fmt.5 = private unnamed_addr constant [24 x i8] c"Spell book: %s, %s, %s\0A\00", align 1
...
entry:
  %enemies = alloca i8**, align 8, !dbg !161
  %loot = alloca i32*, align 8, !dbg !161
  %roll = alloca i32, align 4, !dbg !161
  %hits = alloca i32*, align 8, !dbg !161
  %total = alloca i32, align 4, !dbg !161
  %i = alloca i32, align 4, !dbg !161
  %hp_stages = alloca i32*, align 8, !dbg !161
  %spells = alloca i8**, align 8, !dbg !161
  store i8** null, i8*** %enemies, align 8, !dbg !161
  %array_lit = call i8* @calloc(i64 3, i64 8), !dbg !161
  %lit_data = bitcast i8* %array_lit to i8**, !dbg !161
  %lit_elem = getelementptr i8*, i8** %lit_data, i32 0, !dbg !161
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR1, i32 0, i32 0), i8** %lit_elem, align 8, !dbg !161
  %lit_elem1 = getelementptr i8*, i8** %lit_data, i32 1, !dbg !161
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR2, i32 0, i32 0), i8** %lit_elem1, align 8, !dbg !161
  %lit_elem2 = getelementptr i8*, i8** %lit_data, i32 2, !dbg !161
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR3, i32 0, i32 0), i8** %lit_elem2, align 8, !dbg !161
  store i8** %lit_data, i8*** %enemies, align 8, !dbg !161
  store i32* null, i32** %loot, align 8, !dbg !161
  %array_lit3 = call i8* @calloc(i64 3, i64 4), !dbg !161
  %lit_data4 = bitcast i8* %array_lit3 to i32*, !dbg !161
  %lit_elem5 = getelementptr i32, i32* %lit_data4, i32 0, !dbg !161
  store i32 15, i32* %lit_elem5, align 4, !dbg !161
  %lit_elem6 = getelementptr i32, i32* %lit_data4, i32 1, !dbg !161
  store i32 30, i32* %lit_elem6, align 4, !dbg !161
  %lit_elem7 = getelementptr i32, i32* %lit_data4, i32 2, !dbg !161
  store i32 100, i32* %lit_elem7, align 4, !dbg !161
  store i32* %lit_data4, i32** %loot, align 8, !dbg !161
  %enemies8 = load i8**, i8*** %enemies, align 8, !dbg !162
  %ACCESS = getelementptr i8*, i8** %enemies8, i32 0, !dbg !162
  %ACC = load i8*, i8** %ACCESS, align 8, !dbg !162
  %enemies9 = load i8**, i8*** %enemies, align 8, !dbg !162
  %ACCESS10 = getelementptr i8*, i8** %enemies9, i32 1, !dbg !162
  %ACC11 = load i8*, i8** %ACCESS10, align 8, !dbg !162
  %enemies12 = load i8**, i8*** %enemies, align 8, !dbg !162
  %ACCESS13 = getelementptr i8*, i8** %enemies12, i32 2, !dbg !162
  %ACC14 = load i8*, i8** %ACCESS13, align 8, !dbg !162
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @output_fmt, i32 0, i32 0), i32 3, i8* %ACC, i8* %ACC11, i8* %ACC14), !dbg !162
  %loot15 = load i32*, i32** %loot, align 8, !dbg !163
  %ACCESS16 = getelementptr i32, i32* %loot15, i32 0, !dbg !163
  %ACC17 = load i32, i32* %ACCESS16, align 4, !dbg !163
  %loot18 = load i32*, i32** %loot, align 8, !dbg !163
  %ACCESS19 = getelementptr i32, i32* %loot18, i32 1, !dbg !163
  %ACC20 = load i32, i32* %ACCESS19, align 4, !dbg !163
  %loot21 = load i32*, i32** %loot, align 8, !dbg !163
  %ACCESS22 = getelementptr i32, i32* %loot21, i32 2, !dbg !163
  %ACC23 = load i32, i32* %ACCESS22, align 4, !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @output_fmt.1, i32 0, i32 0), i32 3, i32 %ACC17, i32 %ACC20, i32 %ACC23), !dbg !163
  store i32 0, i32* %roll, align 4, !dbg !161
  store i32 4, i32* %roll, align 4, !dbg !161
  %roll24 = load i32, i32* %roll, align 4, !dbg !161
  %roll25 = load i32, i32* %roll, align 4, !dbg !164
  %MOD = srem i32 %roll25, 3, !dbg !164
  %enemies26 = load i8**, i8*** %enemies, align 8, !dbg !164
  %ACCESS27 = getelementptr i8*, i8** %enemies26, i32 %MOD, !dbg !164
  %ACC28 = load i8*, i8** %ACCESS27, align 8, !dbg !164
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.2, i32 0, i32 0), i32 2, i32 %roll24, i8* %ACC28), !dbg !164
  store i32* null, i32** %hits, align 8, !dbg !161
  %array_lit29 = call i8* @calloc(i64 4, i64 4), !dbg !161
  %lit_data30 = bitcast i8* %array_lit29 to i32*, !dbg !161
  %lit_elem31 = getelementptr i32, i32* %lit_data30, i32 0, !dbg !161
  store i32 12, i32* %lit_elem31, align 4, !dbg !161
  %lit_elem32 = getelementptr i32, i32* %lit_data30, i32 1, !dbg !161
  store i32 8, i32* %lit_elem32, align 4, !dbg !161
  %lit_elem33 = getelementptr i32, i32* %lit_data30, i32 2, !dbg !161
  store i32 15, i32* %lit_elem33, align 4, !dbg !161
  %lit_elem34 = getelementptr i32, i32* %lit_data30, i32 3, !dbg !161
  store i32 20, i32* %lit_elem34, align 4, !dbg !161
  store i32* %lit_data30, i32** %hits, align 8, !dbg !161
  store i32 0, i32* %total, align 4, !dbg !161
  store i32 0, i32* %total, align 4, !dbg !161
...
while.start:                                      ; preds = %while.then, %entry
  %i35 = load i32, i32* %i, align 4, !dbg !161
  %LT = icmp slt i32 %i35, 4, !dbg !161
  br i1 %LT, label %while.then, label %while.end, !dbg !161

while.then:                                       ; preds = %while.start
  %hits36 = load i32*, i32** %hits, align 8, !dbg !165
  %i37 = load i32, i32* %i, align 4, !dbg !165
  %ACCESS38 = getelementptr i32, i32* %hits36, i32 %i37, !dbg !165
  %total39 = load i32, i32* %total, align 4, !dbg !165
  %ACC40 = load i32, i32* %ACCESS38, align 4, !dbg !165
  %ADD = add i32 %total39, %ACC40, !dbg !165
  store i32 %ADD, i32* %total, align 4, !dbg !165
  %i41 = load i32, i32* %i, align 4, !dbg !165
  %ADD42 = add i32 %i41, 1, !dbg !165
  store i32 %ADD42, i32* %i, align 4, !dbg !165
  br label %while.start, !dbg !165

while.end:                                        ; preds = %while.start
  %total43 = load i32, i32* %total, align 4, !dbg !165
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.3, i32 0, i32 0), i32 1, i32 %total43), !dbg !165
  store i32* null, i32** %hp_stages, align 8, !dbg !161
  %array_lit44 = call i8* @calloc(i64 4, i64 4), !dbg !161
  %lit_data45 = bitcast i8* %array_lit44 to i32*, !dbg !161
  %lit_elem46 = getelementptr i32, i32* %lit_data45, i32 0, !dbg !161
  store i32 100, i32* %lit_elem46, align 4, !dbg !161
  %lit_elem47 = getelementptr i32, i32* %lit_data45, i32 1, !dbg !161
  store i32 88, i32* %lit_elem47, align 4, !dbg !161
  %lit_elem48 = getelementptr i32, i32* %lit_data45, i32 2, !dbg !161
  store i32 80, i32* %lit_elem48, align 4, !dbg !161
  %lit_elem49 = getelementptr i32, i32* %lit_data45, i32 3, !dbg !161
  store i32 65, i32* %lit_elem49, align 4, !dbg !161
  store i32* %lit_data45, i32** %hp_stages, align 8, !dbg !161
  %hp_stages50 = load i32*, i32** %hp_stages, align 8, !dbg !166
  %ACCESS51 = getelementptr i32, i32* %hp_stages50, i32 0, !dbg !166
  %ACC52 = load i32, i32* %ACCESS51, align 4, !dbg !166
  %hp_stages53 = load i32*, i32** %hp_stages, align 8, !dbg !166
  %ACCESS54 = getelementptr i32, i32* %hp_stages53, i32 1, !dbg !166
  %ACC55 = load i32, i32* %ACCESS54, align 4, !dbg !166
  %hp_stages56 = load i32*, i32** %hp_stages, align 8, !dbg !166
  %ACCESS57 = getelementptr i32, i32* %hp_stages56, i32 2, !dbg !166
  %ACC58 = load i32, i32* %ACCESS57, align 4, !dbg !166
  %hp_stages59 = load i32*, i32** %hp_stages, align 8, !dbg !166
  %ACCESS60 = getelementptr i32, i32* %hp_stages59, i32 3, !dbg !166
  %ACC61 = load i32, i32* %ACCESS60, align 4, !dbg !166
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @output_fmt.4, i32 0, i32 0), i32 4, i32 %ACC52, i32 %ACC55, i32 %ACC58, i32 %ACC61), !dbg !166
  store i8** null, i8*** %spells, align 8, !dbg !161
  %array_lit62 = call i8* @calloc(i64 3, i64 8), !dbg !161
  %lit_data63 = bitcast i8* %array_lit62 to i8**, !dbg !161
  %lit_elem64 = getelementptr i8*, i8** %lit_data63, i32 0, !dbg !161
  store i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR22, i32 0, i32 0), i8** %lit_elem64, align 8, !dbg !161
  %lit_elem65 = getelementptr i8*, i8** %lit_data63, i32 1, !dbg !161
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @STR23, i32 0, i32 0), i8** %lit_elem65, align 8, !dbg !161
  %lit_elem66 = getelementptr i8*, i8** %lit_data63, i32 2, !dbg !161
  store i8* getelementptr inbounds ([10 x i8], [10 x i8]* @STR24, i32 0, i32 0), i8** %lit_elem66, align 8, !dbg !161
  store i8** %lit_data63, i8*** %spells, align 8, !dbg !161
  %spells67 = load i8**, i8*** %spells, align 8, !dbg !167
  %ACCESS68 = getelementptr i8*, i8** %spells67, i32 0, !dbg !167
  %ACC69 = load i8*, i8** %ACCESS68, align 8, !dbg !167
  %spells70 = load i8**, i8*** %spells, align 8, !dbg !167
  %ACCESS71 = getelementptr i8*, i8** %spells70, i32 1, !dbg !167
  %ACC72 = load i8*, i8** %ACCESS71, align 8, !dbg !167
  %spells73 = load i8**, i8*** %spells, align 8, !dbg !167
  %ACCESS74 = getelementptr i8*, i8** %spells73, i32 2, !dbg !167
  %ACC75 = load i8*, i8** %ACCESS74, align 8, !dbg !167
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @output_fmt.5, i32 0, i32 0), i32 3, i8* %ACC69, i8* %ACC72, i8* %ACC75), !dbg !167
  ret i32 0, !dbg !167
}
...
!3 = !DIFile(filename: "floor19.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
...
!162 = !DILocation(line: 8, scope: !160)
!163 = !DILocation(line: 9, scope: !160)
!164 = !DILocation(line: 12, scope: !160)
!165 = !DILocation(line: 18, scope: !160)
!166 = !DILocation(line: 23, scope: !160)
!167 = !DILocation(line: 26, scope: !160)
