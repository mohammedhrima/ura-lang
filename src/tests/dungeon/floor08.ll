; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor08.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor08.ura"
...
@STR2 = private unnamed_addr constant [10 x i8] c" \E2\80\94 HP: \00", align 1
...
@STR5 = private unnamed_addr constant [9 x i8] c"The Bold\00", align 1
...
define %struct.Hero @Hero.new() !dbg !160 {
entry:
  %h = alloca %struct.Hero, align 8, !dbg !161
  store %struct.Hero zeroinitializer, %struct.Hero* %h, align 8, !dbg !161
  %name = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 0, !dbg !161
  %heap = call i8* @calloc(i64 32, i64 1), !dbg !161
  store i8* %heap, i8** %name, align 8, !dbg !161
  %title = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 1, !dbg !161
  %heap1 = call i8* @calloc(i64 32, i64 1), !dbg !161
  store i8* %heap1, i8** %title, align 8, !dbg !161
  %hp = getelementptr %struct.Hero, %struct.Hero* %h, i32 0, i32 2, !dbg !161
  store i32 100, i32* %hp, align 4, !dbg !161
  %h2 = load %struct.Hero, %struct.Hero* %h, align 8, !dbg !161
  ret %struct.Hero %h2, !dbg !161
}

define void @Hero.setup(i8* %name, i8* %title, %struct.Hero* %self) !dbg !162 {
entry:
  %name1 = alloca i8*, align 8, !dbg !163
  %title2 = alloca i8*, align 8, !dbg !163
  %self3 = alloca %struct.Hero*, align 8, !dbg !163
  store i8* %name, i8** %name1, align 8, !dbg !163
  store i8* %title, i8** %title2, align 8, !dbg !163
  store %struct.Hero* %self, %struct.Hero** %self3, align 8, !dbg !163
  %self4 = load %struct.Hero*, %struct.Hero** %self3, align 8, !dbg !164
  %name5 = getelementptr %struct.Hero, %struct.Hero* %self4, i32 0, i32 0, !dbg !164
  %DOT = load i8*, i8** %name5, align 8, !dbg !164
  %name6 = load i8*, i8** %name1, align 8, !dbg !164
  %strcpy = call i8* @strcpy(i8* %DOT, i8* %name6), !dbg !164
  %self7 = load %struct.Hero*, %struct.Hero** %self3, align 8, !dbg !165
  %title8 = getelementptr %struct.Hero, %struct.Hero* %self7, i32 0, i32 1, !dbg !165
  %DOT9 = load i8*, i8** %title8, align 8, !dbg !165
  %title10 = load i8*, i8** %title2, align 8, !dbg !165
  %strcpy11 = call i8* @strcpy(i8* %DOT9, i8* %title10), !dbg !165
  ret void, !dbg !165
}

define void @Hero.announce(%struct.Hero* %self) !dbg !166 {
entry:
  %self1 = alloca %struct.Hero*, align 8, !dbg !167
  store %struct.Hero* %self, %struct.Hero** %self1, align 8, !dbg !167
  %self2 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !167
  %title = getelementptr %struct.Hero, %struct.Hero* %self2, i32 0, i32 1, !dbg !167
  %DOT = load i8*, i8** %title, align 8, !dbg !167
  %self3 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !167
  %name = getelementptr %struct.Hero, %struct.Hero* %self3, i32 0, i32 0, !dbg !167
  %DOT4 = load i8*, i8** %name, align 8, !dbg !167
  %self5 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !167
  %hp = getelementptr %struct.Hero, %struct.Hero* %self5, i32 0, i32 2, !dbg !167
  %DOT6 = load i32, i32* %hp, align 4, !dbg !167
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT, i8* %DOT4, i32 %DOT6), !dbg !167
  ret void, !dbg !167
}

define void @Hero.heal(i32 %amount, %struct.Hero* %self) !dbg !168 {
entry:
  %amount1 = alloca i32, align 4, !dbg !169
  %self2 = alloca %struct.Hero*, align 8, !dbg !169
  store i32 %amount, i32* %amount1, align 4, !dbg !169
  store %struct.Hero* %self, %struct.Hero** %self2, align 8, !dbg !169
  %self3 = load %struct.Hero*, %struct.Hero** %self2, align 8, !dbg !169
  %hp = getelementptr %struct.Hero, %struct.Hero* %self3, i32 0, i32 2, !dbg !169
  %self4 = load %struct.Hero*, %struct.Hero** %self2, align 8, !dbg !169
  %hp5 = getelementptr %struct.Hero, %struct.Hero* %self4, i32 0, i32 2, !dbg !169
  %DOT = load i32, i32* %hp5, align 4, !dbg !169
  %amount6 = load i32, i32* %amount1, align 4, !dbg !169
  %ADD = add i32 %DOT, %amount6, !dbg !169
  store i32 %ADD, i32* %hp, align 4, !dbg !169
  ret void, !dbg !169
}

define void @Hero.delete(%struct.Hero* %self) !dbg !170 {
entry:
  %self1 = alloca %struct.Hero*, align 8, !dbg !171
  store %struct.Hero* %self, %struct.Hero** %self1, align 8, !dbg !171
  %self2 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !172
  %name = getelementptr %struct.Hero, %struct.Hero* %self2, i32 0, i32 0, !dbg !172
  %DOT = load i8*, i8** %name, align 8, !dbg !172
  call void @free(i8* %DOT), !dbg !172
  %self3 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !173
  %title = getelementptr %struct.Hero, %struct.Hero* %self3, i32 0, i32 1, !dbg !173
  %DOT4 = load i8*, i8** %title, align 8, !dbg !173
  call void @free(i8* %DOT4), !dbg !173
  %self5 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !173
  ret void, !dbg !173
}

declare i32 @printf(i8*, ...)

define i32 @main() !dbg !174 {
entry:
  %hero = alloca %struct.Hero, align 8, !dbg !175
  store %struct.Hero zeroinitializer, %struct.Hero* %hero, align 8, !dbg !175
  %0 = call %struct.Hero @Hero.new(), !dbg !176
  %tmp_struct = alloca %struct.Hero, align 8, !dbg !176
  store %struct.Hero %0, %struct.Hero* %tmp_struct, align 8, !dbg !176
  store %struct.Hero %0, %struct.Hero* %hero, align 8, !dbg !176
  call void @Hero.setup(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR5, i32 0, i32 0), %struct.Hero* %hero), !dbg !177
  call void @Hero.announce(%struct.Hero* %hero), !dbg !178
  call void @Hero.heal(i32 20, %struct.Hero* %hero), !dbg !179
  call void @Hero.announce(%struct.Hero* %hero), !dbg !180
  call void @Hero.delete(%struct.Hero* %hero), !dbg !180
  call void @Hero.delete(%struct.Hero* %tmp_struct), !dbg !180
  ret i32 0, !dbg !180
}
...
!3 = !DIFile(filename: "floor08.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
...
!160 = distinct !DISubprogram(name: "Hero.new", linkageName: "Hero.new", scope: null, file: !3, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 9, scope: !160)
!162 = distinct !DISubprogram(name: "Hero.setup", linkageName: "Hero.setup", scope: null, file: !3, line: 16, type: !5, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 16, scope: !162)
!164 = !DILocation(line: 17, scope: !162)
!165 = !DILocation(line: 18, scope: !162)
!166 = distinct !DISubprogram(name: "Hero.announce", linkageName: "Hero.announce", scope: null, file: !3, line: 20, type: !5, scopeLine: 20, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!167 = !DILocation(line: 20, scope: !166)
!168 = distinct !DISubprogram(name: "Hero.heal", linkageName: "Hero.heal", scope: null, file: !3, line: 23, type: !5, scopeLine: 23, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!169 = !DILocation(line: 23, scope: !168)
!170 = distinct !DISubprogram(name: "Hero.delete", linkageName: "Hero.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!171 = !DILocation(line: 0, scope: !170)
!172 = !DILocation(line: 27, scope: !170)
!173 = !DILocation(line: 28, scope: !170)
!174 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 30, type: !5, scopeLine: 30, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!175 = !DILocation(line: 30, scope: !174)
!176 = !DILocation(line: 31, scope: !174)
!177 = !DILocation(line: 32, scope: !174)
!178 = !DILocation(line: 33, scope: !174)
!179 = !DILocation(line: 34, scope: !174)
!180 = !DILocation(line: 35, scope: !174)
