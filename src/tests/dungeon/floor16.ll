; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor16.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor16.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.Color = type { i8, i8, i8, i8 }

@STR0 = private unnamed_addr constant [20 x i8] c"Dungeon \E2\80\94 Floor 1\00", align 1
@STR1 = private unnamed_addr constant [13 x i8] c"Dungeon Hero\00", align 1
...
entry:
  %hero_x = alloca i32, align 4, !dbg !9
  %speed = alloca i32, align 4, !dbg !9
  call void @InitWindow(i32 800, i32 600, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @STR0, i32 0, i32 0)), !dbg !9
  call void @SetTargetFPS(i32 60), !dbg !10
  store i32 0, i32* %hero_x, align 4, !dbg !9
  store i32 100, i32* %hero_x, align 4, !dbg !9
...
while.then:                                       ; preds = %while.start
  %hero_x1 = load i32, i32* %hero_x, align 4, !dbg !11
  %speed2 = load i32, i32* %speed, align 4, !dbg !11
  %ADD = add i32 %hero_x1, %speed2, !dbg !11
  store i32 %ADD, i32* %hero_x, align 4, !dbg !11
...
if.start:                                         ; preds = %while.then
  %hero_x3 = load i32, i32* %hero_x, align 4, !dbg !11
  %GT = icmp sgt i32 %hero_x3, 800, !dbg !11
  br i1 %GT, label %if.then, label %if.end, !dbg !11

if.end:                                           ; preds = %if.then, %if.start
  call void @BeginDrawing(), !dbg !13
  %setColor = call %struct.Color @setColor(i32 20, i32 20, i32 40, i32 255), !dbg !14
  ...
  %hero_x4 = load i32, i32* %hero_x, align 4, !dbg !15
  %setColor5 = call %struct.Color @setColor(i32 180, i32 100, i32 255, i32 255), !dbg !15
  ...
  call void @DrawRectangle(i32 %hero_x4, i32 300, i32 40, i32 60, i64 %i64_arg9), !dbg !15
  %setColor10 = call %struct.Color @setColor(i32 255, i32 220, i32 0, i32 255), !dbg !16
  ...
  call void @DrawText(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @STR1, i32 0, i32 0), i32 10, i32 10, i32 24, i64 %i64_arg14), !dbg !16
  call void @EndDrawing(), !dbg !17
  br label %while.start, !dbg !17

if.then:                                          ; preds = %if.start
  store i32 0, i32* %hero_x, align 4, !dbg !11
...
!3 = !DIFile(filename: "floor16.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
...
!12 = !DILocation(line: 17, scope: !8)
!13 = !DILocation(line: 12, scope: !8)
!14 = !DILocation(line: 13, scope: !8)
!15 = !DILocation(line: 14, scope: !8)
!16 = !DILocation(line: 15, scope: !8)
!17 = !DILocation(line: 16, scope: !8)
