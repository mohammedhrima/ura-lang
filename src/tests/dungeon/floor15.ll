; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor15.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor15.ura"
...
@STR3 = private unnamed_addr constant [7 x i8] c"! ===\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [22 x i8] c"=== Welcome, %s! ===\0A\00", align 1
@STR4 = private unnamed_addr constant [31 x i8] c"Your quest begins on floor 1.\0A\00", align 1
...
if.end:                                           ; preds = %if.start
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @output_fmt.1, i32 0, i32 0), i8* %ACC), !dbg !162
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @output_fmt.2, i32 0, i32 0)), !dbg !162
  ret void, !dbg !162

if.then:                                          ; preds = %if.start
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @output_fmt, i32 0, i32 0)), !dbg !161
  ret void, !dbg !161
}
...
!3 = !DIFile(filename: "floor15.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
...
!164 = !DILocation(line: 11, scope: !163)
!165 = !DILocation(line: 12, scope: !163)
