; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor18.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor18.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [16 x i8] c"Hello, Dungeon!\00", align 1
@STR2 = private unnamed_addr constant [8 x i8] c" (len: \00", align 1
@STR3 = private unnamed_addr constant [3 x i8] c")\0A\00", align 1
@output_fmt = private unnamed_addr constant [14 x i8] c"%s (len: %d)\0A\00", align 1
@STR4 = private unnamed_addr constant [21 x i8] c"found 'Dungeon' at: \00", align 1
@STR5 = private unnamed_addr constant [8 x i8] c"Dungeon\00", align 1
@STR6 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [24 x i8] c"found 'Dungeon' at: %d\0A\00", align 1
@STR7 = private unnamed_addr constant [20 x i8] c"starts with Hello: \00", align 1
@STR8 = private unnamed_addr constant [6 x i8] c"Hello\00", align 1
@true_str = private unnamed_addr constant [5 x i8] c"True\00", align 1
@false_str = private unnamed_addr constant [6 x i8] c"False\00", align 1
@STR9 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [23 x i8] c"starts with Hello: %s\0A\00", align 1
...
@STR12 = private unnamed_addr constant [9 x i8] c"substr: \00", align 1
@STR13 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.5 = private unnamed_addr constant [12 x i8] c"substr: %s\0A\00", align 1
@STR14 = private unnamed_addr constant [9 x i8] c"pushed: \00", align 1
@STR15 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.6 = private unnamed_addr constant [12 x i8] c"pushed: %s\0A\00", align 1
@STR16 = private unnamed_addr constant [7 x i8] c"Shadow\00", align 1
@STR17 = private unnamed_addr constant [7 x i8] c" Blade\00", align 1
@STR18 = private unnamed_addr constant [7 x i8] c"name: \00", align 1
@STR19 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.7 = private unnamed_addr constant [10 x i8] c"name: %s\0A\00", align 1
@STR20 = private unnamed_addr constant [7 x i8] c"+=:   \00", align 1
@STR21 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.8 = private unnamed_addr constant [10 x i8] c"+=:   %s\0A\00", align 1
@STR22 = private unnamed_addr constant [4 x i8] c"abc\00", align 1
@STR23 = private unnamed_addr constant [4 x i8] c"abc\00", align 1
@STR24 = private unnamed_addr constant [8 x i8] c"equal: \00", align 1
...
@output_fmt.11 = private unnamed_addr constant [11 x i8] c"equal: %s\0A\00", align 1
@STR26 = private unnamed_addr constant [5 x i8] c"HP: \00", align 1
@STR27 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.12 = private unnamed_addr constant [8 x i8] c"HP: %s\0A\00", align 1
@STR28 = private unnamed_addr constant [3 x i8] c"42\00", align 1
@STR29 = private unnamed_addr constant [9 x i8] c"parsed: \00", align 1
@STR30 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.13 = private unnamed_addr constant [12 x i8] c"parsed: %d\0A\00", align 1
@STR31 = private unnamed_addr constant [12 x i8] c"  trimmed  \00", align 1
@STR32 = private unnamed_addr constant [8 x i8] c"trim: '\00", align 1
@STR33 = private unnamed_addr constant [3 x i8] c"'\0A\00", align 1
@output_fmt.14 = private unnamed_addr constant [12 x i8] c"trim: '%s'\0A\00", align 1
@STR34 = private unnamed_addr constant [12 x i8] c"orc orc orc\00", align 1
@STR35 = private unnamed_addr constant [4 x i8] c"orc\00", align 1
@STR36 = private unnamed_addr constant [4 x i8] c"elf\00", align 1
@STR37 = private unnamed_addr constant [10 x i8] c"replace: \00", align 1
@STR38 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.15 = private unnamed_addr constant [13 x i8] c"replace: %s\0A\00", align 1
@STR39 = private unnamed_addr constant [3 x i8] c"ha\00", align 1
@STR40 = private unnamed_addr constant [9 x i8] c"repeat: \00", align 1
@STR41 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.16 = private unnamed_addr constant [12 x i8] c"repeat: %s\0A\00", align 1
@STR42 = private unnamed_addr constant [7 x i8] c"dragon\00", align 1
@STR43 = private unnamed_addr constant [10 x i8] c"reverse: \00", align 1
@STR44 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.17 = private unnamed_addr constant [13 x i8] c"reverse: %s\0A\00", align 1
...
entry:
  %greeting = alloca %struct.String, align 8, !dbg !161
  %shout = alloca %struct.String, align 8, !dbg !161
  %whisper = alloca %struct.String, align 8, !dbg !161
  %word = alloca %struct.String, align 8, !dbg !161
  %msg = alloca %struct.String, align 8, !dbg !161
  %first = alloca %struct.String, align 8, !dbg !161
  %last = alloca %struct.String, align 8, !dbg !161
  %name = alloca %struct.String, align 8, !dbg !161
  %a = alloca %struct.String, align 8, !dbg !161
  %b = alloca %struct.String, align 8, !dbg !161
  %hp_str = alloca %struct.String, align 8, !dbg !161
  %num = alloca %struct.String, align 8, !dbg !161
  %padded = alloca %struct.String, align 8, !dbg !161
  %trimmed = alloca %struct.String, align 8, !dbg !161
  %orig = alloca %struct.String, align 8, !dbg !161
  %swapped = alloca %struct.String, align 8, !dbg !161
  %ha = alloca %struct.String, align 8, !dbg !161
  %ha3 = alloca %struct.String, align 8, !dbg !161
  %rev = alloca %struct.String, align 8, !dbg !161
  %r = alloca %struct.String, align 8, !dbg !161
  store %struct.String zeroinitializer, %struct.String* %greeting, align 8, !dbg !161
  %0 = call %struct.String @String.from(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @STR1, i32 0, i32 0)), !dbg !162
  ...
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op, %struct.String* %greeting), !dbg !162
  %value = getelementptr %struct.String, %struct.String* %greeting, i32 0, i32 0, !dbg !162
  %DOT = load i8*, i8** %value, align 8, !dbg !162
  %String.len = call i32 @String.len(%struct.String* %greeting), !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt, i32 0, i32 0), i32 2, i8* %DOT, i32 %String.len), !dbg !163
  %String.find = call i32 @String.find(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @STR5, i32 0, i32 0), %struct.String* %greeting), !dbg !164
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %String.find), !dbg !164
  %String.starts_with = call i1 @String.starts_with(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR8, i32 0, i32 0), %struct.String* %greeting), !dbg !165
  %bool_str = select i1 %String.starts_with, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str, i32 0, i32 0), !dbg !165
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %bool_str), !dbg !165
  store %struct.String zeroinitializer, %struct.String* %shout, align 8, !dbg !161
  %String.upper = call %struct.String @String.upper(%struct.String* %greeting), !dbg !166
  %tmp_struct1 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %String.upper, %struct.String* %tmp_struct1, align 8, !dbg !166
  %tmp_op2 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %String.upper, %struct.String* %tmp_op2, align 8, !dbg !166
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op2, %struct.String* %shout), !dbg !166
  %value3 = getelementptr %struct.String, %struct.String* %shout, i32 0, i32 0, !dbg !166
  %DOT4 = load i8*, i8** %value3, align 8, !dbg !166
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i32 1, i8* %DOT4), !dbg !166
  store %struct.String zeroinitializer, %struct.String* %whisper, align 8, !dbg !161
  %String.lower = call %struct.String @String.lower(%struct.String* %greeting), !dbg !167
  %tmp_struct5 = alloca %struct.String, align 8, !dbg !167
  store %struct.String %String.lower, %struct.String* %tmp_struct5, align 8, !dbg !167
  %tmp_op6 = alloca %struct.String, align 8, !dbg !167
  store %struct.String %String.lower, %struct.String* %tmp_op6, align 8, !dbg !167
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op6, %struct.String* %whisper), !dbg !167
  %value7 = getelementptr %struct.String, %struct.String* %whisper, i32 0, i32 0, !dbg !167
  %DOT8 = load i8*, i8** %value7, align 8, !dbg !167
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 1, i8* %DOT8), !dbg !167
  store %struct.String zeroinitializer, %struct.String* %word, align 8, !dbg !161
  %String.substr = call %struct.String @String.substr(i32 7, i32 7, %struct.String* %greeting), !dbg !168
  %tmp_struct9 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %String.substr, %struct.String* %tmp_struct9, align 8, !dbg !168
  %tmp_op10 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %String.substr, %struct.String* %tmp_op10, align 8, !dbg !168
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op10, %struct.String* %word), !dbg !168
  %value11 = getelementptr %struct.String, %struct.String* %word, i32 0, i32 0, !dbg !168
  %DOT12 = load i8*, i8** %value11, align 8, !dbg !168
  %6 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.5, i32 0, i32 0), i32 1, i8* %DOT12), !dbg !168
  store %struct.String zeroinitializer, %struct.String* %msg, align 8, !dbg !161
  %7 = call %struct.String @String.new(), !dbg !169
  %tmp_struct13 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %7, %struct.String* %tmp_struct13, align 8, !dbg !169
  %tmp_op14 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %7, %struct.String* %tmp_op14, align 8, !dbg !169
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op14, %struct.String* %msg), !dbg !169
  call void @String.push(i8 72, %struct.String* %msg), !dbg !170
  call void @String.push(i8 80, %struct.String* %msg), !dbg !171
  %value15 = getelementptr %struct.String, %struct.String* %msg, i32 0, i32 0, !dbg !171
  %DOT16 = load i8*, i8** %value15, align 8, !dbg !171
  %8 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.6, i32 0, i32 0), i32 1, i8* %DOT16), !dbg !171
  store %struct.String zeroinitializer, %struct.String* %first, align 8, !dbg !161
  %9 = call %struct.String @String.from(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR16, i32 0, i32 0)), !dbg !172
  %tmp_struct17 = alloca %struct.String, align 8, !dbg !172
  store %struct.String %9, %struct.String* %tmp_struct17, align 8, !dbg !172
  %tmp_op18 = alloca %struct.String, align 8, !dbg !172
  store %struct.String %9, %struct.String* %tmp_op18, align 8, !dbg !172
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op18, %struct.String* %first), !dbg !172
  store %struct.String zeroinitializer, %struct.String* %last, align 8, !dbg !161
  %10 = call %struct.String @String.from(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR17, i32 0, i32 0)), !dbg !173
  %tmp_struct19 = alloca %struct.String, align 8, !dbg !173
  store %struct.String %10, %struct.String* %tmp_struct19, align 8, !dbg !173
  %tmp_op20 = alloca %struct.String, align 8, !dbg !173
  store %struct.String %10, %struct.String* %tmp_op20, align 8, !dbg !173
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op20, %struct.String* %last), !dbg !173
  store %struct.String zeroinitializer, %struct.String* %name, align 8, !dbg !161
  %11 = call %struct.String @String.operator.ADD.String(%struct.String* %last, %struct.String* %first), !dbg !161
  %tmp_op21 = alloca %struct.String, align 8, !dbg !161
  store %struct.String %11, %struct.String* %tmp_op21, align 8, !dbg !161
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op21, %struct.String* %name), !dbg !161
  %value22 = getelementptr %struct.String, %struct.String* %name, i32 0, i32 0, !dbg !161
  %DOT23 = load i8*, i8** %value22, align 8, !dbg !161
  %12 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.7, i32 0, i32 0), i32 1, i8* %DOT23), !dbg !161
  call void @String.operator.ADD_ASS.String(%struct.String* %last, %struct.String* %first), !dbg !161
  %value24 = getelementptr %struct.String, %struct.String* %first, i32 0, i32 0, !dbg !161
  %DOT25 = load i8*, i8** %value24, align 8, !dbg !161
  %13 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.8, i32 0, i32 0), i32 1, i8* %DOT25), !dbg !161
  store %struct.String zeroinitializer, %struct.String* %a, align 8, !dbg !161
  %14 = call %struct.String @String.from(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR22, i32 0, i32 0)), !dbg !174
  %tmp_struct26 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %14, %struct.String* %tmp_struct26, align 8, !dbg !174
  %tmp_op27 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %14, %struct.String* %tmp_op27, align 8, !dbg !174
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op27, %struct.String* %a), !dbg !174
  store %struct.String zeroinitializer, %struct.String* %b, align 8, !dbg !161
  %15 = call %struct.String @String.from(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR23, i32 0, i32 0)), !dbg !175
  %tmp_struct28 = alloca %struct.String, align 8, !dbg !175
  store %struct.String %15, %struct.String* %tmp_struct28, align 8, !dbg !175
  %tmp_op29 = alloca %struct.String, align 8, !dbg !175
  store %struct.String %15, %struct.String* %tmp_op29, align 8, !dbg !175
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op29, %struct.String* %b), !dbg !175
  %16 = call i1 @String.operator.EQ.String(%struct.String* %b, %struct.String* %a), !dbg !175
  %bool_str30 = select i1 %16, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.9, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.10, i32 0, i32 0), !dbg !175
  %17 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.11, i32 0, i32 0), i32 1, i8* %bool_str30), !dbg !175
  store %struct.String zeroinitializer, %struct.String* %hp_str, align 8, !dbg !161
  %18 = call %struct.String @String.from_int(i32 100), !dbg !176
  %tmp_struct31 = alloca %struct.String, align 8, !dbg !176
  store %struct.String %18, %struct.String* %tmp_struct31, align 8, !dbg !176
  %tmp_op32 = alloca %struct.String, align 8, !dbg !176
  store %struct.String %18, %struct.String* %tmp_op32, align 8, !dbg !176
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op32, %struct.String* %hp_str), !dbg !176
  %value33 = getelementptr %struct.String, %struct.String* %hp_str, i32 0, i32 0, !dbg !176
  %DOT34 = load i8*, i8** %value33, align 8, !dbg !176
  %19 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.12, i32 0, i32 0), i32 1, i8* %DOT34), !dbg !176
  store %struct.String zeroinitializer, %struct.String* %num, align 8, !dbg !161
  %20 = call %struct.String @String.from(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @STR28, i32 0, i32 0)), !dbg !177
  %tmp_struct35 = alloca %struct.String, align 8, !dbg !177
  store %struct.String %20, %struct.String* %tmp_struct35, align 8, !dbg !177
  %tmp_op36 = alloca %struct.String, align 8, !dbg !177
  store %struct.String %20, %struct.String* %tmp_op36, align 8, !dbg !177
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op36, %struct.String* %num), !dbg !177
  %String.to_int = call i32 @String.to_int(%struct.String* %num), !dbg !178
  %21 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.13, i32 0, i32 0), i32 1, i32 %String.to_int), !dbg !178
  store %struct.String zeroinitializer, %struct.String* %padded, align 8, !dbg !161
  %22 = call %struct.String @String.from(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @STR31, i32 0, i32 0)), !dbg !179
  %tmp_struct37 = alloca %struct.String, align 8, !dbg !179
  store %struct.String %22, %struct.String* %tmp_struct37, align 8, !dbg !179
  %tmp_op38 = alloca %struct.String, align 8, !dbg !179
  store %struct.String %22, %struct.String* %tmp_op38, align 8, !dbg !179
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op38, %struct.String* %padded), !dbg !179
  store %struct.String zeroinitializer, %struct.String* %trimmed, align 8, !dbg !161
  %String.trim = call %struct.String @String.trim(%struct.String* %padded), !dbg !180
  %tmp_struct39 = alloca %struct.String, align 8, !dbg !180
  store %struct.String %String.trim, %struct.String* %tmp_struct39, align 8, !dbg !180
  %tmp_op40 = alloca %struct.String, align 8, !dbg !180
  store %struct.String %String.trim, %struct.String* %tmp_op40, align 8, !dbg !180
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op40, %struct.String* %trimmed), !dbg !180
  %value41 = getelementptr %struct.String, %struct.String* %trimmed, i32 0, i32 0, !dbg !180
  %DOT42 = load i8*, i8** %value41, align 8, !dbg !180
  %23 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.14, i32 0, i32 0), i32 1, i8* %DOT42), !dbg !180
  store %struct.String zeroinitializer, %struct.String* %orig, align 8, !dbg !161
  %24 = call %struct.String @String.from(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @STR34, i32 0, i32 0)), !dbg !181
  %tmp_struct43 = alloca %struct.String, align 8, !dbg !181
  store %struct.String %24, %struct.String* %tmp_struct43, align 8, !dbg !181
  %tmp_op44 = alloca %struct.String, align 8, !dbg !181
  store %struct.String %24, %struct.String* %tmp_op44, align 8, !dbg !181
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op44, %struct.String* %orig), !dbg !181
  store %struct.String zeroinitializer, %struct.String* %swapped, align 8, !dbg !161
  %String.replace = call %struct.String @String.replace(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR35, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR36, i32 0, i32 0), %struct.String* %orig), !dbg !182
  %tmp_struct45 = alloca %struct.String, align 8, !dbg !182
  store %struct.String %String.replace, %struct.String* %tmp_struct45, align 8, !dbg !182
  %tmp_op46 = alloca %struct.String, align 8, !dbg !182
  store %struct.String %String.replace, %struct.String* %tmp_op46, align 8, !dbg !182
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op46, %struct.String* %swapped), !dbg !182
  %value47 = getelementptr %struct.String, %struct.String* %swapped, i32 0, i32 0, !dbg !182
  %DOT48 = load i8*, i8** %value47, align 8, !dbg !182
  %25 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.15, i32 0, i32 0), i32 1, i8* %DOT48), !dbg !182
  store %struct.String zeroinitializer, %struct.String* %ha, align 8, !dbg !161
  %26 = call %struct.String @String.from(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @STR39, i32 0, i32 0)), !dbg !183
  %tmp_struct49 = alloca %struct.String, align 8, !dbg !183
  store %struct.String %26, %struct.String* %tmp_struct49, align 8, !dbg !183
  %tmp_op50 = alloca %struct.String, align 8, !dbg !183
  store %struct.String %26, %struct.String* %tmp_op50, align 8, !dbg !183
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op50, %struct.String* %ha), !dbg !183
  store %struct.String zeroinitializer, %struct.String* %ha3, align 8, !dbg !161
  %String.repeat = call %struct.String @String.repeat(i32 3, %struct.String* %ha), !dbg !184
  %tmp_struct51 = alloca %struct.String, align 8, !dbg !184
  store %struct.String %String.repeat, %struct.String* %tmp_struct51, align 8, !dbg !184
  %tmp_op52 = alloca %struct.String, align 8, !dbg !184
  store %struct.String %String.repeat, %struct.String* %tmp_op52, align 8, !dbg !184
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op52, %struct.String* %ha3), !dbg !184
  %value53 = getelementptr %struct.String, %struct.String* %ha3, i32 0, i32 0, !dbg !184
  %DOT54 = load i8*, i8** %value53, align 8, !dbg !184
  %27 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @output_fmt.16, i32 0, i32 0), i32 1, i8* %DOT54), !dbg !184
  store %struct.String zeroinitializer, %struct.String* %rev, align 8, !dbg !161
  %28 = call %struct.String @String.from(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR42, i32 0, i32 0)), !dbg !185
  %tmp_struct55 = alloca %struct.String, align 8, !dbg !185
  store %struct.String %28, %struct.String* %tmp_struct55, align 8, !dbg !185
  %tmp_op56 = alloca %struct.String, align 8, !dbg !185
  store %struct.String %28, %struct.String* %tmp_op56, align 8, !dbg !185
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op56, %struct.String* %rev), !dbg !185
  store %struct.String zeroinitializer, %struct.String* %r, align 8, !dbg !161
  %String.reverse = call %struct.String @String.reverse(%struct.String* %rev), !dbg !186
  %tmp_struct57 = alloca %struct.String, align 8, !dbg !186
  store %struct.String %String.reverse, %struct.String* %tmp_struct57, align 8, !dbg !186
  %tmp_op58 = alloca %struct.String, align 8, !dbg !186
  store %struct.String %String.reverse, %struct.String* %tmp_op58, align 8, !dbg !186
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op58, %struct.String* %r), !dbg !186
  %value59 = getelementptr %struct.String, %struct.String* %r, i32 0, i32 0, !dbg !186
  %DOT60 = load i8*, i8** %value59, align 8, !dbg !186
  %29 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.17, i32 0, i32 0), i32 1, i8* %DOT60), !dbg !186
  call void @String.delete(%struct.String* %greeting), !dbg !186
  call void @String.delete(%struct.String* %shout), !dbg !186
  call void @String.delete(%struct.String* %whisper), !dbg !186
  call void @String.delete(%struct.String* %word), !dbg !186
  call void @String.delete(%struct.String* %msg), !dbg !186
  call void @String.delete(%struct.String* %first), !dbg !186
  call void @String.delete(%struct.String* %last), !dbg !186
  call void @String.delete(%struct.String* %name), !dbg !186
  call void @String.delete(%struct.String* %a), !dbg !186
  call void @String.delete(%struct.String* %b), !dbg !186
  call void @String.delete(%struct.String* %hp_str), !dbg !186
  call void @String.delete(%struct.String* %num), !dbg !186
  call void @String.delete(%struct.String* %padded), !dbg !186
  call void @String.delete(%struct.String* %trimmed), !dbg !186
  call void @String.delete(%struct.String* %orig), !dbg !186
  call void @String.delete(%struct.String* %swapped), !dbg !186
  call void @String.delete(%struct.String* %ha), !dbg !186
  call void @String.delete(%struct.String* %ha3), !dbg !186
  call void @String.delete(%struct.String* %rev), !dbg !186
  call void @String.delete(%struct.String* %r), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct1), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct5), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct9), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct13), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct17), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct19), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct26), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct28), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct31), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct35), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct37), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct39), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct43), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct45), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct49), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct51), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct55), !dbg !186
  call void @String.delete(%struct.String* %tmp_struct57), !dbg !186
  ret i32 0, !dbg !186
}
...
!3 = !DIFile(filename: "floor18.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
...
!163 = !DILocation(line: 6, scope: !160)
!164 = !DILocation(line: 8, scope: !160)
!165 = !DILocation(line: 9, scope: !160)
!166 = !DILocation(line: 11, scope: !160)
!167 = !DILocation(line: 14, scope: !160)
!168 = !DILocation(line: 17, scope: !160)
!169 = !DILocation(line: 20, scope: !160)
!170 = !DILocation(line: 21, scope: !160)
!171 = !DILocation(line: 22, scope: !160)
!172 = !DILocation(line: 25, scope: !160)
!173 = !DILocation(line: 26, scope: !160)
!174 = !DILocation(line: 33, scope: !160)
!175 = !DILocation(line: 34, scope: !160)
!176 = !DILocation(line: 37, scope: !160)
!177 = !DILocation(line: 40, scope: !160)
!178 = !DILocation(line: 41, scope: !160)
!179 = !DILocation(line: 43, scope: !160)
...
!185 = !DILocation(line: 55, scope: !160)
!186 = !DILocation(line: 56, scope: !160)
