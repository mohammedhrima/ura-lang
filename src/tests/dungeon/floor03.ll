; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor03.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon/floor03.ura"
...
if.end:                                           ; preds = %if.else, %elif.then7, %elif.then, %if.then
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt.4, i32 0, i32 0), i32 0), !dbg !7
  br label %if.start10, !dbg !7

if.then:                                          ; preds = %if.start
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt, i32 0, i32 0), i32 0), !dbg !7
  ...
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end, !dbg !7
  ...
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.2, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end, !dbg !7

if.else:                                          ; preds = %elif.start4
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt.3, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end, !dbg !7
...
if.then12:                                        ; preds = %if.start10
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt.5, i32 0, i32 0), i32 0), !dbg !7
  ...
  %6 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @output_fmt.6, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end11, !dbg !7
  ...
  %7 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt.7, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end11, !dbg !7

if.else21:                                        ; preds = %elif.start17
  %8 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.8, i32 0, i32 0), i32 0), !dbg !7
  br label %if.end11, !dbg !7
}
...
!3 = !DIFile(filename: "floor03.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/dungeon")
