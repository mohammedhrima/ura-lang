; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor13b.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor13b.ura"
...
@STR2 = private unnamed_addr constant [9 x i8] c" chars)\0A\00", align 1
@output_fmt = private unnamed_addr constant [15 x i8] c"%s (%d chars)\0A\00", align 1
@STR3 = private unnamed_addr constant [7 x i8] c"Shadow\00", align 1
@STR4 = private unnamed_addr constant [7 x i8] c"Aldric\00", align 1
...
define %struct.Label @Label.new() !dbg !160 {
entry:
  %l = alloca %struct.Label, align 8, !dbg !161
  store %struct.Label zeroinitializer, %struct.Label* %l, align 8, !dbg !161
  %value = getelementptr %struct.Label, %struct.Label* %l, i32 0, i32 0, !dbg !161
  %heap = call i8* @calloc(i64 64, i64 1), !dbg !161
  store i8* %heap, i8** %value, align 8, !dbg !161
  %len = getelementptr %struct.Label, %struct.Label* %l, i32 0, i32 1, !dbg !161
  store i32 0, i32* %len, align 4, !dbg !161
  %l1 = load %struct.Label, %struct.Label* %l, align 8, !dbg !161
  ret %struct.Label %l1, !dbg !161
}

define void @Label.delete(%struct.Label* %self) !dbg !162 {
entry:
  %self1 = alloca %struct.Label*, align 8, !dbg !163
  store %struct.Label* %self, %struct.Label** %self1, align 8, !dbg !163
  %self2 = load %struct.Label*, %struct.Label** %self1, align 8, !dbg !164
  %value = getelementptr %struct.Label, %struct.Label* %self2, i32 0, i32 0, !dbg !164
  %DOT = load i8*, i8** %value, align 8, !dbg !164
  call void @free(i8* %DOT), !dbg !164
  %self3 = load %struct.Label*, %struct.Label** %self1, align 8, !dbg !164
  ret void, !dbg !164
}

define void @Label.set(i8* %s, %struct.Label* %self) !dbg !165 {
entry:
  %s1 = alloca i8*, align 8, !dbg !166
  %self2 = alloca %struct.Label*, align 8, !dbg !166
  store i8* %s, i8** %s1, align 8, !dbg !166
  store %struct.Label* %self, %struct.Label** %self2, align 8, !dbg !166
  %self3 = load %struct.Label*, %struct.Label** %self2, align 8, !dbg !167
  %value = getelementptr %struct.Label, %struct.Label* %self3, i32 0, i32 0, !dbg !167
  %DOT = load i8*, i8** %value, align 8, !dbg !167
  %s4 = load i8*, i8** %s1, align 8, !dbg !167
  %strcpy = call i8* @strcpy(i8* %DOT, i8* %s4), !dbg !167
  %self5 = load %struct.Label*, %struct.Label** %self2, align 8, !dbg !167
  %len = getelementptr %struct.Label, %struct.Label* %self5, i32 0, i32 1, !dbg !167
  %s6 = load i8*, i8** %s1, align 8, !dbg !168
  %strlen = call i32 @strlen(i8* %s6), !dbg !168
  store i32 %strlen, i32* %len, align 4, !dbg !168
  ret void, !dbg !168
}

define void @Label.operator.ASSIGN.CHARS(i8* %s, %struct.Label* %self) !dbg !169 {
entry:
  %s1 = alloca i8*, align 8, !dbg !170
  %self2 = alloca %struct.Label*, align 8, !dbg !170
  store i8* %s, i8** %s1, align 8, !dbg !170
  store %struct.Label* %self, %struct.Label** %self2, align 8, !dbg !170
  %s3 = load i8*, i8** %s1, align 8, !dbg !171
  %ref_arg = load %struct.Label*, %struct.Label** %self2, align 8, !dbg !171
  call void @Label.set(i8* %s3, %struct.Label* %ref_arg), !dbg !171
  ret void, !dbg !171
}

define void @Label.operator.ASSIGN.Label(%struct.Label* %v, %struct.Label* %self) !dbg !172 {
entry:
  %v1 = alloca %struct.Label*, align 8, !dbg !173
  %self2 = alloca %struct.Label*, align 8, !dbg !173
  store %struct.Label* %v, %struct.Label** %v1, align 8, !dbg !173
  store %struct.Label* %self, %struct.Label** %self2, align 8, !dbg !173
  %v3 = load %struct.Label*, %struct.Label** %v1, align 8, !dbg !174
  %value = getelementptr %struct.Label, %struct.Label* %v3, i32 0, i32 0, !dbg !174
  %DOT = load i8*, i8** %value, align 8, !dbg !174
  %ref_arg = load %struct.Label*, %struct.Label** %self2, align 8, !dbg !174
  call void @Label.set(i8* %DOT, %struct.Label* %ref_arg), !dbg !174
  ret void, !dbg !174
}

define %struct.Label @Label.operator.ADD.Label(%struct.Label* %v, %struct.Label* %self) !dbg !175 {
entry:
  %v1 = alloca %struct.Label*, align 8, !dbg !176
  %self2 = alloca %struct.Label*, align 8, !dbg !176
  %res = alloca %struct.Label, align 8, !dbg !176
  store %struct.Label* %v, %struct.Label** %v1, align 8, !dbg !176
  store %struct.Label* %self, %struct.Label** %self2, align 8, !dbg !176
  store %struct.Label zeroinitializer, %struct.Label* %res, align 8, !dbg !176
  %0 = call %struct.Label @Label.new(), !dbg !177
  %tmp_struct = alloca %struct.Label, align 8, !dbg !177
  store %struct.Label %0, %struct.Label* %tmp_struct, align 8, !dbg !177
  %tmp_op = alloca %struct.Label, align 8, !dbg !177
  store %struct.Label %0, %struct.Label* %tmp_op, align 8, !dbg !177
  call void @Label.operator.ASSIGN.Label(%struct.Label* %tmp_op, %struct.Label* %res), !dbg !177
  %value = getelementptr %struct.Label, %struct.Label* %res, i32 0, i32 0, !dbg !178
  %DOT = load i8*, i8** %value, align 8, !dbg !178
  %self3 = load %struct.Label*, %struct.Label** %self2, align 8, !dbg !178
  %value4 = getelementptr %struct.Label, %struct.Label* %self3, i32 0, i32 0, !dbg !178
  %DOT5 = load i8*, i8** %value4, align 8, !dbg !178
  %strcpy = call i8* @strcpy(i8* %DOT, i8* %DOT5), !dbg !178
  %value6 = getelementptr %struct.Label, %struct.Label* %res, i32 0, i32 0, !dbg !179
  %DOT7 = load i8*, i8** %value6, align 8, !dbg !179
  %v8 = load %struct.Label*, %struct.Label** %v1, align 8, !dbg !179
  %value9 = getelementptr %struct.Label, %struct.Label* %v8, i32 0, i32 0, !dbg !179
  %DOT10 = load i8*, i8** %value9, align 8, !dbg !179
  %strcat = call i8* @strcat(i8* %DOT7, i8* %DOT10), !dbg !179
  %len = getelementptr %struct.Label, %struct.Label* %res, i32 0, i32 1, !dbg !179
  %self11 = load %struct.Label*, %struct.Label** %self2, align 8, !dbg !179
  %len12 = getelementptr %struct.Label, %struct.Label* %self11, i32 0, i32 1, !dbg !179
  %v13 = load %struct.Label*, %struct.Label** %v1, align 8, !dbg !179
  %len14 = getelementptr %struct.Label, %struct.Label* %v13, i32 0, i32 1, !dbg !179
  %DOT15 = load i32, i32* %len12, align 4, !dbg !179
  %DOT16 = load i32, i32* %len14, align 4, !dbg !179
  %ADD = add i32 %DOT15, %DOT16, !dbg !179
  store i32 %ADD, i32* %len, align 4, !dbg !179
  call void @Label.delete(%struct.Label* %tmp_struct), !dbg !179
  %res17 = load %struct.Label, %struct.Label* %res, align 8, !dbg !179
  ret %struct.Label %res17, !dbg !179
}

define void @Label.print(%struct.Label* %self) !dbg !180 {
entry:
  %self1 = alloca %struct.Label*, align 8, !dbg !181
  store %struct.Label* %self, %struct.Label** %self1, align 8, !dbg !181
  %self2 = load %struct.Label*, %struct.Label** %self1, align 8, !dbg !181
  %value = getelementptr %struct.Label, %struct.Label* %self2, i32 0, i32 0, !dbg !181
  %DOT = load i8*, i8** %value, align 8, !dbg !181
  %self3 = load %struct.Label*, %struct.Label** %self1, align 8, !dbg !181
  %len = getelementptr %struct.Label, %struct.Label* %self3, i32 0, i32 1, !dbg !181
  %DOT4 = load i32, i32* %len, align 4, !dbg !181
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT, i32 %DOT4), !dbg !181
  ret void, !dbg !181
}
...
define i32 @main() !dbg !182 {
entry:
  %title = alloca %struct.Label, align 8, !dbg !183
  %name = alloca %struct.Label, align 8, !dbg !183
  %full = alloca %struct.Label, align 8, !dbg !183
  store %struct.Label zeroinitializer, %struct.Label* %title, align 8, !dbg !183
  %0 = call %struct.Label @Label.new(), !dbg !184
  %tmp_struct = alloca %struct.Label, align 8, !dbg !184
  store %struct.Label %0, %struct.Label* %tmp_struct, align 8, !dbg !184
  %tmp_op = alloca %struct.Label, align 8, !dbg !184
  store %struct.Label %0, %struct.Label* %tmp_op, align 8, !dbg !184
  call void @Label.operator.ASSIGN.Label(%struct.Label* %tmp_op, %struct.Label* %title), !dbg !184
  call void @Label.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR3, i32 0, i32 0), %struct.Label* %title), !dbg !184
  store %struct.Label zeroinitializer, %struct.Label* %name, align 8, !dbg !183
  %1 = call %struct.Label @Label.new(), !dbg !185
  %tmp_struct1 = alloca %struct.Label, align 8, !dbg !185
  store %struct.Label %1, %struct.Label* %tmp_struct1, align 8, !dbg !185
  %tmp_op2 = alloca %struct.Label, align 8, !dbg !185
  store %struct.Label %1, %struct.Label* %tmp_op2, align 8, !dbg !185
  call void @Label.operator.ASSIGN.Label(%struct.Label* %tmp_op2, %struct.Label* %name), !dbg !185
  call void @Label.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR4, i32 0, i32 0), %struct.Label* %name), !dbg !185
  store %struct.Label zeroinitializer, %struct.Label* %full, align 8, !dbg !183
  %2 = call %struct.Label @Label.operator.ADD.Label(%struct.Label* %name, %struct.Label* %title), !dbg !183
  %tmp_op3 = alloca %struct.Label, align 8, !dbg !183
  store %struct.Label %2, %struct.Label* %tmp_op3, align 8, !dbg !183
  call void @Label.operator.ASSIGN.Label(%struct.Label* %tmp_op3, %struct.Label* %full), !dbg !183
  call void @Label.print(%struct.Label* %full), !dbg !186
  call void @Label.delete(%struct.Label* %title), !dbg !186
  call void @Label.delete(%struct.Label* %name), !dbg !186
  call void @Label.delete(%struct.Label* %full), !dbg !186
  call void @Label.delete(%struct.Label* %tmp_struct), !dbg !186
  call void @Label.delete(%struct.Label* %tmp_struct1), !dbg !186
  ret i32 0, !dbg !186
}
...
!3 = !DIFile(filename: "floor13b.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
...
!160 = distinct !DISubprogram(name: "Label.new", linkageName: "Label.new", scope: null, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 8, scope: !160)
!162 = distinct !DISubprogram(name: "Label.delete", linkageName: "Label.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 0, scope: !162)
!164 = !DILocation(line: 15, scope: !162)
!165 = distinct !DISubprogram(name: "Label.set", linkageName: "Label.set", scope: null, file: !3, line: 17, type: !5, scopeLine: 17, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!166 = !DILocation(line: 17, scope: !165)
!167 = !DILocation(line: 18, scope: !165)
!168 = !DILocation(line: 19, scope: !165)
!169 = distinct !DISubprogram(name: "Label.operator.ASSIGN.CHARS", linkageName: "Label.operator.ASSIGN.CHARS", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!170 = !DILocation(line: 0, scope: !169)
!171 = !DILocation(line: 22, scope: !169)
!172 = distinct !DISubprogram(name: "Label.operator.ASSIGN.Label", linkageName: "Label.operator.ASSIGN.Label", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!173 = !DILocation(line: 0, scope: !172)
!174 = !DILocation(line: 25, scope: !172)
!175 = distinct !DISubprogram(name: "Label.operator.ADD.Label", linkageName: "Label.operator.ADD.Label", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!176 = !DILocation(line: 0, scope: !175)
!177 = !DILocation(line: 28, scope: !175)
!178 = !DILocation(line: 29, scope: !175)
!179 = !DILocation(line: 30, scope: !175)
!180 = distinct !DISubprogram(name: "Label.print", linkageName: "Label.print", scope: null, file: !3, line: 34, type: !5, scopeLine: 34, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!181 = !DILocation(line: 34, scope: !180)
!182 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 37, type: !5, scopeLine: 37, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!183 = !DILocation(line: 37, scope: !182)
!184 = !DILocation(line: 38, scope: !182)
!185 = !DILocation(line: 41, scope: !182)
!186 = !DILocation(line: 45, scope: !182)
