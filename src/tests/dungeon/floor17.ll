; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor17.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon/floor17.ura"
...
if.end:                                           ; preds = %if.start
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @output_fmt.1, i32 0, i32 0)), !dbg !168
...
if.then:                                          ; preds = %if.start
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0)), !dbg !162
  ret void, !dbg !162
...
if.then27:                                        ; preds = %if.start25
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @output_fmt.2, i32 0, i32 0), i8* %buf29), !dbg !172
...
!3 = !DIFile(filename: "floor17.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/dungeon")
