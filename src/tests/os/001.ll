; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/os/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/os/001.ura"
...
@STR3 = private unnamed_addr constant [10 x i8] c"argv[0]: \00", align 1
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 %argc3), !dbg !161
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.1, i32 0, i32 0), i8* %ACC), !dbg !162
  ret i32 0, !dbg !162
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/os")
