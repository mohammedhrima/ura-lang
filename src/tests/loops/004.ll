; ModuleID = 'src/tests/loops/004.ura'
source_filename = "src/tests/loops/004.ura"
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %i1), !dbg !161
...
for.end:                                          ; preds = %for.cond
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.1, i32 0, i32 0), i32 0), !dbg !161
...
for.body4:                                        ; preds = %for.cond3
  ...
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i32 %i11), !dbg !161
...
for.end6:                                         ; preds = %for.cond3
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.3, i32 0, i32 0), i32 0), !dbg !161
...
for.body16:                                       ; preds = %for.cond15
  ...
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 1, i32 %i23), !dbg !161
...
for.end18:                                        ; preds = %for.cond15
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.5, i32 0, i32 0), i32 0), !dbg !161
...
for.body28:                                       ; preds = %for.cond27
  ...
  %6 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i32 1, i32 %i35), !dbg !161
...
for.end30:                                        ; preds = %for.cond27
  %7 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.7, i32 0, i32 0), i32 0), !dbg !161
...
for.end42:                                        ; preds = %if.then, %for.cond39
  %8 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.9, i32 0, i32 0), i32 0), !dbg !161
...
if.end:                                           ; preds = %if.start
  ...
  %9 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i32 1, i32 %i48), !dbg !161
...
for.end55:                                        ; preds = %for.cond52
  %10 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.11, i32 0, i32 0), i32 0), !dbg !161
  ret i32 0, !dbg !161
...
if.end61:                                         ; preds = %if.start60
  ...
  %11 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.10, i32 0, i32 0), i32 1, i32 %i64), !dbg !161
...
!3 = !DIFile(filename: "004.ura", directory: "src/tests/loops")
