; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops/001.ura"
...
while.end:                                        ; preds = %while.start
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @output_fmt, i32 0, i32 0), i32 %kills3), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/loops")
