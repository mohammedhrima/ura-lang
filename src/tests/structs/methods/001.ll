; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/methods/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/methods/001.ura"
...
@STR2 = private unnamed_addr constant [10 x i8] c" enters!\0A\00", align 1
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT, i8* %DOT4), !dbg !167
  ret void, !dbg !167
}

define void @Hero.delete(%struct.Hero* %self) !dbg !168 {
entry:
  %self1 = alloca %struct.Hero*, align 8, !dbg !169
  store %struct.Hero* %self, %struct.Hero** %self1, align 8, !dbg !169
  %self2 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !170
  %name = getelementptr %struct.Hero, %struct.Hero* %self2, i32 0, i32 0, !dbg !170
  %DOT = load i8*, i8** %name, align 8, !dbg !170
  call void @free(i8* %DOT), !dbg !170
  %self3 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !171
  %title = getelementptr %struct.Hero, %struct.Hero* %self3, i32 0, i32 1, !dbg !171
  %DOT4 = load i8*, i8** %title, align 8, !dbg !171
  call void @free(i8* %DOT4), !dbg !171
  %self5 = load %struct.Hero*, %struct.Hero** %self1, align 8, !dbg !171
  ret void, !dbg !171
}

declare i32 @printf(i8*, ...)

define i32 @main() !dbg !172 {
entry:
  %hero = alloca %struct.Hero, align 8, !dbg !173
  store %struct.Hero zeroinitializer, %struct.Hero* %hero, align 8, !dbg !173
  %0 = call %struct.Hero @Hero.new(), !dbg !174
  %tmp_struct = alloca %struct.Hero, align 8, !dbg !174
  store %struct.Hero %0, %struct.Hero* %tmp_struct, align 8, !dbg !174
  store %struct.Hero %0, %struct.Hero* %hero, align 8, !dbg !174
  call void @Hero.setup(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR3, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @STR4, i32 0, i32 0), %struct.Hero* %hero), !dbg !175
  call void @Hero.announce(%struct.Hero* %hero), !dbg !176
  call void @Hero.delete(%struct.Hero* %hero), !dbg !176
  call void @Hero.delete(%struct.Hero* %tmp_struct), !dbg !176
  ret i32 0, !dbg !176
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/methods")
...
!162 = distinct !DISubprogram(name: "Hero.setup", linkageName: "Hero.setup", scope: null, file: !3, line: 15, type: !5, scopeLine: 15, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 15, scope: !162)
!164 = !DILocation(line: 16, scope: !162)
!165 = !DILocation(line: 17, scope: !162)
!166 = distinct !DISubprogram(name: "Hero.announce", linkageName: "Hero.announce", scope: null, file: !3, line: 19, type: !5, scopeLine: 19, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!167 = !DILocation(line: 19, scope: !166)
!168 = distinct !DISubprogram(name: "Hero.delete", linkageName: "Hero.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!169 = !DILocation(line: 0, scope: !168)
!170 = !DILocation(line: 23, scope: !168)
!171 = !DILocation(line: 24, scope: !168)
!172 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 26, type: !5, scopeLine: 26, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!173 = !DILocation(line: 26, scope: !172)
!174 = !DILocation(line: 27, scope: !172)
!175 = !DILocation(line: 28, scope: !172)
!176 = !DILocation(line: 29, scope: !172)
