; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/output/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/output/002.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }
%struct.Name = type { i8*, i8* }
...
@STR2 = private unnamed_addr constant [6 x i8] c"Smith\00", align 1
@STR3 = private unnamed_addr constant [7 x i8] c"name: \00", align 1
@STR4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [10 x i8] c"name: %s\0A\00", align 1
@STR5 = private unnamed_addr constant [12 x i8] c" the Brave\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [14 x i8] c"%s the Brave\0A\00", align 1
...
define void @Name.delete(%struct.Name* %0) {
entry:
  ret void
}

define i8* @Name.operator.output(%struct.Name* %self) !dbg !160 {
entry:
  %self1 = alloca %struct.Name*, align 8, !dbg !161
  store %struct.Name* %self, %struct.Name** %self1, align 8, !dbg !161
  %self2 = load %struct.Name*, %struct.Name** %self1, align 8, !dbg !161
  %first = getelementptr %struct.Name, %struct.Name* %self2, i32 0, i32 0, !dbg !161
  %DOT = load i8*, i8** %first, align 8, !dbg !161
  ret i8* %DOT, !dbg !161
}

define i32 @main() !dbg !162 {
entry:
  %n = alloca %struct.Name, align 8, !dbg !163
  store %struct.Name zeroinitializer, %struct.Name* %n, align 8, !dbg !163
  %first = getelementptr %struct.Name, %struct.Name* %n, i32 0, i32 0, !dbg !163
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR1, i32 0, i32 0), i8** %first, align 8, !dbg !163
  %last = getelementptr %struct.Name, %struct.Name* %n, i32 0, i32 1, !dbg !163
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR2, i32 0, i32 0), i8** %last, align 8, !dbg !163
  %output_op = call i8* @Name.operator.output(%struct.Name* %n), !dbg !163
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %output_op), !dbg !163
  %output_op1 = call i8* @Name.operator.output(%struct.Name* %n), !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %output_op1), !dbg !163
  call void @Name.delete(%struct.Name* %n), !dbg !163
  ret i32 0, !dbg !163
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/output")
...
!160 = distinct !DISubprogram(name: "Name.operator.output", linkageName: "Name.operator.output", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 0, scope: !160)
!162 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 11, type: !5, scopeLine: 11, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 11, scope: !162)
