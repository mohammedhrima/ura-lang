; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/output/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/output/002.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt, i32 0, i32 0), i8* %output_op), !dbg !163
  %output_op1 = call i8* @Name.operator.output(%struct.Name* %n), !dbg !163
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt.1, i32 0, i32 0), i8* %output_op1), !dbg !163
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/structs/output")
