; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/output/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/output/003.ura"
...
@STR2 = private unnamed_addr constant [8 x i8] c"Score: \00", align 1
@STR3 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [11 x i8] c"Score: %s\0A\00", align 1
@STR4 = private unnamed_addr constant [12 x i8] c" \E2\80\94 nice!\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [14 x i8] c"%s \E2\80\94 nice!\0A\00", align 1
...
define %struct.Score @Score.new(i32 %p, i32 %c) !dbg !160 {
entry:
  %p1 = alloca i32, align 4, !dbg !161
  %c2 = alloca i32, align 4, !dbg !161
  %s = alloca %struct.Score, align 8, !dbg !161
  store i32 %p, i32* %p1, align 4, !dbg !161
  store i32 %c, i32* %c2, align 4, !dbg !161
  store %struct.Score zeroinitializer, %struct.Score* %s, align 4, !dbg !161
  %points = getelementptr %struct.Score, %struct.Score* %s, i32 0, i32 0, !dbg !161
  %p3 = load i32, i32* %p1, align 4, !dbg !161
  store i32 %p3, i32* %points, align 4, !dbg !161
  %combo = getelementptr %struct.Score, %struct.Score* %s, i32 0, i32 1, !dbg !161
  %c4 = load i32, i32* %c2, align 4, !dbg !161
  store i32 %c4, i32* %combo, align 4, !dbg !161
  %s5 = load %struct.Score, %struct.Score* %s, align 4, !dbg !161
  ret %struct.Score %s5, !dbg !161
}

define %struct.String @Score.operator.output(%struct.Score* %self) !dbg !162 {
entry:
  %self1 = alloca %struct.Score*, align 8, !dbg !163
  %s = alloca %struct.String, align 8, !dbg !163
  %c = alloca %struct.String, align 8, !dbg !163
  store %struct.Score* %self, %struct.Score** %self1, align 8, !dbg !163
  store %struct.String zeroinitializer, %struct.String* %s, align 8, !dbg !163
  %self2 = load %struct.Score*, %struct.Score** %self1, align 8, !dbg !164
  %points = getelementptr %struct.Score, %struct.Score* %self2, i32 0, i32 0, !dbg !164
  %DOT = load i32, i32* %points, align 4, !dbg !164
  %0 = call %struct.String @String.from_int(i32 %DOT), !dbg !164
  ...
  call void @String.join(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @STR1, i32 0, i32 0), %struct.String* %s), !dbg !165
  store %struct.String zeroinitializer, %struct.String* %c, align 8, !dbg !163
  %self3 = load %struct.Score*, %struct.Score** %self1, align 8, !dbg !166
  %combo = getelementptr %struct.Score, %struct.Score* %self3, i32 0, i32 1, !dbg !166
  %DOT4 = load i32, i32* %combo, align 4, !dbg !166
  ...
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op6, %struct.String* %c), !dbg !166
  %value = getelementptr %struct.String, %struct.String* %c, i32 0, i32 0, !dbg !167
  %DOT7 = load i8*, i8** %value, align 8, !dbg !167
  call void @String.join(i8* %DOT7, %struct.String* %s), !dbg !167
  call void @String.delete(%struct.String* %c), !dbg !167
  call void @String.delete(%struct.String* %tmp_struct), !dbg !167
  call void @String.delete(%struct.String* %tmp_struct5), !dbg !167
  %s8 = load %struct.String, %struct.String* %s, align 8, !dbg !167
  ret %struct.String %s8, !dbg !167
}

define i32 @main() !dbg !168 {
entry:
  %s = alloca %struct.Score, align 8, !dbg !169
  store %struct.Score zeroinitializer, %struct.Score* %s, align 4, !dbg !169
  %0 = call %struct.Score @Score.new(i32 1500, i32 3), !dbg !170
  %tmp_struct = alloca %struct.Score, align 8, !dbg !170
  store %struct.Score %0, %struct.Score* %tmp_struct, align 4, !dbg !170
  store %struct.Score %0, %struct.Score* %s, align 4, !dbg !170
  %output_op = call %struct.String @Score.operator.output(%struct.Score* %s), !dbg !170
  %out_tmp = alloca %struct.String, align 8, !dbg !170
  store %struct.String %output_op, %struct.String* %out_tmp, align 8, !dbg !170
  %output_op1 = call i8* @String.operator.output(%struct.String* %out_tmp), !dbg !170
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %output_op1), !dbg !170
  %output_op2 = call %struct.String @Score.operator.output(%struct.Score* %s), !dbg !170
  %out_tmp3 = alloca %struct.String, align 8, !dbg !170
  store %struct.String %output_op2, %struct.String* %out_tmp3, align 8, !dbg !170
  %output_op4 = call i8* @String.operator.output(%struct.String* %out_tmp3), !dbg !170
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %output_op4), !dbg !170
  call void @Score.delete(%struct.Score* %s), !dbg !170
  call void @Score.delete(%struct.Score* %tmp_struct), !dbg !170
  call void @String.delete(%struct.String* %out_tmp), !dbg !170
  call void @String.delete(%struct.String* %out_tmp3), !dbg !170
  ret i32 0, !dbg !170
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/output")
...
!160 = distinct !DISubprogram(name: "Score.new", linkageName: "Score.new", scope: null, file: !3, line: 8, type: !5, scopeLine: 8, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 8, scope: !160)
!162 = distinct !DISubprogram(name: "Score.operator.output", linkageName: "Score.operator.output", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 0, scope: !162)
!164 = !DILocation(line: 15, scope: !162)
!165 = !DILocation(line: 16, scope: !162)
!166 = !DILocation(line: 17, scope: !162)
!167 = !DILocation(line: 18, scope: !162)
!168 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 21, type: !5, scopeLine: 21, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!169 = !DILocation(line: 21, scope: !168)
!170 = !DILocation(line: 22, scope: !168)
