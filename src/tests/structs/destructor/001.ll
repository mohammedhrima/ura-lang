; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/destructor/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/destructor/001.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }
%struct.Tracker = type { i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [8 x i8] c"create \00", align 1
@STR2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt = private unnamed_addr constant [11 x i8] c"create %d\0A\00", align 1
@STR3 = private unnamed_addr constant [8 x i8] c"delete \00", align 1
@STR4 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.1 = private unnamed_addr constant [11 x i8] c"delete %d\0A\00", align 1
@STR5 = private unnamed_addr constant [7 x i8] c"using \00", align 1
@STR6 = private unnamed_addr constant [6 x i8] c" and \00", align 1
@STR7 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.2 = private unnamed_addr constant [17 x i8] c"using %d and %d\0A\00", align 1
...
define %struct.Tracker @Tracker.new(i32 %id) !dbg !160 {
entry:
  %id1 = alloca i32, align 4, !dbg !161
  %t = alloca %struct.Tracker, align 8, !dbg !161
  store i32 %id, i32* %id1, align 4, !dbg !161
  store %struct.Tracker zeroinitializer, %struct.Tracker* %t, align 4, !dbg !161
  %id2 = getelementptr %struct.Tracker, %struct.Tracker* %t, i32 0, i32 0, !dbg !161
  %id3 = load i32, i32* %id1, align 4, !dbg !161
  store i32 %id3, i32* %id2, align 4, !dbg !161
  %id4 = load i32, i32* %id1, align 4, !dbg !161
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt, i32 0, i32 0), i32 1, i32 %id4), !dbg !161
  %t5 = load %struct.Tracker, %struct.Tracker* %t, align 4, !dbg !161
  ret %struct.Tracker %t5, !dbg !161
}

define void @Tracker.delete(%struct.Tracker* %self) !dbg !162 {
entry:
  %self1 = alloca %struct.Tracker*, align 8, !dbg !163
  store %struct.Tracker* %self, %struct.Tracker** %self1, align 8, !dbg !163
  %self2 = load %struct.Tracker*, %struct.Tracker** %self1, align 8, !dbg !163
  %id = getelementptr %struct.Tracker, %struct.Tracker* %self2, i32 0, i32 0, !dbg !163
  %DOT = load i32, i32* %id, align 4, !dbg !163
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %DOT), !dbg !163
  %self3 = load %struct.Tracker*, %struct.Tracker** %self1, align 8, !dbg !163
  ret void, !dbg !163
}

declare i32 @printf(i8*, i32, ...)

define i32 @main() !dbg !164 {
entry:
  %a = alloca %struct.Tracker, align 8, !dbg !165
  %b = alloca %struct.Tracker, align 8, !dbg !165
  store %struct.Tracker zeroinitializer, %struct.Tracker* %a, align 4, !dbg !165
  %0 = call %struct.Tracker @Tracker.new(i32 1), !dbg !166
  %tmp_struct = alloca %struct.Tracker, align 8, !dbg !166
  store %struct.Tracker %0, %struct.Tracker* %tmp_struct, align 4, !dbg !166
  store %struct.Tracker %0, %struct.Tracker* %a, align 4, !dbg !166
  store %struct.Tracker zeroinitializer, %struct.Tracker* %b, align 4, !dbg !165
  %1 = call %struct.Tracker @Tracker.new(i32 2), !dbg !167
  %tmp_struct1 = alloca %struct.Tracker, align 8, !dbg !167
  store %struct.Tracker %1, %struct.Tracker* %tmp_struct1, align 4, !dbg !167
  store %struct.Tracker %1, %struct.Tracker* %b, align 4, !dbg !167
  %id = getelementptr %struct.Tracker, %struct.Tracker* %a, i32 0, i32 0, !dbg !167
  %DOT = load i32, i32* %id, align 4, !dbg !167
  %id2 = getelementptr %struct.Tracker, %struct.Tracker* %b, i32 0, i32 0, !dbg !167
  %DOT3 = load i32, i32* %id2, align 4, !dbg !167
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @output_fmt.2, i32 0, i32 0), i32 2, i32 %DOT, i32 %DOT3), !dbg !167
  call void @Tracker.delete(%struct.Tracker* %a), !dbg !167
  call void @Tracker.delete(%struct.Tracker* %b), !dbg !167
  call void @Tracker.delete(%struct.Tracker* %tmp_struct), !dbg !167
  call void @Tracker.delete(%struct.Tracker* %tmp_struct1), !dbg !167
  ret i32 0, !dbg !167
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/structs/destructor")
...
!160 = distinct !DISubprogram(name: "Tracker.new", linkageName: "Tracker.new", scope: null, file: !3, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 7, scope: !160)
!162 = distinct !DISubprogram(name: "Tracker.delete", linkageName: "Tracker.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 0, scope: !162)
!164 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 16, type: !5, scopeLine: 16, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!165 = !DILocation(line: 16, scope: !164)
!166 = !DILocation(line: 17, scope: !164)
!167 = !DILocation(line: 18, scope: !164)
