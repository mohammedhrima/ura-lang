; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/variables/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/variables/003.ura"
...
entry:
  ...
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i64 %xp3), !dbg !7
  %level4 = load i2, i2* %level, align 1, !dbg !7
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.3, i32 0, i32 0), i32 1, i2 %level4), !dbg !7
  %grade5 = load i8, i8* %grade, align 1, !dbg !7
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.4, i32 0, i32 0), i32 1, i8 %grade5), !dbg !7
  ...
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.5, i32 0, i32 0), i32 1, i8* %bool_str), !dbg !7
  %ratio7 = load float, float* %ratio, align 4, !dbg !7
  %f2d = fpext float %ratio7 to double, !dbg !7
  %6 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @output_fmt.6, i32 0, i32 0), i32 1, double %f2d), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/variables")
