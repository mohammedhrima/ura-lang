; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays/005.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays/005.ura"
...
@output_fmt = private unnamed_addr constant [13 x i8] c"%d %d %d %d\0A\00", align 1
...
@output_fmt.1 = private unnamed_addr constant [10 x i8] c"%d %d %d\0A\00", align 1
...
define i32 @double(i32 %n) !dbg !160 {
entry:
  %n1 = alloca i32, align 4, !dbg !161
  store i32 %n, i32* %n1, align 4, !dbg !161
  %n2 = load i32, i32* %n1, align 4, !dbg !161
  %MUL = mul i32 %n2, 2, !dbg !161
  ret i32 %MUL, !dbg !161
}

define i32 @main() !dbg !162 {
entry:
  %x = alloca i32, align 4, !dbg !163
  %v = alloca i32*, align 8, !dbg !163
  %dmg = alloca i32*, align 8, !dbg !163
  store i32 0, i32* %x, align 4, !dbg !163
  store i32 5, i32* %x, align 4, !dbg !163
  store i32* null, i32** %v, align 8, !dbg !163
  %array_lit = call i8* @calloc(i64 4, i64 4), !dbg !163
  %lit_data = bitcast i8* %array_lit to i32*, !dbg !163
  %x1 = load i32, i32* %x, align 4, !dbg !163
  %lit_elem = getelementptr i32, i32* %lit_data, i32 0, !dbg !163
  store i32 %x1, i32* %lit_elem, align 4, !dbg !163
  %x2 = load i32, i32* %x, align 4, !dbg !163
  %ADD = add i32 %x2, 1, !dbg !163
  %lit_elem3 = getelementptr i32, i32* %lit_data, i32 1, !dbg !163
  store i32 %ADD, i32* %lit_elem3, align 4, !dbg !163
  %x4 = load i32, i32* %x, align 4, !dbg !163
  %MUL = mul i32 %x4, 2, !dbg !163
  %lit_elem5 = getelementptr i32, i32* %lit_data, i32 2, !dbg !163
  store i32 %MUL, i32* %lit_elem5, align 4, !dbg !163
  %x6 = load i32, i32* %x, align 4, !dbg !164
  %double = call i32 @double(i32 %x6), !dbg !164
  %lit_elem7 = getelementptr i32, i32* %lit_data, i32 3, !dbg !164
  store i32 %double, i32* %lit_elem7, align 4, !dbg !164
  store i32* %lit_data, i32** %v, align 8, !dbg !164
  %v8 = load i32*, i32** %v, align 8, !dbg !165
  %ACCESS = getelementptr i32, i32* %v8, i32 0, !dbg !165
  %ACC = load i32, i32* %ACCESS, align 4, !dbg !165
  %v9 = load i32*, i32** %v, align 8, !dbg !165
  %ACCESS10 = getelementptr i32, i32* %v9, i32 1, !dbg !165
  %ACC11 = load i32, i32* %ACCESS10, align 4, !dbg !165
  %v12 = load i32*, i32** %v, align 8, !dbg !165
  %ACCESS13 = getelementptr i32, i32* %v12, i32 2, !dbg !165
  %ACC14 = load i32, i32* %ACCESS13, align 4, !dbg !165
  %v15 = load i32*, i32** %v, align 8, !dbg !165
  %ACCESS16 = getelementptr i32, i32* %v15, i32 3, !dbg !165
  %ACC17 = load i32, i32* %ACCESS16, align 4, !dbg !165
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt, i32 0, i32 0), i32 4, i32 %ACC, i32 %ACC11, i32 %ACC14, i32 %ACC17), !dbg !165
  store i32* null, i32** %dmg, align 8, !dbg !163
  %array_lit18 = call i8* @calloc(i64 3, i64 4), !dbg !163
  %lit_data19 = bitcast i8* %array_lit18 to i32*, !dbg !163
  %lit_elem20 = getelementptr i32, i32* %lit_data19, i32 0, !dbg !163
  store i32 15, i32* %lit_elem20, align 4, !dbg !163
  %lit_elem21 = getelementptr i32, i32* %lit_data19, i32 1, !dbg !163
  store i32 17, i32* %lit_elem21, align 4, !dbg !163
  %lit_elem22 = getelementptr i32, i32* %lit_data19, i32 2, !dbg !163
  store i32 16, i32* %lit_elem22, align 4, !dbg !163
  store i32* %lit_data19, i32** %dmg, align 8, !dbg !163
  %dmg23 = load i32*, i32** %dmg, align 8, !dbg !166
  %ACCESS24 = getelementptr i32, i32* %dmg23, i32 0, !dbg !166
  %ACC25 = load i32, i32* %ACCESS24, align 4, !dbg !166
  %dmg26 = load i32*, i32** %dmg, align 8, !dbg !166
  %ACCESS27 = getelementptr i32, i32* %dmg26, i32 1, !dbg !166
  %ACC28 = load i32, i32* %ACCESS27, align 4, !dbg !166
  %dmg29 = load i32*, i32** %dmg, align 8, !dbg !166
  %ACCESS30 = getelementptr i32, i32* %dmg29, i32 2, !dbg !166
  %ACC31 = load i32, i32* %ACCESS30, align 4, !dbg !166
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.1, i32 0, i32 0), i32 3, i32 %ACC25, i32 %ACC28, i32 %ACC31), !dbg !166
  ret i32 0, !dbg !166
}
...
!3 = !DIFile(filename: "005.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays")
...
!160 = distinct !DISubprogram(name: "double", linkageName: "double", scope: null, file: !3, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 4, scope: !160)
!162 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!163 = !DILocation(line: 7, scope: !162)
!164 = !DILocation(line: 9, scope: !162)
!165 = !DILocation(line: 10, scope: !162)
!166 = !DILocation(line: 13, scope: !162)
