; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays/003.ura"
...
@output_fmt = private unnamed_addr constant [16 x i8] c"%d %d %d %d %d\0A\00", align 1
...
entry:
  %v = alloca i32*, align 8, !dbg !161
  %single = alloca i32*, align 8, !dbg !161
  %w = alloca i32*, align 8, !dbg !161
  %i = alloca i32, align 4, !dbg !161
  store i32* null, i32** %v, align 8, !dbg !161
  %array_lit = call i8* @calloc(i64 5, i64 4), !dbg !161
  %lit_data = bitcast i8* %array_lit to i32*, !dbg !161
  %lit_elem = getelementptr i32, i32* %lit_data, i32 0, !dbg !161
  store i32 10, i32* %lit_elem, align 4, !dbg !161
  %lit_elem1 = getelementptr i32, i32* %lit_data, i32 1, !dbg !161
  store i32 20, i32* %lit_elem1, align 4, !dbg !161
  %lit_elem2 = getelementptr i32, i32* %lit_data, i32 2, !dbg !161
  store i32 30, i32* %lit_elem2, align 4, !dbg !161
  %lit_elem3 = getelementptr i32, i32* %lit_data, i32 3, !dbg !161
  store i32 40, i32* %lit_elem3, align 4, !dbg !161
  %lit_elem4 = getelementptr i32, i32* %lit_data, i32 4, !dbg !161
  store i32 50, i32* %lit_elem4, align 4, !dbg !161
  store i32* %lit_data, i32** %v, align 8, !dbg !161
  %v5 = load i32*, i32** %v, align 8, !dbg !162
  %ACCESS = getelementptr i32, i32* %v5, i32 0, !dbg !162
  %ACC = load i32, i32* %ACCESS, align 4, !dbg !162
  %v6 = load i32*, i32** %v, align 8, !dbg !162
  %ACCESS7 = getelementptr i32, i32* %v6, i32 1, !dbg !162
  %ACC8 = load i32, i32* %ACCESS7, align 4, !dbg !162
  %v9 = load i32*, i32** %v, align 8, !dbg !162
  %ACCESS10 = getelementptr i32, i32* %v9, i32 2, !dbg !162
  %ACC11 = load i32, i32* %ACCESS10, align 4, !dbg !162
  %v12 = load i32*, i32** %v, align 8, !dbg !162
  %ACCESS13 = getelementptr i32, i32* %v12, i32 3, !dbg !162
  %ACC14 = load i32, i32* %ACCESS13, align 4, !dbg !162
  %v15 = load i32*, i32** %v, align 8, !dbg !162
  %ACCESS16 = getelementptr i32, i32* %v15, i32 4, !dbg !162
  %ACC17 = load i32, i32* %ACCESS16, align 4, !dbg !162
  %0 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt, i32 0, i32 0), i32 5, i32 %ACC, i32 %ACC8, i32 %ACC11, i32 %ACC14, i32 %ACC17), !dbg !162
  store i32* null, i32** %single, align 8, !dbg !161
  %array_lit18 = call i8* @calloc(i64 1, i64 4), !dbg !161
  %lit_data19 = bitcast i8* %array_lit18 to i32*, !dbg !161
  %lit_elem20 = getelementptr i32, i32* %lit_data19, i32 0, !dbg !161
  store i32 42, i32* %lit_elem20, align 4, !dbg !161
  store i32* %lit_data19, i32** %single, align 8, !dbg !161
  %single21 = load i32*, i32** %single, align 8, !dbg !163
  %ACCESS22 = getelementptr i32, i32* %single21, i32 0, !dbg !163
  %ACC23 = load i32, i32* %ACCESS22, align 4, !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i32 %ACC23), !dbg !163
  store i32* null, i32** %w, align 8, !dbg !161
  %array_lit24 = call i8* @calloc(i64 3, i64 4), !dbg !161
  %lit_data25 = bitcast i8* %array_lit24 to i32*, !dbg !161
  %lit_elem26 = getelementptr i32, i32* %lit_data25, i32 0, !dbg !161
  store i32 1, i32* %lit_elem26, align 4, !dbg !161
  %lit_elem27 = getelementptr i32, i32* %lit_data25, i32 1, !dbg !161
  store i32 2, i32* %lit_elem27, align 4, !dbg !161
  %lit_elem28 = getelementptr i32, i32* %lit_data25, i32 2, !dbg !161
  store i32 3, i32* %lit_elem28, align 4, !dbg !161
  store i32* %lit_data25, i32** %w, align 8, !dbg !161
  store i32 0, i32* %i, align 4, !dbg !161
  store i32 0, i32* %i, align 4, !dbg !161
  br label %while.start, !dbg !161

while.start:                                      ; preds = %while.then, %entry
  %i29 = load i32, i32* %i, align 4, !dbg !161
  %LT = icmp slt i32 %i29, 3, !dbg !161
  br i1 %LT, label %while.then, label %while.end, !dbg !161

while.then:                                       ; preds = %while.start
  %w30 = load i32*, i32** %w, align 8, !dbg !164
  %i31 = load i32, i32* %i, align 4, !dbg !164
  %ACCESS32 = getelementptr i32, i32* %w30, i32 %i31, !dbg !164
  %ACC33 = load i32, i32* %ACCESS32, align 4, !dbg !164
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i32 %ACC33), !dbg !164
  %i34 = load i32, i32* %i, align 4, !dbg !164
  %ADD = add i32 %i34, 1, !dbg !164
  store i32 %ADD, i32* %i, align 4, !dbg !164
  br label %while.start, !dbg !164

while.end:                                        ; preds = %while.start
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.3, i32 0, i32 0), i32 0), !dbg !164
  ret i32 0, !dbg !164
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/arrays")
...
!162 = !DILocation(line: 6, scope: !160)
!163 = !DILocation(line: 9, scope: !160)
!164 = !DILocation(line: 14, scope: !160)
