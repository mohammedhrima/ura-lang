; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/arrays/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/arrays/003.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt, i32 0, i32 0), i32 %ACC, i32 %ACC8, i32 %ACC11, i32 %ACC14, i32 %ACC17), !dbg !162
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 %ACC23), !dbg !163
...
while.then:                                       ; preds = %while.start
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 %ACC33), !dbg !164
...
while.end:                                        ; preds = %while.start
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @output_fmt.3, i32 0, i32 0)), !dbg !164
  ret i32 0, !dbg !164
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/arrays")
