; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/globals/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/globals/002.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt, i32 0, i32 0), i32 %floor), !dbg !7
  %lives = load i32, i32* @lives, align 4, !dbg !7
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt.1, i32 0, i32 0), i32 %lives), !dbg !7
  %max_floor = load i32, i32* @max_floor, align 4, !dbg !7
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt.2, i32 0, i32 0), i32 %max_floor), !dbg !7
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @output_fmt.3, i32 0, i32 0), i8* %bool_str), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/globals")
