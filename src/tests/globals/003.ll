; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/globals/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/globals/003.ura"
...
@STR1 = private unnamed_addr constant [6 x i8] c"kills\00", align 1
...
@STR4 = private unnamed_addr constant [6 x i8] c"kills\00", align 1
...
define %struct.KillCounter @KillCounter.new() !dbg !160 {
entry:
  %k = alloca %struct.KillCounter, align 8, !dbg !161
  store %struct.KillCounter zeroinitializer, %struct.KillCounter* %k, align 8, !dbg !161
  %value = getelementptr %struct.KillCounter, %struct.KillCounter* %k, i32 0, i32 0, !dbg !161
  store i32 0, i32* %value, align 4, !dbg !161
  %label = getelementptr %struct.KillCounter, %struct.KillCounter* %k, i32 0, i32 1, !dbg !161
  %strdup = call i8* @strdup(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR1, i32 0, i32 0)), !dbg !162
  store i8* %strdup, i8** %label, align 8, !dbg !162
  %k1 = load %struct.KillCounter, %struct.KillCounter* %k, align 8, !dbg !162
  ret %struct.KillCounter %k1, !dbg !162
}

define void @KillCounter.tick(%struct.KillCounter* %self) !dbg !163 {
entry:
  %self1 = alloca %struct.KillCounter*, align 8, !dbg !164
  store %struct.KillCounter* %self, %struct.KillCounter** %self1, align 8, !dbg !164
  %self2 = load %struct.KillCounter*, %struct.KillCounter** %self1, align 8, !dbg !164
  %value = getelementptr %struct.KillCounter, %struct.KillCounter* %self2, i32 0, i32 0, !dbg !164
  %DOT = load i32, i32* %value, align 4, !dbg !164
  %ADD = add i32 %DOT, 1, !dbg !164
  store i32 %ADD, i32* %value, align 4, !dbg !164
  ret void, !dbg !164
}

define void @KillCounter.print(%struct.KillCounter* %self) !dbg !165 {
entry:
  %self1 = alloca %struct.KillCounter*, align 8, !dbg !166
  store %struct.KillCounter* %self, %struct.KillCounter** %self1, align 8, !dbg !166
  %self2 = load %struct.KillCounter*, %struct.KillCounter** %self1, align 8, !dbg !166
  %label = getelementptr %struct.KillCounter, %struct.KillCounter* %self2, i32 0, i32 1, !dbg !166
  %DOT = load i8*, i8** %label, align 8, !dbg !166
  %self3 = load %struct.KillCounter*, %struct.KillCounter** %self1, align 8, !dbg !166
  %value = getelementptr %struct.KillCounter, %struct.KillCounter* %self3, i32 0, i32 0, !dbg !166
  %DOT4 = load i32, i32* %value, align 4, !dbg !166
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT, i32 %DOT4), !dbg !166
  ret void, !dbg !166
}

define void @KillCounter.delete(%struct.KillCounter* %self) !dbg !167 {
entry:
  %self1 = alloca %struct.KillCounter*, align 8, !dbg !168
  store %struct.KillCounter* %self, %struct.KillCounter** %self1, align 8, !dbg !168
  %self2 = load %struct.KillCounter*, %struct.KillCounter** %self1, align 8, !dbg !169
  %label = getelementptr %struct.KillCounter, %struct.KillCounter* %self2, i32 0, i32 1, !dbg !169
  %DOT = load i8*, i8** %label, align 8, !dbg !169
  call void @free(i8* %DOT), !dbg !169
  %self3 = load %struct.KillCounter*, %struct.KillCounter** %self1, align 8, !dbg !169
  ret void, !dbg !169
}
...
entry:
  %strdup = call i8* @strdup(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR4, i32 0, i32 0)), !dbg !171
  store i8* %strdup, i8** getelementptr inbounds (%struct.KillCounter, %struct.KillCounter* @counter, i32 0, i32 1), align 8, !dbg !171
  call void @KillCounter.tick(%struct.KillCounter* @counter), !dbg !172
  call void @KillCounter.tick(%struct.KillCounter* @counter), !dbg !173
  call void @KillCounter.tick(%struct.KillCounter* @counter), !dbg !174
  call void @KillCounter.print(%struct.KillCounter* @counter), !dbg !175
  call void @KillCounter.delete(%struct.KillCounter* @counter), !dbg !175
  ret i32 0, !dbg !175
}
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/globals")
...
!160 = distinct !DISubprogram(name: "KillCounter.new", linkageName: "KillCounter.new", scope: null, file: !3, line: 9, type: !5, scopeLine: 9, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 9, scope: !160)
!162 = !DILocation(line: 12, scope: !160)
!163 = distinct !DISubprogram(name: "KillCounter.tick", linkageName: "KillCounter.tick", scope: null, file: !3, line: 15, type: !5, scopeLine: 15, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!164 = !DILocation(line: 15, scope: !163)
!165 = distinct !DISubprogram(name: "KillCounter.print", linkageName: "KillCounter.print", scope: null, file: !3, line: 18, type: !5, scopeLine: 18, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!166 = !DILocation(line: 18, scope: !165)
!167 = distinct !DISubprogram(name: "KillCounter.delete", linkageName: "KillCounter.delete", scope: null, file: !3, type: !5, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!168 = !DILocation(line: 0, scope: !167)
!169 = !DILocation(line: 22, scope: !167)
!170 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 26, type: !5, scopeLine: 26, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!171 = !DILocation(line: 27, scope: !170)
!172 = !DILocation(line: 28, scope: !170)
!173 = !DILocation(line: 29, scope: !170)
!174 = !DILocation(line: 30, scope: !170)
!175 = !DILocation(line: 31, scope: !170)
