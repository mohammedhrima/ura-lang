; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net/client.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net/client.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [35 x i8] c"\1B[0;31m[client] socket failed\1B[0m\0A\00", align 1
@STR2 = private unnamed_addr constant [36 x i8] c"\1B[0;31m[client] connect failed\1B[0m\0A\00", align 1
@STR3 = private unnamed_addr constant [54 x i8] c"\1B[0;36m[client]\1B[0m connected to server on port 8080\0A\00", align 1
@STR4 = private unnamed_addr constant [41 x i8] c"\1B[0;31m[client]\1B[0m server disconnected\0A\00", align 1
@STR5 = private unnamed_addr constant [6 x i8] c"\0D\1B[2K\00", align 1
@STR6 = private unnamed_addr constant [21 x i8] c"\1B[0;33m[server]\1B[0m \00", align 1
...
@STR9 = private unnamed_addr constant [23 x i8] c"\1B[0;36m[client]\1B[0m > \00", align 1
...
entry:
  ...
  store i32 0, i32* %fd, align 4, !dbg !164
  %socket = call i32 @socket(i32 2, i32 1, i32 0), !dbg !165
  store i32 %socket, i32* %fd, align 4, !dbg !165
  br label %if.start, !dbg !165

if.start:                                         ; preds = %entry
  %fd1 = load i32, i32* %fd, align 4, !dbg !165
  %LT = icmp slt i32 %fd1, 0, !dbg !165
  br i1 %LT, label %if.then, label %if.end, !dbg !165

if.end:                                           ; preds = %if.start
  store i8* null, i8** %addr, align 8, !dbg !164
  %calloc = call i8* @calloc(i64 16, i64 1), !dbg !166
  store i8* %calloc, i8** %addr, align 8, !dbg !166
  %addr2 = load i8*, i8** %addr, align 8, !dbg !167
  %ACCESS = getelementptr i8, i8* %addr2, i32 0, !dbg !167
  store i8 16, i8* %ACCESS, align 1, !dbg !167
  %addr3 = load i8*, i8** %addr, align 8, !dbg !168
  %ACCESS4 = getelementptr i8, i8* %addr3, i32 1, !dbg !168
  store i8 2, i8* %ACCESS4, align 1, !dbg !168
  %addr5 = load i8*, i8** %addr, align 8, !dbg !169
  %ACCESS6 = getelementptr i8, i8* %addr5, i32 2, !dbg !169
  store i8 31, i8* %ACCESS6, align 1, !dbg !169
  %addr7 = load i8*, i8** %addr, align 8, !dbg !170
  %ACCESS8 = getelementptr i8, i8* %addr7, i32 3, !dbg !170
  store i8 -112, i8* %ACCESS8, align 1, !dbg !170
  %addr9 = load i8*, i8** %addr, align 8, !dbg !171
  %ACCESS10 = getelementptr i8, i8* %addr9, i32 4, !dbg !171
  store i8 127, i8* %ACCESS10, align 1, !dbg !171
  %addr11 = load i8*, i8** %addr, align 8, !dbg !172
  %ACCESS12 = getelementptr i8, i8* %addr11, i32 5, !dbg !172
  store i8 0, i8* %ACCESS12, align 1, !dbg !172
  %addr13 = load i8*, i8** %addr, align 8, !dbg !173
  %ACCESS14 = getelementptr i8, i8* %addr13, i32 6, !dbg !173
  store i8 0, i8* %ACCESS14, align 1, !dbg !173
  %addr15 = load i8*, i8** %addr, align 8, !dbg !174
  %ACCESS16 = getelementptr i8, i8* %addr15, i32 7, !dbg !174
  store i8 1, i8* %ACCESS16, align 1, !dbg !174
  store i32 0, i32* %result, align 4, !dbg !164
  %fd17 = load i32, i32* %fd, align 4, !dbg !175
  %addr18 = load i8*, i8** %addr, align 8, !dbg !175
  %connect = call i32 @connect(i32 %fd17, i8* %addr18, i32 16), !dbg !175
  store i32 %connect, i32* %result, align 4, !dbg !175
  br label %if.start19, !dbg !175

if.then:                                          ; preds = %if.start
  call void @log(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @STR1, i32 0, i32 0)), !dbg !176
  ret i32 1, !dbg !176

if.start19:                                       ; preds = %if.end
  %result22 = load i32, i32* %result, align 4, !dbg !175
  %LT23 = icmp slt i32 %result22, 0, !dbg !175
  br i1 %LT23, label %if.then21, label %if.end20, !dbg !175

if.end20:                                         ; preds = %if.start19
  call void @log(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @STR3, i32 0, i32 0)), !dbg !177
  store i8* null, i8** %buf, align 8, !dbg !164
  %calloc24 = call i8* @calloc(i64 1024, i64 1), !dbg !178
  store i8* %calloc24, i8** %buf, align 8, !dbg !178
  store i8* null, i8** %rbuf, align 8, !dbg !164
  %calloc25 = call i8* @calloc(i64 1024, i64 1), !dbg !179
  store i8* %calloc25, i8** %rbuf, align 8, !dbg !179
  store i32 0, i32* %r, align 4, !dbg !164
  store i32 0, i32* %r, align 4, !dbg !164
  store i32 0, i32* %pid, align 4, !dbg !164
  %fork = call i32 @fork(), !dbg !180
  store i32 %fork, i32* %pid, align 4, !dbg !180
  br label %if.start26, !dbg !180

if.then21:                                        ; preds = %if.start19
  call void @log(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @STR2, i32 0, i32 0)), !dbg !181
  ret i32 1, !dbg !181

if.start26:                                       ; preds = %if.end20
  %pid29 = load i32, i32* %pid, align 4, !dbg !180
  %EQ = icmp eq i32 %pid29, 0, !dbg !180
  br i1 %EQ, label %if.then28, label %if.end27, !dbg !180

if.end27:                                         ; preds = %if.start26
  br label %while.start40, !dbg !182

if.then28:                                        ; preds = %if.start26
  br label %while.start, !dbg !180

while.start:                                      ; preds = %if.end33, %if.then28
  br i1 true, label %while.then, label %while.end, !dbg !180

while.then:                                       ; preds = %while.start
  %fd30 = load i32, i32* %fd, align 4, !dbg !183
  %rbuf31 = load i8*, i8** %rbuf, align 8, !dbg !183
  %read = call i32 @read(i32 %fd30, i8* %rbuf31, i32 1023), !dbg !183
  store i32 %read, i32* %r, align 4, !dbg !183
  br label %if.start32, !dbg !183

while.end:                                        ; preds = %if.then34, %while.start
  ret i32 0, !dbg !182

if.start32:                                       ; preds = %while.then
  %r35 = load i32, i32* %r, align 4, !dbg !183
  %LE = icmp sle i32 %r35, 0, !dbg !183
  br i1 %LE, label %if.then34, label %if.end33, !dbg !183

if.end33:                                         ; preds = %if.start32
  %rbuf36 = load i8*, i8** %rbuf, align 8, !dbg !184
  %r37 = load i32, i32* %r, align 4, !dbg !184
  %ACCESS38 = getelementptr i8, i8* %rbuf36, i32 %r37, !dbg !184
  store i8 0, i8* %ACCESS38, align 1, !dbg !184
  call void @log(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR5, i32 0, i32 0)), !dbg !185
  call void @log(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @STR6, i32 0, i32 0)), !dbg !186
  %rbuf39 = load i8*, i8** %rbuf, align 8, !dbg !187
  call void @log(i8* %rbuf39), !dbg !187
  call void @log(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @STR7, i32 0, i32 0)), !dbg !188
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR8, i32 0, i32 0)), !dbg !182
  br label %while.start, !dbg !182

if.then34:                                        ; preds = %if.start32
  call void @log(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @STR4, i32 0, i32 0)), !dbg !189
  br label %while.end, !dbg !189

while.start40:                                    ; preds = %if.end46, %if.end27
  br i1 true, label %while.then41, label %while.end42, !dbg !182

while.then41:                                     ; preds = %while.start40
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR9, i32 0, i32 0)), !dbg !190
  %buf43 = load i8*, i8** %buf, align 8, !dbg !191
  %read44 = call i32 @read(i32 0, i8* %buf43, i32 1023), !dbg !191
  store i32 %read44, i32* %r, align 4, !dbg !191
  br label %if.start45, !dbg !191

while.end42:                                      ; preds = %if.then47, %while.start40
  %fd57 = load i32, i32* %fd, align 4, !dbg !192
  %close = call i32 @close(i32 %fd57), !dbg !192
  %buf58 = load i8*, i8** %buf, align 8, !dbg !193
  call void @free(i8* %buf58), !dbg !193
  %rbuf59 = load i8*, i8** %rbuf, align 8, !dbg !194
  call void @free(i8* %rbuf59), !dbg !194
  %addr60 = load i8*, i8** %addr, align 8, !dbg !195
  call void @free(i8* %addr60), !dbg !195
  ret i32 0, !dbg !195

if.start45:                                       ; preds = %while.then41
  %r48 = load i32, i32* %r, align 4, !dbg !191
  %LE49 = icmp sle i32 %r48, 0, !dbg !191
  br i1 %LE49, label %if.then47, label %if.end46, !dbg !191

if.end46:                                         ; preds = %if.start45
  %r50 = load i32, i32* %r, align 4, !dbg !196
  %SUB = sub i32 %r50, 1, !dbg !196
  %buf51 = load i8*, i8** %buf, align 8, !dbg !196
  %ACCESS52 = getelementptr i8, i8* %buf51, i32 %SUB, !dbg !196
  store i8 0, i8* %ACCESS52, align 1, !dbg !196
  %fd53 = load i32, i32* %fd, align 4, !dbg !197
  %buf54 = load i8*, i8** %buf, align 8, !dbg !197
  %r55 = load i32, i32* %r, align 4, !dbg !197
  %SUB56 = sub i32 %r55, 1, !dbg !197
  %write = call i32 @write(i32 %fd53, i8* %buf54, i32 %SUB56), !dbg !197
  br label %while.start40, !dbg !197

if.then47:                                        ; preds = %if.start45
  br label %while.end42, !dbg !191
}
...
!3 = !DIFile(filename: "client.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net")
...
!171 = !DILocation(line: 18, scope: !163)
!172 = !DILocation(line: 19, scope: !163)
!173 = !DILocation(line: 20, scope: !163)
!174 = !DILocation(line: 21, scope: !163)
!175 = !DILocation(line: 23, scope: !163)
!176 = !DILocation(line: 10, scope: !163)
!177 = !DILocation(line: 28, scope: !163)
!178 = !DILocation(line: 30, scope: !163)
!179 = !DILocation(line: 31, scope: !163)
!180 = !DILocation(line: 34, scope: !163)
!181 = !DILocation(line: 25, scope: !163)
!182 = !DILocation(line: 46, scope: !163)
!183 = !DILocation(line: 37, scope: !163)
!184 = !DILocation(line: 41, scope: !163)
!185 = !DILocation(line: 42, scope: !163)
!186 = !DILocation(line: 43, scope: !163)
!187 = !DILocation(line: 44, scope: !163)
!188 = !DILocation(line: 45, scope: !163)
!189 = !DILocation(line: 39, scope: !163)
!190 = !DILocation(line: 50, scope: !163)
!191 = !DILocation(line: 51, scope: !163)
!192 = !DILocation(line: 57, scope: !163)
!193 = !DILocation(line: 58, scope: !163)
!194 = !DILocation(line: 59, scope: !163)
!195 = !DILocation(line: 60, scope: !163)
!196 = !DILocation(line: 54, scope: !163)
!197 = !DILocation(line: 55, scope: !163)
