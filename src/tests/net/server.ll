; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net/server.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net/server.ura"
target triple = "arm64-apple-macosx16.0.0"

%struct.String = type { i8*, i32, i32 }

@STR0 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR1 = private unnamed_addr constant [35 x i8] c"\1B[0;31m[server] socket failed\1B[0m\0A\00", align 1
@STR2 = private unnamed_addr constant [33 x i8] c"\1B[0;31m[server] bind failed\1B[0m\0A\00", align 1
@STR3 = private unnamed_addr constant [47 x i8] c"\1B[0;32m[server]\1B[0m listening on port 8080...\0A\00", align 1
@STR4 = private unnamed_addr constant [38 x i8] c"\1B[0;32m[server]\1B[0m client connected\0A\00", align 1
@STR5 = private unnamed_addr constant [41 x i8] c"\1B[0;31m[server]\1B[0m client disconnected\0A\00", align 1
@STR6 = private unnamed_addr constant [6 x i8] c"\0D\1B[2K\00", align 1
@STR7 = private unnamed_addr constant [21 x i8] c"\1B[0;36m[client]\1B[0m \00", align 1
...
define i32 @main() !dbg !163 {
entry:
  %server_fd = alloca i32, align 4, !dbg !164
  %opt = alloca i8*, align 8, !dbg !164
  %addr = alloca i8*, align 8, !dbg !164
  %result = alloca i32, align 4, !dbg !164
  %buf = alloca i8*, align 8, !dbg !164
  %rbuf = alloca i8*, align 8, !dbg !164
  %client_fd = alloca i32, align 4, !dbg !164
  %r = alloca i32, align 4, !dbg !164
  %pid = alloca i32, align 4, !dbg !164
  %pid2 = alloca i32, align 4, !dbg !164
  store i32 0, i32* %server_fd, align 4, !dbg !164
  %socket = call i32 @socket(i32 2, i32 1, i32 0), !dbg !165
  store i32 %socket, i32* %server_fd, align 4, !dbg !165
  br label %if.start, !dbg !165

if.start:                                         ; preds = %entry
  %server_fd1 = load i32, i32* %server_fd, align 4, !dbg !165
  %LT = icmp slt i32 %server_fd1, 0, !dbg !165
  br i1 %LT, label %if.then, label %if.end, !dbg !165

if.end:                                           ; preds = %if.start
  store i8* null, i8** %opt, align 8, !dbg !164
  %calloc = call i8* @calloc(i64 4, i64 1), !dbg !166
  store i8* %calloc, i8** %opt, align 8, !dbg !166
  %opt2 = load i8*, i8** %opt, align 8, !dbg !167
  %ACCESS = getelementptr i8, i8* %opt2, i32 0, !dbg !167
  store i8 1, i8* %ACCESS, align 1, !dbg !167
  %server_fd3 = load i32, i32* %server_fd, align 4, !dbg !168
  %opt4 = load i8*, i8** %opt, align 8, !dbg !168
  %setsockopt = call i32 @setsockopt(i32 %server_fd3, i32 65535, i32 4, i8* %opt4, i32 4), !dbg !168
  %server_fd5 = load i32, i32* %server_fd, align 4, !dbg !169
  %opt6 = load i8*, i8** %opt, align 8, !dbg !169
  %setsockopt7 = call i32 @setsockopt(i32 %server_fd5, i32 65535, i32 512, i8* %opt6, i32 4), !dbg !169
  %opt8 = load i8*, i8** %opt, align 8, !dbg !170
  call void @free(i8* %opt8), !dbg !170
  store i8* null, i8** %addr, align 8, !dbg !164
  %calloc9 = call i8* @calloc(i64 16, i64 1), !dbg !171
  store i8* %calloc9, i8** %addr, align 8, !dbg !171
  %addr10 = load i8*, i8** %addr, align 8, !dbg !172
  %ACCESS11 = getelementptr i8, i8* %addr10, i32 0, !dbg !172
  store i8 16, i8* %ACCESS11, align 1, !dbg !172
  %addr12 = load i8*, i8** %addr, align 8, !dbg !173
  %ACCESS13 = getelementptr i8, i8* %addr12, i32 1, !dbg !173
  store i8 2, i8* %ACCESS13, align 1, !dbg !173
  %addr14 = load i8*, i8** %addr, align 8, !dbg !174
  %ACCESS15 = getelementptr i8, i8* %addr14, i32 2, !dbg !174
  store i8 31, i8* %ACCESS15, align 1, !dbg !174
  %addr16 = load i8*, i8** %addr, align 8, !dbg !175
  %ACCESS17 = getelementptr i8, i8* %addr16, i32 3, !dbg !175
  store i8 -112, i8* %ACCESS17, align 1, !dbg !175
  store i32 0, i32* %result, align 4, !dbg !164
  %server_fd18 = load i32, i32* %server_fd, align 4, !dbg !176
  %addr19 = load i8*, i8** %addr, align 8, !dbg !176
  %bind = call i32 @bind(i32 %server_fd18, i8* %addr19, i32 16), !dbg !176
  store i32 %bind, i32* %result, align 4, !dbg !176
  br label %if.start20, !dbg !176

if.then:                                          ; preds = %if.start
  call void @log(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @STR1, i32 0, i32 0)), !dbg !177
  ret i32 1, !dbg !177

if.start20:                                       ; preds = %if.end
  %result23 = load i32, i32* %result, align 4, !dbg !176
  %LT24 = icmp slt i32 %result23, 0, !dbg !176
  br i1 %LT24, label %if.then22, label %if.end21, !dbg !176

if.end21:                                         ; preds = %if.start20
  %server_fd25 = load i32, i32* %server_fd, align 4, !dbg !178
  %listen = call i32 @listen(i32 %server_fd25, i32 5), !dbg !178
  call void @log(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @STR3, i32 0, i32 0)), !dbg !179
  store i8* null, i8** %buf, align 8, !dbg !164
  %calloc26 = call i8* @calloc(i64 1024, i64 1), !dbg !180
  store i8* %calloc26, i8** %buf, align 8, !dbg !180
  store i8* null, i8** %rbuf, align 8, !dbg !164
  %calloc27 = call i8* @calloc(i64 1024, i64 1), !dbg !181
  store i8* %calloc27, i8** %rbuf, align 8, !dbg !181
  store i32 0, i32* %client_fd, align 4, !dbg !164
  store i32 0, i32* %client_fd, align 4, !dbg !164
  store i32 0, i32* %r, align 4, !dbg !164
  store i32 0, i32* %r, align 4, !dbg !164
  br label %while.start, !dbg !164

if.then22:                                        ; preds = %if.start20
  call void @log(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @STR2, i32 0, i32 0)), !dbg !182
  ret i32 1, !dbg !182

while.start:                                      ; preds = %if.end35, %if.then31, %if.end21
  br i1 true, label %while.then, label %while.end, !dbg !164

while.then:                                       ; preds = %while.start
  %server_fd28 = load i32, i32* %server_fd, align 4, !dbg !183
  %accept = call i32 @accept(i32 %server_fd28, i8* null, i8* null), !dbg !183
  store i32 %accept, i32* %client_fd, align 4, !dbg !183
  br label %if.start29, !dbg !183

while.end:                                        ; preds = %while.start
  %buf79 = load i8*, i8** %buf, align 8, !dbg !184
  call void @free(i8* %buf79), !dbg !184
  %rbuf80 = load i8*, i8** %rbuf, align 8, !dbg !185
  call void @free(i8* %rbuf80), !dbg !185
  %addr81 = load i8*, i8** %addr, align 8, !dbg !186
  call void @free(i8* %addr81), !dbg !186
  ret i32 0, !dbg !186

if.start29:                                       ; preds = %while.then
  %client_fd32 = load i32, i32* %client_fd, align 4, !dbg !183
  %LT33 = icmp slt i32 %client_fd32, 0, !dbg !183
  br i1 %LT33, label %if.then31, label %if.end30, !dbg !183

if.end30:                                         ; preds = %if.start29
  call void @log(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @STR4, i32 0, i32 0)), !dbg !187
  store i32 0, i32* %pid, align 4, !dbg !164
  %fork = call i32 @fork(), !dbg !188
  store i32 %fork, i32* %pid, align 4, !dbg !188
  br label %if.start34, !dbg !188

if.then31:                                        ; preds = %if.start29
  br label %while.start, !dbg !183

if.start34:                                       ; preds = %if.end30
  %pid37 = load i32, i32* %pid, align 4, !dbg !188
  %EQ = icmp eq i32 %pid37, 0, !dbg !188
  br i1 %EQ, label %if.then36, label %if.end35, !dbg !188

if.end35:                                         ; preds = %if.start34
  %client_fd77 = load i32, i32* %client_fd, align 4, !dbg !189
  %close78 = call i32 @close(i32 %client_fd77), !dbg !189
  br label %while.start, !dbg !189

if.then36:                                        ; preds = %if.start34
  %server_fd38 = load i32, i32* %server_fd, align 4, !dbg !190
  %close = call i32 @close(i32 %server_fd38), !dbg !190
  store i32 0, i32* %pid2, align 4, !dbg !164
  %fork39 = call i32 @fork(), !dbg !191
  store i32 %fork39, i32* %pid2, align 4, !dbg !191
  br label %if.start40, !dbg !191

if.start40:                                       ; preds = %if.then36
  %pid243 = load i32, i32* %pid2, align 4, !dbg !191
  %EQ44 = icmp eq i32 %pid243, 0, !dbg !191
  br i1 %EQ44, label %if.then42, label %if.end41, !dbg !191

if.end41:                                         ; preds = %if.start40
  br label %while.start58, !dbg !192

if.then42:                                        ; preds = %if.start40
  br label %while.start45, !dbg !191

while.start45:                                    ; preds = %if.end51, %if.then42
  br i1 true, label %while.then46, label %while.end47, !dbg !191

while.then46:                                     ; preds = %while.start45
  %client_fd48 = load i32, i32* %client_fd, align 4, !dbg !193
  %buf49 = load i8*, i8** %buf, align 8, !dbg !193
  %read = call i32 @read(i32 %client_fd48, i8* %buf49, i32 1023), !dbg !193
  store i32 %read, i32* %r, align 4, !dbg !193
  br label %if.start50, !dbg !193

while.end47:                                      ; preds = %if.then52, %while.start45
  ret i32 0, !dbg !192

if.start50:                                       ; preds = %while.then46
  %r53 = load i32, i32* %r, align 4, !dbg !193
  %LE = icmp sle i32 %r53, 0, !dbg !193
  br i1 %LE, label %if.then52, label %if.end51, !dbg !193

if.end51:                                         ; preds = %if.start50
  %buf54 = load i8*, i8** %buf, align 8, !dbg !194
  %r55 = load i32, i32* %r, align 4, !dbg !194
  %ACCESS56 = getelementptr i8, i8* %buf54, i32 %r55, !dbg !194
  store i8 0, i8* %ACCESS56, align 1, !dbg !194
  call void @log(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR6, i32 0, i32 0)), !dbg !195
  call void @log(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @STR7, i32 0, i32 0)), !dbg !196
  %buf57 = load i8*, i8** %buf, align 8, !dbg !197
  call void @log(i8* %buf57), !dbg !197
  call void @log(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @STR8, i32 0, i32 0)), !dbg !198
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR9, i32 0, i32 0)), !dbg !192
  br label %while.start45, !dbg !192

if.then52:                                        ; preds = %if.start50
  call void @log(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @STR5, i32 0, i32 0)), !dbg !199
  br label %while.end47, !dbg !199

while.start58:                                    ; preds = %if.end64, %if.end41
  br i1 true, label %while.then59, label %while.end60, !dbg !192

while.then59:                                     ; preds = %while.start58
  call void @log(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @STR10, i32 0, i32 0)), !dbg !200
  %rbuf61 = load i8*, i8** %rbuf, align 8, !dbg !201
  %read62 = call i32 @read(i32 0, i8* %rbuf61, i32 1023), !dbg !201
  store i32 %read62, i32* %r, align 4, !dbg !201
  br label %if.start63, !dbg !201

while.end60:                                      ; preds = %if.then65, %while.start58
  %client_fd75 = load i32, i32* %client_fd, align 4, !dbg !202
  %close76 = call i32 @close(i32 %client_fd75), !dbg !202
  ret i32 0, !dbg !202

if.start63:                                       ; preds = %while.then59
  %r66 = load i32, i32* %r, align 4, !dbg !201
  %LE67 = icmp sle i32 %r66, 0, !dbg !201
  br i1 %LE67, label %if.then65, label %if.end64, !dbg !201

if.end64:                                         ; preds = %if.start63
  %r68 = load i32, i32* %r, align 4, !dbg !203
  %SUB = sub i32 %r68, 1, !dbg !203
  %rbuf69 = load i8*, i8** %rbuf, align 8, !dbg !203
  %ACCESS70 = getelementptr i8, i8* %rbuf69, i32 %SUB, !dbg !203
  store i8 0, i8* %ACCESS70, align 1, !dbg !203
  %client_fd71 = load i32, i32* %client_fd, align 4, !dbg !204
  %rbuf72 = load i8*, i8** %rbuf, align 8, !dbg !204
  %r73 = load i32, i32* %r, align 4, !dbg !204
  %SUB74 = sub i32 %r73, 1, !dbg !204
  %write = call i32 @write(i32 %client_fd71, i8* %rbuf72, i32 %SUB74), !dbg !204
  br label %while.start58, !dbg !204

if.then65:                                        ; preds = %if.start63
  br label %while.end60, !dbg !201
}
...
!3 = !DIFile(filename: "server.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/net")
...
!160 = distinct !DISubprogram(name: "log", linkageName: "log", scope: null, file: !3, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 4, scope: !160)
!162 = !DILocation(line: 5, scope: !160)
!163 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 7, type: !5, scopeLine: 7, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!164 = !DILocation(line: 7, scope: !163)
!165 = !DILocation(line: 8, scope: !163)
!166 = !DILocation(line: 13, scope: !163)
!167 = !DILocation(line: 14, scope: !163)
!168 = !DILocation(line: 15, scope: !163)
!169 = !DILocation(line: 16, scope: !163)
!170 = !DILocation(line: 17, scope: !163)
!171 = !DILocation(line: 19, scope: !163)
!172 = !DILocation(line: 20, scope: !163)
!173 = !DILocation(line: 21, scope: !163)
!174 = !DILocation(line: 22, scope: !163)
!175 = !DILocation(line: 23, scope: !163)
!176 = !DILocation(line: 25, scope: !163)
!177 = !DILocation(line: 10, scope: !163)
!178 = !DILocation(line: 30, scope: !163)
!179 = !DILocation(line: 31, scope: !163)
!180 = !DILocation(line: 33, scope: !163)
!181 = !DILocation(line: 34, scope: !163)
!182 = !DILocation(line: 27, scope: !163)
!183 = !DILocation(line: 39, scope: !163)
!184 = !DILocation(line: 80, scope: !163)
!185 = !DILocation(line: 81, scope: !163)
!186 = !DILocation(line: 82, scope: !163)
!187 = !DILocation(line: 43, scope: !163)
!188 = !DILocation(line: 45, scope: !163)
!189 = !DILocation(line: 78, scope: !163)
!190 = !DILocation(line: 47, scope: !163)
!191 = !DILocation(line: 50, scope: !163)
!192 = !DILocation(line: 62, scope: !163)
!193 = !DILocation(line: 53, scope: !163)
!194 = !DILocation(line: 57, scope: !163)
!195 = !DILocation(line: 58, scope: !163)
!196 = !DILocation(line: 59, scope: !163)
!197 = !DILocation(line: 60, scope: !163)
!198 = !DILocation(line: 61, scope: !163)
!199 = !DILocation(line: 55, scope: !163)
!200 = !DILocation(line: 67, scope: !163)
!201 = !DILocation(line: 68, scope: !163)
!202 = !DILocation(line: 74, scope: !163)
!203 = !DILocation(line: 71, scope: !163)
!204 = !DILocation(line: 72, scope: !163)
