; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/casting/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/casting/002.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @output_fmt, i32 0, i32 0), i32 %score4, i32 %max_score5), !dbg !7
  %pct6 = load float, float* %pct, align 4, !dbg !7
  %f2d = fpext float %pct6 to double, !dbg !7
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @output_fmt.1, i32 0, i32 0), double %f2d), !dbg !7
  ret i32 0, !dbg !7
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/casting")
