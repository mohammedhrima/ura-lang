; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/casting/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/casting/001.ura"
...
entry:
  ...
  %0 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @output_fmt, i32 0, i32 0), i32 %code2, i8 %grade3), !dbg !7
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.1, i32 0, i32 0), i32 %n6), !dbg !7
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @output_fmt.2, i32 0, i32 0), i32 %diff13), !dbg !8
  ret i32 0, !dbg !8
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/casting")
