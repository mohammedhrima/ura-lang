; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/002.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT, i32 %String.len), !dbg !163
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i8* %DOT2), !dbg !163
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.2, i32 0, i32 0), i32 %String.len3, i8* %bool_str), !dbg !164
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.3, i32 0, i32 0), i8* %DOT7, i32 %String.len8), !dbg !169
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.4, i32 0, i32 0), i8 %c9, i8* %DOT11, i32 %String.len12), !dbg !171
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.5, i32 0, i32 0), i32 %as, i32 %String.len17), !dbg !175
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i8* %DOT21), !dbg !177
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.9, i32 0, i32 0), i32 %String.len22, i8* %bool_str24), !dbg !179
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string")
