; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/002.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/002.ura"
...
@STR4 = private unnamed_addr constant [36 x i8] c"hello world this is a longer string\00", align 1
...
@output_fmt.2 = private unnamed_addr constant [7 x i8] c"%d %s\0A\00", align 1
@STR9 = private unnamed_addr constant [2 x i8] c" \00", align 1
@STR10 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.3 = private unnamed_addr constant [7 x i8] c"%s %d\0A\00", align 1
...
@output_fmt.4 = private unnamed_addr constant [10 x i8] c"%c %s %d\0A\00", align 1
@STR14 = private unnamed_addr constant [2 x i8] c" \00", align 1
@STR15 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.5 = private unnamed_addr constant [7 x i8] c"%d %d\0A\00", align 1
@STR16 = private unnamed_addr constant [6 x i8] c"hello\00", align 1
@STR17 = private unnamed_addr constant [7 x i8] c" world\00", align 1
...
@output_fmt.9 = private unnamed_addr constant [7 x i8] c"%d %s\0A\00", align 1
...
entry:
  ...
  %c = alloca i8, align 1, !dbg !161
  %c2 = alloca i8, align 1, !dbg !161
  ...
  call void @String.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR1, i32 0, i32 0), %struct.String* %s), !dbg !162
  %value = getelementptr %struct.String, %struct.String* %s, i32 0, i32 0, !dbg !162
  %DOT = load i8*, i8** %value, align 8, !dbg !162
  %String.len = call i32 @String.len(%struct.String* %s), !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt, i32 0, i32 0), i32 2, i8* %DOT, i32 %String.len), !dbg !163
  call void @String.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @STR4, i32 0, i32 0), %struct.String* %s), !dbg !163
  %value1 = getelementptr %struct.String, %struct.String* %s, i32 0, i32 0, !dbg !163
  %DOT2 = load i8*, i8** %value1, align 8, !dbg !163
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %DOT2), !dbg !163
  call void @String.operator.ASSIGN.CHARS(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @STR6, i32 0, i32 0), %struct.String* %s), !dbg !163
  %String.len3 = call i32 @String.len(%struct.String* %s), !dbg !164
  %String.empty = call i1 @String.empty(%struct.String* %s), !dbg !164
  %bool_str = select i1 %String.empty, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str, i32 0, i32 0), !dbg !164
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.2, i32 0, i32 0), i32 2, i32 %String.len3, i8* %bool_str), !dbg !164
  store %struct.String zeroinitializer, %struct.String* %s2, align 8, !dbg !161
  %4 = call %struct.String @String.new(), !dbg !165
  %tmp_struct4 = alloca %struct.String, align 8, !dbg !165
  store %struct.String %4, %struct.String* %tmp_struct4, align 8, !dbg !165
  %tmp_op5 = alloca %struct.String, align 8, !dbg !165
  store %struct.String %4, %struct.String* %tmp_op5, align 8, !dbg !165
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op5, %struct.String* %s2), !dbg !165
  call void @String.push(i8 88, %struct.String* %s2), !dbg !166
  call void @String.push(i8 89, %struct.String* %s2), !dbg !167
  call void @String.push(i8 90, %struct.String* %s2), !dbg !168
  %value6 = getelementptr %struct.String, %struct.String* %s2, i32 0, i32 0, !dbg !168
  %DOT7 = load i8*, i8** %value6, align 8, !dbg !168
  %String.len8 = call i32 @String.len(%struct.String* %s2), !dbg !169
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.3, i32 0, i32 0), i32 2, i8* %DOT7, i32 %String.len8), !dbg !169
  store i8 0, i8* %c, align 1, !dbg !161
  %String.pop = call i8 @String.pop(%struct.String* %s2), !dbg !170
  store i8 %String.pop, i8* %c, align 1, !dbg !170
  %c9 = load i8, i8* %c, align 1, !dbg !170
  %value10 = getelementptr %struct.String, %struct.String* %s2, i32 0, i32 0, !dbg !170
  %DOT11 = load i8*, i8** %value10, align 8, !dbg !170
  %String.len12 = call i32 @String.len(%struct.String* %s2), !dbg !171
  %6 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.4, i32 0, i32 0), i32 3, i8 %c9, i8* %DOT11, i32 %String.len12), !dbg !171
  %String.pop13 = call i8 @String.pop(%struct.String* %s2), !dbg !172
  %String.pop14 = call i8 @String.pop(%struct.String* %s2), !dbg !173
  store i8 0, i8* %c2, align 1, !dbg !161
  %String.pop15 = call i8 @String.pop(%struct.String* %s2), !dbg !174
  store i8 %String.pop15, i8* %c2, align 1, !dbg !174
  %c216 = load i8, i8* %c2, align 1, !dbg !174
  %as = sext i8 %c216 to i32, !dbg !174
  %String.len17 = call i32 @String.len(%struct.String* %s2), !dbg !175
  %7 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.5, i32 0, i32 0), i32 2, i32 %as, i32 %String.len17), !dbg !175
  store %struct.String zeroinitializer, %struct.String* %s3, align 8, !dbg !161
  %8 = call %struct.String @String.from(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR16, i32 0, i32 0)), !dbg !176
  %tmp_struct18 = alloca %struct.String, align 8, !dbg !176
  store %struct.String %8, %struct.String* %tmp_struct18, align 8, !dbg !176
  %tmp_op19 = alloca %struct.String, align 8, !dbg !176
  store %struct.String %8, %struct.String* %tmp_op19, align 8, !dbg !176
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op19, %struct.String* %s3), !dbg !176
  call void @String.join(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @STR17, i32 0, i32 0), %struct.String* %s3), !dbg !177
  %value20 = getelementptr %struct.String, %struct.String* %s3, i32 0, i32 0, !dbg !177
  %DOT21 = load i8*, i8** %value20, align 8, !dbg !177
  %9 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i32 1, i8* %DOT21), !dbg !177
  call void @String.clear(%struct.String* %s3), !dbg !178
  %String.len22 = call i32 @String.len(%struct.String* %s3), !dbg !179
  %String.empty23 = call i1 @String.empty(%struct.String* %s3), !dbg !179
  %bool_str24 = select i1 %String.empty23, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.7, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.8, i32 0, i32 0), !dbg !179
  %10 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.9, i32 0, i32 0), i32 2, i32 %String.len22, i8* %bool_str24), !dbg !179
  call void @String.delete(%struct.String* %s), !dbg !179
  call void @String.delete(%struct.String* %s2), !dbg !179
  call void @String.delete(%struct.String* %s3), !dbg !179
  call void @String.delete(%struct.String* %tmp_struct), !dbg !179
  call void @String.delete(%struct.String* %tmp_struct4), !dbg !179
  call void @String.delete(%struct.String* %tmp_struct18), !dbg !179
  ret i32 0, !dbg !179
}
...
!3 = !DIFile(filename: "002.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string")
...
!164 = !DILocation(line: 13, scope: !160)
!165 = !DILocation(line: 15, scope: !160)
!166 = !DILocation(line: 16, scope: !160)
!167 = !DILocation(line: 17, scope: !160)
!168 = !DILocation(line: 18, scope: !160)
!169 = !DILocation(line: 19, scope: !160)
!170 = !DILocation(line: 21, scope: !160)
!171 = !DILocation(line: 22, scope: !160)
!172 = !DILocation(line: 24, scope: !160)
!173 = !DILocation(line: 25, scope: !160)
!174 = !DILocation(line: 26, scope: !160)
!175 = !DILocation(line: 27, scope: !160)
!176 = !DILocation(line: 29, scope: !160)
!177 = !DILocation(line: 30, scope: !160)
!178 = !DILocation(line: 33, scope: !160)
!179 = !DILocation(line: 34, scope: !160)
