; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/001.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/001.ura"
...
@output_fmt = private unnamed_addr constant [7 x i8] c"%d %s\0A\00", align 1
...
@output_fmt.3 = private unnamed_addr constant [10 x i8] c"%s %d %s\0A\00", align 1
...
@output_fmt.6 = private unnamed_addr constant [7 x i8] c"%d %s\0A\00", align 1
...
@output_fmt.10 = private unnamed_addr constant [13 x i8] c"%c %c %c %c\0A\00", align 1
...
entry:
  ...
  %s4 = alloca %struct.String, align 8, !dbg !161
  %s5 = alloca %struct.String, align 8, !dbg !161
  %s6 = alloca %struct.String, align 8, !dbg !161
  store %struct.String zeroinitializer, %struct.String* %s1, align 8, !dbg !161
  %0 = call %struct.String @String.new(), !dbg !162
  ...
  %String.len = call i32 @String.len(%struct.String* %s1), !dbg !163
  %String.empty = call i1 @String.empty(%struct.String* %s1), !dbg !163
  %bool_str = select i1 %String.empty, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str, i32 0, i32 0), !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt, i32 0, i32 0), i32 2, i32 %String.len, i8* %bool_str), !dbg !163
  store %struct.String zeroinitializer, %struct.String* %s2, align 8, !dbg !161
  %2 = call %struct.String @String.from(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR3, i32 0, i32 0)), !dbg !164
  ...
  %value = getelementptr %struct.String, %struct.String* %s2, i32 0, i32 0, !dbg !164
  %DOT = load i8*, i8** %value, align 8, !dbg !164
  %String.len3 = call i32 @String.len(%struct.String* %s2), !dbg !165
  %String.empty4 = call i1 @String.empty(%struct.String* %s2), !dbg !165
  %bool_str5 = select i1 %String.empty4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.1, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.2, i32 0, i32 0), !dbg !165
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @output_fmt.3, i32 0, i32 0), i32 3, i8* %DOT, i32 %String.len3, i8* %bool_str5), !dbg !165
  store %struct.String zeroinitializer, %struct.String* %s3, align 8, !dbg !161
  %4 = call %struct.String @String.from(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @STR7, i32 0, i32 0)), !dbg !166
  %tmp_struct6 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %4, %struct.String* %tmp_struct6, align 8, !dbg !166
  %tmp_op7 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %4, %struct.String* %tmp_op7, align 8, !dbg !166
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op7, %struct.String* %s3), !dbg !166
  %String.len8 = call i32 @String.len(%struct.String* %s3), !dbg !167
  %String.empty9 = call i1 @String.empty(%struct.String* %s3), !dbg !167
  %bool_str10 = select i1 %String.empty9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @true_str.4, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @false_str.5, i32 0, i32 0), !dbg !167
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @output_fmt.6, i32 0, i32 0), i32 2, i32 %String.len8, i8* %bool_str10), !dbg !167
  store %struct.String zeroinitializer, %struct.String* %s4, align 8, !dbg !161
  %6 = call %struct.String @String.from_int(i32 42), !dbg !168
  %tmp_struct11 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %6, %struct.String* %tmp_struct11, align 8, !dbg !168
  %tmp_op12 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %6, %struct.String* %tmp_op12, align 8, !dbg !168
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op12, %struct.String* %s4), !dbg !168
  %value13 = getelementptr %struct.String, %struct.String* %s4, i32 0, i32 0, !dbg !168
  %DOT14 = load i8*, i8** %value13, align 8, !dbg !168
  %7 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.7, i32 0, i32 0), i32 1, i8* %DOT14), !dbg !168
  store %struct.String zeroinitializer, %struct.String* %s5, align 8, !dbg !161
  %8 = call %struct.String @String.from_int(i32 -123), !dbg !169
  %tmp_struct15 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %8, %struct.String* %tmp_struct15, align 8, !dbg !169
  %tmp_op16 = alloca %struct.String, align 8, !dbg !169
  store %struct.String %8, %struct.String* %tmp_op16, align 8, !dbg !169
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op16, %struct.String* %s5), !dbg !169
  %value17 = getelementptr %struct.String, %struct.String* %s5, i32 0, i32 0, !dbg !169
  %DOT18 = load i8*, i8** %value17, align 8, !dbg !169
  %9 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i32 1, i8* %DOT18), !dbg !169
  store %struct.String zeroinitializer, %struct.String* %s6, align 8, !dbg !161
  %10 = call %struct.String @String.from_int(i32 0), !dbg !170
  %tmp_struct19 = alloca %struct.String, align 8, !dbg !170
  store %struct.String %10, %struct.String* %tmp_struct19, align 8, !dbg !170
  %tmp_op20 = alloca %struct.String, align 8, !dbg !170
  store %struct.String %10, %struct.String* %tmp_op20, align 8, !dbg !170
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op20, %struct.String* %s6), !dbg !170
  %value21 = getelementptr %struct.String, %struct.String* %s6, i32 0, i32 0, !dbg !170
  %DOT22 = load i8*, i8** %value21, align 8, !dbg !170
  %11 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.9, i32 0, i32 0), i32 1, i8* %DOT22), !dbg !170
  %String.at = call i8 @String.at(i32 0, %struct.String* %s2), !dbg !171
  %String.at23 = call i8 @String.at(i32 4, %struct.String* %s2), !dbg !171
  %String.at24 = call i8 @String.at(i32 -1, %struct.String* %s2), !dbg !171
  %String.at25 = call i8 @String.at(i32 99, %struct.String* %s2), !dbg !171
  %12 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @output_fmt.10, i32 0, i32 0), i32 4, i8 %String.at, i8 %String.at23, i8 %String.at24, i8 %String.at25), !dbg !171
  %String.c_str = call i8* @String.c_str(%struct.String* %s2), !dbg !172
  %13 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.11, i32 0, i32 0), i32 1, i8* %String.c_str), !dbg !172
  call void @String.delete(%struct.String* %s1), !dbg !172
  call void @String.delete(%struct.String* %s2), !dbg !172
  call void @String.delete(%struct.String* %s3), !dbg !172
  call void @String.delete(%struct.String* %s4), !dbg !172
  call void @String.delete(%struct.String* %s5), !dbg !172
  call void @String.delete(%struct.String* %s6), !dbg !172
  call void @String.delete(%struct.String* %tmp_struct), !dbg !172
  call void @String.delete(%struct.String* %tmp_struct1), !dbg !172
  call void @String.delete(%struct.String* %tmp_struct6), !dbg !172
  call void @String.delete(%struct.String* %tmp_struct11), !dbg !172
  call void @String.delete(%struct.String* %tmp_struct15), !dbg !172
  call void @String.delete(%struct.String* %tmp_struct19), !dbg !172
  ret i32 0, !dbg !172
}
...
!3 = !DIFile(filename: "001.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string")
...
!169 = !DILocation(line: 17, scope: !160)
!170 = !DILocation(line: 20, scope: !160)
!171 = !DILocation(line: 23, scope: !160)
!172 = !DILocation(line: 24, scope: !160)
