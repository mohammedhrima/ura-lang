; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string/004.ura"
...
@output_fmt.2 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR5 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.3 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR6 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.4 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR7 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.5 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@STR8 = private unnamed_addr constant [12 x i8] c"   hello   \00", align 1
@STR9 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.6 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR10 = private unnamed_addr constant [6 x i8] c"hello\00", align 1
@STR11 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.7 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR12 = private unnamed_addr constant [4 x i8] c"   \00", align 1
@STR13 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.8 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@STR14 = private unnamed_addr constant [16 x i8] c"foo bar foo baz\00", align 1
@STR15 = private unnamed_addr constant [4 x i8] c"foo\00", align 1
@STR16 = private unnamed_addr constant [4 x i8] c"qux\00", align 1
@STR17 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.9 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR18 = private unnamed_addr constant [4 x i8] c"xyz\00", align 1
@STR19 = private unnamed_addr constant [4 x i8] c"qux\00", align 1
@STR20 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.10 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR21 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1
@STR22 = private unnamed_addr constant [4 x i8] c"qux\00", align 1
@STR23 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.11 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR24 = private unnamed_addr constant [3 x i8] c"ab\00", align 1
@STR25 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.12 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR26 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.13 = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@STR27 = private unnamed_addr constant [6 x i8] c"abcde\00", align 1
@STR28 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.14 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
@STR29 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@STR30 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@output_fmt.15 = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1
...
define i32 @main() !dbg !160 {
entry:
  %s = alloca %struct.String, align 8, !dbg !161
  %u = alloca %struct.String, align 8, !dbg !161
  %l = alloca %struct.String, align 8, !dbg !161
  %sub = alloca %struct.String, align 8, !dbg !161
  %sub2 = alloca %struct.String, align 8, !dbg !161
  %sub3 = alloca %struct.String, align 8, !dbg !161
  %sub4 = alloca %struct.String, align 8, !dbg !161
  %t1 = alloca %struct.String, align 8, !dbg !161
  %t2 = alloca %struct.String, align 8, !dbg !161
  %t3 = alloca %struct.String, align 8, !dbg !161
  %t4 = alloca %struct.String, align 8, !dbg !161
  %t5 = alloca %struct.String, align 8, !dbg !161
  %t6 = alloca %struct.String, align 8, !dbg !161
  %r1 = alloca %struct.String, align 8, !dbg !161
  %r2 = alloca %struct.String, align 8, !dbg !161
  %r3 = alloca %struct.String, align 8, !dbg !161
  %r4 = alloca %struct.String, align 8, !dbg !161
  %rep = alloca %struct.String, align 8, !dbg !161
  %rep2 = alloca %struct.String, align 8, !dbg !161
  %rep3 = alloca %struct.String, align 8, !dbg !161
  %rev = alloca %struct.String, align 8, !dbg !161
  %rev2 = alloca %struct.String, align 8, !dbg !161
  %rev3 = alloca %struct.String, align 8, !dbg !161
  %rev4 = alloca %struct.String, align 8, !dbg !161
  store %struct.String zeroinitializer, %struct.String* %s, align 8, !dbg !161
  %0 = call %struct.String @String.from(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @STR1, i32 0, i32 0)), !dbg !162
  %tmp_struct = alloca %struct.String, align 8, !dbg !162
  store %struct.String %0, %struct.String* %tmp_struct, align 8, !dbg !162
  %tmp_op = alloca %struct.String, align 8, !dbg !162
  store %struct.String %0, %struct.String* %tmp_op, align 8, !dbg !162
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op, %struct.String* %s), !dbg !162
  store %struct.String zeroinitializer, %struct.String* %u, align 8, !dbg !161
  %String.upper = call %struct.String @String.upper(%struct.String* %s), !dbg !163
  %tmp_struct1 = alloca %struct.String, align 8, !dbg !163
  store %struct.String %String.upper, %struct.String* %tmp_struct1, align 8, !dbg !163
  %tmp_op2 = alloca %struct.String, align 8, !dbg !163
  store %struct.String %String.upper, %struct.String* %tmp_op2, align 8, !dbg !163
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op2, %struct.String* %u), !dbg !163
  %value = getelementptr %struct.String, %struct.String* %u, i32 0, i32 0, !dbg !163
  %DOT = load i8*, i8** %value, align 8, !dbg !163
  %1 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 1, i8* %DOT), !dbg !163
  store %struct.String zeroinitializer, %struct.String* %l, align 8, !dbg !161
  %String.lower = call %struct.String @String.lower(%struct.String* %s), !dbg !164
  %tmp_struct3 = alloca %struct.String, align 8, !dbg !164
  store %struct.String %String.lower, %struct.String* %tmp_struct3, align 8, !dbg !164
  %tmp_op4 = alloca %struct.String, align 8, !dbg !164
  store %struct.String %String.lower, %struct.String* %tmp_op4, align 8, !dbg !164
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op4, %struct.String* %l), !dbg !164
  %value5 = getelementptr %struct.String, %struct.String* %l, i32 0, i32 0, !dbg !164
  %DOT6 = load i8*, i8** %value5, align 8, !dbg !164
  %2 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 1, i8* %DOT6), !dbg !164
  store %struct.String zeroinitializer, %struct.String* %sub, align 8, !dbg !161
  %String.substr = call %struct.String @String.substr(i32 6, i32 5, %struct.String* %s), !dbg !165
  %tmp_struct7 = alloca %struct.String, align 8, !dbg !165
  store %struct.String %String.substr, %struct.String* %tmp_struct7, align 8, !dbg !165
  %tmp_op8 = alloca %struct.String, align 8, !dbg !165
  store %struct.String %String.substr, %struct.String* %tmp_op8, align 8, !dbg !165
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op8, %struct.String* %sub), !dbg !165
  %value9 = getelementptr %struct.String, %struct.String* %sub, i32 0, i32 0, !dbg !165
  %DOT10 = load i8*, i8** %value9, align 8, !dbg !165
  %3 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 1, i8* %DOT10), !dbg !165
  store %struct.String zeroinitializer, %struct.String* %sub2, align 8, !dbg !161
  %String.substr11 = call %struct.String @String.substr(i32 0, i32 5, %struct.String* %s), !dbg !166
  %tmp_struct12 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %String.substr11, %struct.String* %tmp_struct12, align 8, !dbg !166
  %tmp_op13 = alloca %struct.String, align 8, !dbg !166
  store %struct.String %String.substr11, %struct.String* %tmp_op13, align 8, !dbg !166
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op13, %struct.String* %sub2), !dbg !166
  %value14 = getelementptr %struct.String, %struct.String* %sub2, i32 0, i32 0, !dbg !166
  %DOT15 = load i8*, i8** %value14, align 8, !dbg !166
  %4 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i32 1, i8* %DOT15), !dbg !166
  store %struct.String zeroinitializer, %struct.String* %sub3, align 8, !dbg !161
  %String.substr16 = call %struct.String @String.substr(i32 0, i32 100, %struct.String* %s), !dbg !167
  %tmp_struct17 = alloca %struct.String, align 8, !dbg !167
  store %struct.String %String.substr16, %struct.String* %tmp_struct17, align 8, !dbg !167
  %tmp_op18 = alloca %struct.String, align 8, !dbg !167
  store %struct.String %String.substr16, %struct.String* %tmp_op18, align 8, !dbg !167
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op18, %struct.String* %sub3), !dbg !167
  %value19 = getelementptr %struct.String, %struct.String* %sub3, i32 0, i32 0, !dbg !167
  %DOT20 = load i8*, i8** %value19, align 8, !dbg !167
  %5 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 1, i8* %DOT20), !dbg !167
  store %struct.String zeroinitializer, %struct.String* %sub4, align 8, !dbg !161
  %String.substr21 = call %struct.String @String.substr(i32 -1, i32 5, %struct.String* %s), !dbg !168
  %tmp_struct22 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %String.substr21, %struct.String* %tmp_struct22, align 8, !dbg !168
  %tmp_op23 = alloca %struct.String, align 8, !dbg !168
  store %struct.String %String.substr21, %struct.String* %tmp_op23, align 8, !dbg !168
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op23, %struct.String* %sub4), !dbg !168
  %String.len = call i32 @String.len(%struct.String* %sub4), !dbg !169
  %6 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.5, i32 0, i32 0), i32 1, i32 %String.len), !dbg !169
  store %struct.String zeroinitializer, %struct.String* %t1, align 8, !dbg !161
  %7 = call %struct.String @String.from(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @STR8, i32 0, i32 0)), !dbg !170
  %tmp_struct24 = alloca %struct.String, align 8, !dbg !170
  store %struct.String %7, %struct.String* %tmp_struct24, align 8, !dbg !170
  %tmp_op25 = alloca %struct.String, align 8, !dbg !170
  store %struct.String %7, %struct.String* %tmp_op25, align 8, !dbg !170
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op25, %struct.String* %t1), !dbg !170
  store %struct.String zeroinitializer, %struct.String* %t2, align 8, !dbg !161
  %String.trim = call %struct.String @String.trim(%struct.String* %t1), !dbg !171
  %tmp_struct26 = alloca %struct.String, align 8, !dbg !171
  store %struct.String %String.trim, %struct.String* %tmp_struct26, align 8, !dbg !171
  %tmp_op27 = alloca %struct.String, align 8, !dbg !171
  store %struct.String %String.trim, %struct.String* %tmp_op27, align 8, !dbg !171
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op27, %struct.String* %t2), !dbg !171
  %value28 = getelementptr %struct.String, %struct.String* %t2, i32 0, i32 0, !dbg !171
  %DOT29 = load i8*, i8** %value28, align 8, !dbg !171
  %8 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i32 1, i8* %DOT29), !dbg !171
  store %struct.String zeroinitializer, %struct.String* %t3, align 8, !dbg !161
  %9 = call %struct.String @String.from(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR10, i32 0, i32 0)), !dbg !172
  %tmp_struct30 = alloca %struct.String, align 8, !dbg !172
  store %struct.String %9, %struct.String* %tmp_struct30, align 8, !dbg !172
  %tmp_op31 = alloca %struct.String, align 8, !dbg !172
  store %struct.String %9, %struct.String* %tmp_op31, align 8, !dbg !172
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op31, %struct.String* %t3), !dbg !172
  store %struct.String zeroinitializer, %struct.String* %t4, align 8, !dbg !161
  %String.trim32 = call %struct.String @String.trim(%struct.String* %t3), !dbg !173
  %tmp_struct33 = alloca %struct.String, align 8, !dbg !173
  store %struct.String %String.trim32, %struct.String* %tmp_struct33, align 8, !dbg !173
  %tmp_op34 = alloca %struct.String, align 8, !dbg !173
  store %struct.String %String.trim32, %struct.String* %tmp_op34, align 8, !dbg !173
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op34, %struct.String* %t4), !dbg !173
  %value35 = getelementptr %struct.String, %struct.String* %t4, i32 0, i32 0, !dbg !173
  %DOT36 = load i8*, i8** %value35, align 8, !dbg !173
  %10 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.7, i32 0, i32 0), i32 1, i8* %DOT36), !dbg !173
  store %struct.String zeroinitializer, %struct.String* %t5, align 8, !dbg !161
  %11 = call %struct.String @String.from(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR12, i32 0, i32 0)), !dbg !174
  %tmp_struct37 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %11, %struct.String* %tmp_struct37, align 8, !dbg !174
  %tmp_op38 = alloca %struct.String, align 8, !dbg !174
  store %struct.String %11, %struct.String* %tmp_op38, align 8, !dbg !174
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op38, %struct.String* %t5), !dbg !174
  store %struct.String zeroinitializer, %struct.String* %t6, align 8, !dbg !161
  %String.trim39 = call %struct.String @String.trim(%struct.String* %t5), !dbg !175
  %tmp_struct40 = alloca %struct.String, align 8, !dbg !175
  store %struct.String %String.trim39, %struct.String* %tmp_struct40, align 8, !dbg !175
  %tmp_op41 = alloca %struct.String, align 8, !dbg !175
  store %struct.String %String.trim39, %struct.String* %tmp_op41, align 8, !dbg !175
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op41, %struct.String* %t6), !dbg !175
  %String.len42 = call i32 @String.len(%struct.String* %t6), !dbg !176
  %12 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i32 1, i32 %String.len42), !dbg !176
  store %struct.String zeroinitializer, %struct.String* %r1, align 8, !dbg !161
  %13 = call %struct.String @String.from(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @STR14, i32 0, i32 0)), !dbg !177
  %tmp_struct43 = alloca %struct.String, align 8, !dbg !177
  store %struct.String %13, %struct.String* %tmp_struct43, align 8, !dbg !177
  %tmp_op44 = alloca %struct.String, align 8, !dbg !177
  store %struct.String %13, %struct.String* %tmp_op44, align 8, !dbg !177
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op44, %struct.String* %r1), !dbg !177
  store %struct.String zeroinitializer, %struct.String* %r2, align 8, !dbg !161
  %String.replace = call %struct.String @String.replace(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR15, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR16, i32 0, i32 0), %struct.String* %r1), !dbg !178
  %tmp_struct45 = alloca %struct.String, align 8, !dbg !178
  store %struct.String %String.replace, %struct.String* %tmp_struct45, align 8, !dbg !178
  %tmp_op46 = alloca %struct.String, align 8, !dbg !178
  store %struct.String %String.replace, %struct.String* %tmp_op46, align 8, !dbg !178
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op46, %struct.String* %r2), !dbg !178
  %value47 = getelementptr %struct.String, %struct.String* %r2, i32 0, i32 0, !dbg !178
  %DOT48 = load i8*, i8** %value47, align 8, !dbg !178
  %14 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.9, i32 0, i32 0), i32 1, i8* %DOT48), !dbg !178
  store %struct.String zeroinitializer, %struct.String* %r3, align 8, !dbg !161
  %String.replace49 = call %struct.String @String.replace(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR18, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR19, i32 0, i32 0), %struct.String* %r1), !dbg !179
  %tmp_struct50 = alloca %struct.String, align 8, !dbg !179
  store %struct.String %String.replace49, %struct.String* %tmp_struct50, align 8, !dbg !179
  %tmp_op51 = alloca %struct.String, align 8, !dbg !179
  store %struct.String %String.replace49, %struct.String* %tmp_op51, align 8, !dbg !179
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op51, %struct.String* %r3), !dbg !179
  %value52 = getelementptr %struct.String, %struct.String* %r3, i32 0, i32 0, !dbg !179
  %DOT53 = load i8*, i8** %value52, align 8, !dbg !179
  %15 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.10, i32 0, i32 0), i32 1, i8* %DOT53), !dbg !179
  store %struct.String zeroinitializer, %struct.String* %r4, align 8, !dbg !161
  %String.replace54 = call %struct.String @String.replace(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @STR21, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR22, i32 0, i32 0), %struct.String* %r1), !dbg !180
  %tmp_struct55 = alloca %struct.String, align 8, !dbg !180
  store %struct.String %String.replace54, %struct.String* %tmp_struct55, align 8, !dbg !180
  %tmp_op56 = alloca %struct.String, align 8, !dbg !180
  store %struct.String %String.replace54, %struct.String* %tmp_op56, align 8, !dbg !180
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op56, %struct.String* %r4), !dbg !180
  %value57 = getelementptr %struct.String, %struct.String* %r4, i32 0, i32 0, !dbg !180
  %DOT58 = load i8*, i8** %value57, align 8, !dbg !180
  %16 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.11, i32 0, i32 0), i32 1, i8* %DOT58), !dbg !180
  store %struct.String zeroinitializer, %struct.String* %rep, align 8, !dbg !161
  %17 = call %struct.String @String.from(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @STR24, i32 0, i32 0)), !dbg !181
  %tmp_struct59 = alloca %struct.String, align 8, !dbg !181
  store %struct.String %17, %struct.String* %tmp_struct59, align 8, !dbg !181
  %tmp_op60 = alloca %struct.String, align 8, !dbg !181
  store %struct.String %17, %struct.String* %tmp_op60, align 8, !dbg !181
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op60, %struct.String* %rep), !dbg !181
  store %struct.String zeroinitializer, %struct.String* %rep2, align 8, !dbg !161
  %String.repeat = call %struct.String @String.repeat(i32 3, %struct.String* %rep), !dbg !182
  %tmp_struct61 = alloca %struct.String, align 8, !dbg !182
  store %struct.String %String.repeat, %struct.String* %tmp_struct61, align 8, !dbg !182
  %tmp_op62 = alloca %struct.String, align 8, !dbg !182
  store %struct.String %String.repeat, %struct.String* %tmp_op62, align 8, !dbg !182
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op62, %struct.String* %rep2), !dbg !182
  %value63 = getelementptr %struct.String, %struct.String* %rep2, i32 0, i32 0, !dbg !182
  %DOT64 = load i8*, i8** %value63, align 8, !dbg !182
  %18 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.12, i32 0, i32 0), i32 1, i8* %DOT64), !dbg !182
  store %struct.String zeroinitializer, %struct.String* %rep3, align 8, !dbg !161
  %String.repeat65 = call %struct.String @String.repeat(i32 0, %struct.String* %rep), !dbg !183
  %tmp_struct66 = alloca %struct.String, align 8, !dbg !183
  store %struct.String %String.repeat65, %struct.String* %tmp_struct66, align 8, !dbg !183
  %tmp_op67 = alloca %struct.String, align 8, !dbg !183
  store %struct.String %String.repeat65, %struct.String* %tmp_op67, align 8, !dbg !183
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op67, %struct.String* %rep3), !dbg !183
  %String.len68 = call i32 @String.len(%struct.String* %rep3), !dbg !184
  %19 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.13, i32 0, i32 0), i32 1, i32 %String.len68), !dbg !184
  store %struct.String zeroinitializer, %struct.String* %rev, align 8, !dbg !161
  %20 = call %struct.String @String.from(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR27, i32 0, i32 0)), !dbg !185
  %tmp_struct69 = alloca %struct.String, align 8, !dbg !185
  store %struct.String %20, %struct.String* %tmp_struct69, align 8, !dbg !185
  %tmp_op70 = alloca %struct.String, align 8, !dbg !185
  store %struct.String %20, %struct.String* %tmp_op70, align 8, !dbg !185
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op70, %struct.String* %rev), !dbg !185
  store %struct.String zeroinitializer, %struct.String* %rev2, align 8, !dbg !161
  %String.reverse = call %struct.String @String.reverse(%struct.String* %rev), !dbg !186
  %tmp_struct71 = alloca %struct.String, align 8, !dbg !186
  store %struct.String %String.reverse, %struct.String* %tmp_struct71, align 8, !dbg !186
  %tmp_op72 = alloca %struct.String, align 8, !dbg !186
  store %struct.String %String.reverse, %struct.String* %tmp_op72, align 8, !dbg !186
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op72, %struct.String* %rev2), !dbg !186
  %value73 = getelementptr %struct.String, %struct.String* %rev2, i32 0, i32 0, !dbg !186
  %DOT74 = load i8*, i8** %value73, align 8, !dbg !186
  %21 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.14, i32 0, i32 0), i32 1, i8* %DOT74), !dbg !186
  store %struct.String zeroinitializer, %struct.String* %rev3, align 8, !dbg !161
  %22 = call %struct.String @String.from(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @STR29, i32 0, i32 0)), !dbg !187
  %tmp_struct75 = alloca %struct.String, align 8, !dbg !187
  store %struct.String %22, %struct.String* %tmp_struct75, align 8, !dbg !187
  %tmp_op76 = alloca %struct.String, align 8, !dbg !187
  store %struct.String %22, %struct.String* %tmp_op76, align 8, !dbg !187
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op76, %struct.String* %rev3), !dbg !187
  store %struct.String zeroinitializer, %struct.String* %rev4, align 8, !dbg !161
  %String.reverse77 = call %struct.String @String.reverse(%struct.String* %rev3), !dbg !188
  %tmp_struct78 = alloca %struct.String, align 8, !dbg !188
  store %struct.String %String.reverse77, %struct.String* %tmp_struct78, align 8, !dbg !188
  %tmp_op79 = alloca %struct.String, align 8, !dbg !188
  store %struct.String %String.reverse77, %struct.String* %tmp_op79, align 8, !dbg !188
  call void @String.operator.ASSIGN.String(%struct.String* %tmp_op79, %struct.String* %rev4), !dbg !188
  %value80 = getelementptr %struct.String, %struct.String* %rev4, i32 0, i32 0, !dbg !188
  %DOT81 = load i8*, i8** %value80, align 8, !dbg !188
  %23 = call i32 (i8*, i32, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.15, i32 0, i32 0), i32 1, i8* %DOT81), !dbg !188
  call void @String.delete(%struct.String* %s), !dbg !188
  call void @String.delete(%struct.String* %u), !dbg !188
  call void @String.delete(%struct.String* %l), !dbg !188
  call void @String.delete(%struct.String* %sub), !dbg !188
  call void @String.delete(%struct.String* %sub2), !dbg !188
  call void @String.delete(%struct.String* %sub3), !dbg !188
  call void @String.delete(%struct.String* %sub4), !dbg !188
  call void @String.delete(%struct.String* %t1), !dbg !188
  call void @String.delete(%struct.String* %t2), !dbg !188
  call void @String.delete(%struct.String* %t3), !dbg !188
  call void @String.delete(%struct.String* %t4), !dbg !188
  call void @String.delete(%struct.String* %t5), !dbg !188
  call void @String.delete(%struct.String* %t6), !dbg !188
  call void @String.delete(%struct.String* %r1), !dbg !188
  call void @String.delete(%struct.String* %r2), !dbg !188
  call void @String.delete(%struct.String* %r3), !dbg !188
  call void @String.delete(%struct.String* %r4), !dbg !188
  call void @String.delete(%struct.String* %rep), !dbg !188
  call void @String.delete(%struct.String* %rep2), !dbg !188
  call void @String.delete(%struct.String* %rep3), !dbg !188
  call void @String.delete(%struct.String* %rev), !dbg !188
  call void @String.delete(%struct.String* %rev2), !dbg !188
  call void @String.delete(%struct.String* %rev3), !dbg !188
  call void @String.delete(%struct.String* %rev4), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct1), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct3), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct7), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct12), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct17), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct22), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct24), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct26), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct30), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct33), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct37), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct40), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct43), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct45), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct50), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct55), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct59), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct61), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct66), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct69), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct71), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct75), !dbg !188
  call void @String.delete(%struct.String* %tmp_struct78), !dbg !188
  ret i32 0, !dbg !188
}
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/tests/string")
...
!160 = distinct !DISubprogram(name: "main", linkageName: "main", scope: null, file: !3, line: 4, type: !5, scopeLine: 4, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !6)
!161 = !DILocation(line: 4, scope: !160)
!162 = !DILocation(line: 5, scope: !160)
!163 = !DILocation(line: 7, scope: !160)
!164 = !DILocation(line: 10, scope: !160)
!165 = !DILocation(line: 13, scope: !160)
!166 = !DILocation(line: 16, scope: !160)
!167 = !DILocation(line: 19, scope: !160)
!168 = !DILocation(line: 22, scope: !160)
!169 = !DILocation(line: 23, scope: !160)
!170 = !DILocation(line: 25, scope: !160)
!171 = !DILocation(line: 26, scope: !160)
!172 = !DILocation(line: 29, scope: !160)
!173 = !DILocation(line: 30, scope: !160)
!174 = !DILocation(line: 33, scope: !160)
!175 = !DILocation(line: 34, scope: !160)
!176 = !DILocation(line: 35, scope: !160)
!177 = !DILocation(line: 37, scope: !160)
!178 = !DILocation(line: 38, scope: !160)
!179 = !DILocation(line: 41, scope: !160)
!180 = !DILocation(line: 44, scope: !160)
!181 = !DILocation(line: 47, scope: !160)
!182 = !DILocation(line: 48, scope: !160)
!183 = !DILocation(line: 51, scope: !160)
!184 = !DILocation(line: 52, scope: !160)
!185 = !DILocation(line: 54, scope: !160)
!186 = !DILocation(line: 55, scope: !160)
!187 = !DILocation(line: 58, scope: !160)
!188 = !DILocation(line: 59, scope: !160)
