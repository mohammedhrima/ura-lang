; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/004.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/004.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i8* %DOT), !dbg !163
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i8* %DOT6), !dbg !164
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i8* %DOT10), !dbg !165
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i8* %DOT15), !dbg !166
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i8* %DOT20), !dbg !167
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.5, i32 0, i32 0), i32 %String.len), !dbg !169
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.6, i32 0, i32 0), i8* %DOT29), !dbg !171
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.7, i32 0, i32 0), i8* %DOT36), !dbg !173
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i32 %String.len42), !dbg !176
  ...
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.9, i32 0, i32 0), i8* %DOT48), !dbg !178
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.10, i32 0, i32 0), i8* %DOT53), !dbg !179
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.11, i32 0, i32 0), i8* %DOT58), !dbg !180
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.12, i32 0, i32 0), i8* %DOT64), !dbg !182
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.13, i32 0, i32 0), i32 %String.len68), !dbg !184
  ...
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.14, i32 0, i32 0), i8* %DOT74), !dbg !186
  ...
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.15, i32 0, i32 0), i8* %DOT81), !dbg !188
...
!3 = !DIFile(filename: "004.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string")
