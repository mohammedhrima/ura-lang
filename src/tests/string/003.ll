; ModuleID = '/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/003.ura'
source_filename = "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string/003.ura"
...
entry:
  ...
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt, i32 0, i32 0), i32 %String.find), !dbg !163
  %String.find1 = call i32 @String.find(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @STR4, i32 0, i32 0), %struct.String* %s), !dbg !164
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.1, i32 0, i32 0), i32 %String.find1), !dbg !164
  %String.find2 = call i32 @String.find(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @STR6, i32 0, i32 0), %struct.String* %s), !dbg !165
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.2, i32 0, i32 0), i32 %String.find2), !dbg !165
  %String.find3 = call i32 @String.find(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @STR8, i32 0, i32 0), %struct.String* %s), !dbg !166
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.3, i32 0, i32 0), i32 %String.find3), !dbg !166
  %String.find4 = call i32 @String.find(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @STR10, i32 0, i32 0), %struct.String* %s), !dbg !167
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.4, i32 0, i32 0), i32 %String.find4), !dbg !167
  ...
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.5, i32 0, i32 0), i8* %bool_str), !dbg !168
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.8, i32 0, i32 0), i8* %bool_str6), !dbg !169
  ...
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.11, i32 0, i32 0), i8* %bool_str7), !dbg !170
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.14, i32 0, i32 0), i8* %bool_str9), !dbg !171
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.17, i32 0, i32 0), i8* %bool_str11), !dbg !172
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.20, i32 0, i32 0), i8* %bool_str12), !dbg !173
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.23, i32 0, i32 0), i8* %bool_str14), !dbg !174
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.26, i32 0, i32 0), i8* %bool_str16), !dbg !175
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.27, i32 0, i32 0), i32 %String.find19), !dbg !177
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.30, i32 0, i32 0), i8* %bool_str21), !dbg !178
  ...
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.33, i32 0, i32 0), i8* %bool_str23), !dbg !179
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @output_fmt.36, i32 0, i32 0), i8* %bool_str25), !dbg !180
...
!3 = !DIFile(filename: "003.ura", directory: "/Users/hrimamohammed/Desktop/personal/ura-lang/src/tests/string")
